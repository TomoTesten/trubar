...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2016-01-1368"
---
...
(1)
Padalo ima knjižico, ki vsebuje naslednje podatke:
...
(1)
Zlaganje glavnega padala opravlja padalec z dovoljenjem padalca kategorije A, B, C ali D, oseba s pooblastilom zlagalec padal in oseba s pooblastilom vzdrževalec padal.
...
(1)
Tehnični pregledi padal se delijo na:
...
(1)
Tehnični pregled padala zajema pregled sestavnih delov kompleta padala.
...
(1)
Padalo in opremo mora lastnik ali uporabnik padala vzdrževati v skladu z navodili za vzdrževanje proizvajalca padala.
...
(1)
Padalo oziroma nahrbtnik s sistemom vezi, ki se uporablja za usposabljanje kandidatov po načinu TSO, mora imeti možnost avtomatskega aktiviranja glavnega padala in možnost aktiviranja na prosto.
...
(1)
Vodja skokov za pristanke izven letališč ali vzletišč pred skokom pregleda teren in oceni, ali je skok na določen teren varen, in šele nato padalcem z ustrezno kategorijo dovoljenja padalca dovoli skok.
...
(1)
Padalci so opremljeni s padalom, ki je tehnično pregledano in ima dokumente iz 6. člena tega pravilnika.
...
(1)
Vodja padalcev v zrakoplovu je za nadzor teh v zrakoplovu odgovoren vodji zrakoplova in skrbi za:
...
(1)
V kontroliranem zračnem prostoru je izvajanje padalskih skokov iz zrakoplova dovoljeno:
...
(1)
Izvajanje padalskih skokov v kontroliranem zračnem prostoru poteka v skladu z načrtom izvajanja padalskih skokov, ki ga izdela vodja skokov in potrdi pristojna služba zračnega prometa.
...
(1)
Organizacija za usposabljanje vodi knjigo učencev, kot jo določi agencija.
...
(1)
Kandidat mora v organizaciji za usposabljanje opraviti teoretično in praktično usposabljanje za pridobitev dovoljenja padalca ali ustreznega pooblastila po programu usposabljanja iz Priloge 1 tega pravilnika in v skladu s priročnikom za usposabljanje, ki ga potrdi agencija.
...
(1)
Kandidat, ki pristopi k praktičnemu usposabljanju za pridobitev dovoljenja padalca, pred prvim skokom ne sme biti mlajši od 16 let. Kandidat, ki je mlajši od 18 let, mora imeti pred začetkom praktičnega usposabljanja pisno dovoljenje staršev ali skrbnikov.
...
– skoke s padalom, ko krilna obremenitev ne presega 5 kg/m
2
(1 lbs/ft
2
).
...
(1)
Kandidat pristopi k opravljanju teoretičnega dela izpita iz vseh predmetov, ki so predpisani s programom usposabljanja iz Priloge 1 tega pravilnika. Teoretični del izpita za pridobitev dovoljenja padalca posamezne kategorije dovoljenja padalca ali pooblastila se opravlja pri učitelju izpraševalcu.
...
(1)
Ko kandidat opravi teoretični del izpita, lahko pristopi k opravljanju praktičnega dela izpita pri učitelju izpraševalcu.
...
– skoke s padalom, kjer krilna obremenitev ne presega 7 kg/m
2
(1,4 lbs/ft
2
).
...
– skoke s padalom, kjer krilna obremenitev ne presega 9 kg
2
(1,8 lb/ft
2
).
...
(1)
Dovoljenje padalca velja 4 leta.
...
(1)
Imetnik dovoljenja padalca lahko pridobi naslednja pooblastila:
...
(1)
Padalec lahko skače kot tandem pilot, če ima veljavno pooblastilo tandem pilot ali učitelj tandem pilota.
...
(1)
Imetnik dovoljenja padalca lahko usposablja kandidate po načinu usposabljanja TSO, če ima ustrezno veljavno pooblastilo učitelj padalstva TSO.
...
(1)
Kandidat mora za pridobitev pooblastila učitelja izpraševalca imeti:
...
(1)
Zlagalec padal je pooblaščen za zlaganje glavnih padal.
...
(1)
Kandidat mora imeti pred začetkom usposabljanja za pooblastilo vzdrževalec padal 1 pooblastilo zlagalec padal najmanj 12 mesecev.
...
(1)
Kandidat za pooblastilo vzdrževalec padal 2 mora imeti pred začetkom usposabljanja pooblastilo vzdrževalec padal 1 najmanj 12 mesecev.
...
(1)
Pri izvajanju privilegijev iz dovoljenja padalca mora padalec imeti pri sebi naslednje dokumente:
...
(1)
Na podlagi veljavnega dovoljenja padalca ali pooblastila, pridobljenega v tujini, lahko agencija na zahtevo imetnika dovoljenja padalca izda dovoljenje padalca ali pooblastilo v skladu s tem pravilnikom.
...
(1)
Imetnik tujega dovoljenja padalca lahko izvaja padalske skoke iz zrakoplovov z oznako državne pripadnosti Republike Slovenije, če izpolnjujejo zahteve dovoljenja padalca in pooblastila države, ki je izdala dovoljenje, ter zdravstvene zahteve države izdaje dovoljenja.
...
(1)
Imetnik dovoljenja padalca s pooblastilom tandem pilota mora:
...
(1)
Imetnik dovoljenja padalca s pooblastilom tandem pilota nosi opremo, oblačila in obutev glede na letni čas.
...
(1)
Skoki s tandem padalom se lahko izvajajo samo, če je mogoče vizualno ali z navigacijsko napravo določiti točko odskoka. Če je spodnja baza oblakov nižja od višine odskoka, oblačnost pa 5/8 ali več, mora biti spodnja baza oblakov najmanj 4500 čevljev nad terenom za pristanek.
...
(1)
Imetnik dovoljenja padalca s pooblastilom tandem pilota poda potniku navodila pred vkrcanjem v zrakoplov in med letom.
...
(1)
Skoke s potniki s tandem padalom lahko opravlja imetnik dovoljenja padalca s pooblastilom tandem pilota, ki:
...
(1)
Vozovnica je dokazilo o sklenjeni pogodbi o izvedbi tandemskega skoka med imetnikom dovoljenja padalca s pooblastilom tandem pilota in potnikom, pri čemer se v zvezi z vozovnico uporabljajo določbe zakona, ki ureja obligacijska in stvarnopravna razmerja v letalstvu.
...
(1)
Organizacije za usposabljanje uskladijo programe usposabljanj v skladu s tem pravilnikom najpozneje v 2 letih od uveljavitve tega pravilnika.
...
Priloga 3: Oblika dovoljenja padalca in pooblastil, knjižice padala in knjižice padalskega kompleta
