---
kratica: MP_ODLO10866
naziv: "Odlok o spremembah prostorskih ureditvenih pogojev za plansko celoto B8 Beričevo (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=1998-01-2811"
---

# Odlok o spremembah prostorskih ureditvenih pogojev za plansko celoto B8 Beričevo (ODLO)

Na podlagi drugega odstavka 39. člena zakona o urejanju naselij in drugih posegov v prostor (Uradni list SRS, št. 18/84) in 16. člena statuta Občine Dol pri Ljubljani (Uradni list RS, št. 43/95 in 27/96) je Občinski svet občine Dol pri Ljubljani na 3. izredni seji 21. 7. 1998 sprejel


## O D L O K
o spremembah prostorskih ureditvenih pogojev za plansko celoto B8 Beričevo
...
“S tem odlokom se sprejmejo prostorski ureditveni pogoji za plansko celoto B8 Beričevo (Uradni list SRS, št. 27-1319/87 in RS 27-1415/92), dopolnjeni v maju 1998.”
...
“Meje planske celote in posameznih območij urejanja so določene v grafičnem delu sprememb prostorskih ureditvenih pogojev za plansko celoto B8 Beričevo, izdelanih leta 1998 in prikazanih v načrtih TTN in PKN v merilu 1:5000. Katastrski načrti v merilu 1:2880 oziroma 1:1000 (Uradni list SRS, št. 27/87) se uporabljajo v delih, ki so skladni s citiranimi spremembami.”


### 4. člen

4. člen odloka se črta.


### 5. člen

Doda se novi 4. člen, ki se glasi:
...
V morfoloških enotah 2A, 2B, 2C in 2D je dovoljena tudi gradnja stanovanjskih objektov z večjim številom stanovanj, če se objekti po velikosti in obliki prilagodijo gradbeni strukturi v območju oziroma ne odstopajo od prevladujočega morfološkega vzorca naselja in če so zagotovljeni ostali lokacijski pogoji kot: število parkirnih mest, zelene površine in površine za igro otrok (vsaj 20 m2 na stanovanje), svetlobno-tehnični pogoji, velikost funkcionalnega zemljišča in drugi.
...
Novozgrajeni objekti morajo biti odmaknjeni od objektov šolstva, inštitutov, zdravstva in varstva vsaj 15 m in najmanj 5 m od parcelne meje teh objektov.
...
V drugih kmetijskih zemljiščih (drugo območje) in v gospodarskem gozdu so dovoljeni tile posegi:
...
14.2. Posegi v naravne prvine prostora
...
Ceste oziroma cestni objekti se lahko gradijo in prenavljajo v rezervatih oziroma varstvenih pasovih cest na podlagi splošnih določil odloka.
...
– poslovni prostori z obiskom strank 1 PM na 20 m2 netto površine,
– gostilna 1 PM na 4 sedeže in 1 PM na 1 tekoči meter točilnega pulta,
– za druge dejavnosti se določi potrebno število parkirnih mest v lokacijski dokumentaciji skladno s predpisi.
15.7. Vodne površine
...
Do izgradnje kanalizacije je možno sanitarne in tehnološke vode začasno zadržati v vodotesnih nepretočnih, troprekatnih greznicah, ki jih je treba redno čistiti. Vsebino greznic je treba odvažati na ustrezno opremljeno čistilno napravo.
...
Gradnja novih objektov, prizidave, nadzidave in spremembe namembnosti oziroma dejavnosti v obstoječih objektih in vsi drugi posegi v prostoru so dovoljeni, če ne povzročajo v okolju večjih motenj, kot so s predpisi dovoljene. Pri vseh posegih je treba upoštevati normativne določbe glede zaščite okolja.
17.2. Varstvo zraka
Treba je:
...
– odjemno oziroma zbirno mesto mora biti praviloma na funkcionalnem zemljišču povzročitelja komunalnih odpadkov, naseljih s pretežno individualno zazidavo je lahko odjemno mesto na javni površini,
...
Črtata se 54. in 55. člen.


### 7. člen

Doda se novi 5. člen, ki se glasi:

“Območje urejanja BS 8/2-1 Beričevo.

V morfološki enoti 9 so dovoljeni posegi v zvezi z urejanjem lokalnega pokopališča.”


### 8. člen

56. člen postane novi 6. člen, v katerem se točka A spremeni tako, da se glasi:

“Dopustne so novogradnje in prizidave objektov ter sprememba namembnosti za inštitutsko-poslovne dejavnosti.”

Točka B se spremeni tako, da se glasi:

“Oblikovanje objektov mora biti skladno z obstoječo zazidavo.

Za vse posege v prostor je treba predhodno izdelati strokovno gradivo, ki bo ocenilo predlagane posege iz ekološkega, programskega in oblikovnega vidika. Strokovno gradivo, ki ga potrdi občinska služba za urbanizem, je podlaga za izdelavo lokacijske dokumentacije.”


### 9. člen

57. člen postane novi 7. člen, v katerem se prvi odstavek točke A se spremeni tako, da se glasi:

“Dopustni so posegi v prostor, ki so potrebni za funkcioniranje trafo postaje ter gradnja poslovnih dejavnosti za potrebe elektrogospodarstva.”

Črta se določilo točke B.


### 10. člen

Črta se besedilo 58., 59. in 60. člena.


### 11. člen

61. člen postane novi 8. člen.


### 12. člen

62. člen postane novi 9. člen in se spremeni tako, da se glasi:
...
63. člen postane novi 10. člen in se spremeni tako, da se glasi:
...
64. člen postane novi 11. člen in se spremeni tako, da se glasi:

“Ta odlok začne veljati osmi dan po objavi v Uradnem listu Republike Slovenije.”

Št. 00303-1/98

Dol pri Ljubljani, dne 21. julija 1998.
