...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2020-01-1646"
---
...
(1)
Zahteva za registracijo znamke iz točke a) prvega odstavka prejšnjega člena vsebuje:
...
(1)
V seznamu blaga ali storitev iz točke c) prvega odstavka 2. člena tega pravilnika se navede blago ali storitve, za katere se zahteva registracija znamke.
...
(1)
Za dopolnitev prijave se uporabljajo določbe 4. in 5. člena tega pravilnika.
...
(1)
Ugovor zoper registracijo znamke se vloži v dveh izvodih, razen če je vložen v elektronski obliki, in vsebuje:
...
(1)
Zahteva za delitev prijave znamke ali znamke v več prijav znamk ali znamk vsebuje:
