---
kratica: MP_PRAV1654
naziv: "Pravilnik sklada štipendij za nadarjene in uspešne študente Občine Slovenska Bistrica (PRAV)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2005-01-2426"
---

# Pravilnik sklada štipendij za nadarjene in uspešne študente Občine Slovenska Bistrica (PRAV)

Na podlagi določil 10. člena Statuta Občine Slovenska Bistrica (Uradni list RS, št. 34/95, 72/99 in 65/02) in na predlog Upravnega odbora Sklada štipendij za nadarjene in uspešne študente Občine Slovenska Bistrica, je Občinski svet občine Slovenska Bistrica na 18. redni seji dne 16. 5. 2005 sprejel
...
Pravilnik ureja namen, financiranje, organizacijo in poslovanje Sklada štipendij za nadarjene in uspešne študente Občine Slovenska Bistrica (v nadaljnjem besedilu: sklad).
...
– imajo vsaj prav dobro (8) povprečno oceno opravljenih obveznosti v vseh letnikih študija. Pri tem se upoštevajo izpiti, ki jih je študent opravil do 30. septembra leta, v katerem je bila oddana vloga za pridobitev štipendije,
...
– imajo drugi vir dohodka (delo preko študentskega servisa se ne upošteva kot dohodek),
...
Štipendist, ki ponavlja letnik ali podaljša absolventski staž, ali se zaradi ponavljanja ali iz drugih razlogov vpiše drug visokošolski zavod ali študijsko smer, ne more prejemati štipendije iz tega sklada, razen v upravičenih primerih, ki jih oceni Upravni odbor sklada.
...
Pravica do štipendije preneha po sklepu Upravnega odbora sklada z dnem, ko je nastala sprememba, razen v primeru, ko je štipendist opravil obveznosti pred iztekom študentskega oziroma absolventskega statusa in se mu preostali del pripadajoče štipendije po odločbi, izplača v enkratnem znesku pri naslednjem rednem izplačilu štipendij.
Neupravičeno prejeto štipendijo je štipendist dolžan vrniti skupaj z zakonskimi obveznostmi po veljavni obrestni meri za dolgoročne kredite. Obresti se ne zaračunajo, če študent v roku enega meseca od dne, ko je bil pisno obveščen o dodelitvi ugodnejše iz drugega vira, vrne vse do tedaj prejete štipendije.
...
Način in roki vračila štipendije se določijo z izvensodno poravnavo. Če izvensodna poravnava ni mogoča, je za reševanje pristojno Okrajno sodišče Slovenska Bistrica.
...
 
+------+----------+---------------+----------------+-------------------------+
|Zap.  |Povprečna |  Osnovni del  | Variabilni del | Največje skupno število |
|št.   |  ocena   |               |                |          točk           |
+------+----------+---------------+----------------+-------------------------+
|      |          |     točke     |     točke      |                         |
+------+----------+---------------+----------------+-------------------------+
|1.    |8,00–8,20 |      600      |      200       |           800           |
+------+----------+---------------+----------------+-------------------------+
|2.    |8,21–8,50 |      700      |      200       |           900           |
+------+----------+---------------+----------------+-------------------------+
|3.    |8,51–8,90 |      800      |      200       |          1000           |
+------+----------+---------------+----------------+-------------------------+
|4.    |8.91–9,50 |      900      |      200       |          1100           |
+------+----------+---------------+----------------+-------------------------+
|5.    |  9.51–   |     1100      |      200       |          1300           |
|      |  10,00   |               |                |                         |
+------+----------+---------------+----------------+-------------------------+
...
Točke za variabilni del štipendije študent pridobi s pomočjo kriterijev, za dodatne aktivnosti študenta v preteklem študijskem letu, opredeljenih v nadaljevanju. Študentu se upošteva največ 200 tako pridobljenih točk.
1. Tekmovanja iz posameznih predmetnih področij s področja študija (Največje možno število točk 100)

+------------+----------------------------+
|            |        Število točk        |
|            +----------------------------+
|Tekmovanje  | individualni|    ekipni    |
|            |   rezultat  |   rezultat   |
+------------+-------------+--------------+
|Državno     |      40     |      20      |
+------------+-------------+--------------+
...
2. Udeležba na kongresih, simpozijih, seminarjih (Največje možno število točk 100)
...
3. Prostovoljno delo (največje možno število točk 150)

+------------------------------+---------+
|Sodelovanje na natečajih      | Število |
|                              |   točk  |
+------------------------------+---------+
|Občasno prostovoljno delo     |    60   |
+------------------------------+---------+
|Redno prostovoljno delo od 6  |   100   |
|do 14 ur mesečno              |         |
+------------------------------+---------+
|Redno prostovoljno delo nad 14|   150   |
|ur mesečno                    |         |
+------------------------------+---------+
|MAX TOČK =                    |   150   |
+------------------------------+---------+

4. Ostali dosežki (Največje možno število točk 150)

+------------------+---------------------+
|Sodelovanje na    |    Število točk     |
|natečajih         |                     |
+------------------+---------------------+
|Državna raven     |         40          |
+------------------+---------------------+
...
 
+------------------+---------------------+
|Funkcije v        |    Število točk     |
+------------------+---------------------+
|Organih fakultete |         50          |
+------------------+---------------------+
|Organih univerze  |         70          |
+------------------+---------------------+
|Zunanjih          |         70          |
...
Vrednost točke znaša 0,073% zajamčene plače v Republiki Sloveniji. Vrednost točke za vsako šolsko leto potrdi na predlog Upravnega odbora sklada župan Občine Slovenska Bistrica s sklepom.


### 16. člen

V primeru, da je število vlog nad planiranim in v občinskem proračunu zagotovljenim obsegom finančnih sredstev sklada, Upravni odbor sklada s sklepom ustrezno zviša najnižjo povprečno oceno opravljenih izpitov iz prve alinee 11. člena tega pravilnika.
...
– izjavo, da imajo drugega vira dohodka (delo preko študentskega servisa se ne upošteva kot dohodek),
...
Za študijsko leto 2005/2006 se vsem študentom prizna največje možno število točk variabilnega dela.


### 27. člen

Ta pravilnik začne veljati osmi dan po objavi v Uradnem listu Republike Slovenije.
Z dnem uveljavitve tega pravilnika preneha veljati dosedanji Pravilnik sklada štipendij za nadarjene in uspešne študente Občine Slovenska Bistrica (Uradni list RS, št. 79/01).

Št. 10/032-01/18-9/2005
