...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2020-01-3332"
---
...
(1) Prepoved iz prvega odstavka prejšnjega člena ne velja za:
...
(2) Prepoved iz prvega odstavka prejšnjega člena ne velja za muzeje in galerije v statističnih regijah Osrednjeslovenska, Goriška, Obalno-kraška in Gorenjska.

3. člen

(1) Ponujanje storitev iz prve alineje prvega odstavka in drugega odstavka prejšnjega člena je dovoljeno le pod pogojem, da se zagotovi:
...
(1) Ponujanje storitev iz druge alineje prvega odstavka 2. člena tega odloka je dovoljeno le pod pogojem, da se zagotovi:
...
Z dnem uveljavitve tega odloka preneha veljati Odlok o začasni prepovedi ponujanja kulturnih in kinematografskih storitev končnim uporabnikom v Republiki Sloveniji (Uradni list RS, št. 182/20).
