---
kratica: MP_ODLO32782
naziv: "Odlok o programu opremljanja stavbnih zemljišč in merilih za odmero komunalnega prispevka na območju Občine Idrija (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2011-01-3555"
---

# Odlok o programu opremljanja stavbnih zemljišč in merilih za odmero komunalnega prispevka na območju Občine Idrija (ODLO)

Na podlagi 74. člena Zakona o prostorskem načrtovanju (Uradni list RS, št. 33/07, 108/09), 29. člena Zakona o lokalni samoupravi (Uradni list RS, št. 94/07 – UPB2, 76/08, 79/09, 51/10), Uredbe o vsebini programa opremljanja stavbnih zemljišč (Uradni list RS, št. 80/07), Pravilnika o merilih za odmero komunalnega prispevka (Uradni list RS, št. 95/07) ter 15. člena Statuta Občine Idrija (Uradni list RS, št. 75/10 – UPB) je Občinski svet Občine Idrija na 8. seji dne 29. 9. 2011 sprejel


## O D L O K
o programu opremljanja stavbnih zemljišč in merilih za odmero komunalnega prispevka na območju Občine Idrija
...
S tem odlokom se sprejme Program opremljanja stavbnih zemljišč za območje Občine Idrija in merila za odmero komunalnega prispevka na območju Občine Idrija.
...
(1) Program opremljanja stavbnih zemljišč za območje Občine Idrija je izdelan v skladu z uredbo, ki določa vsebino programa opremljanja stavbnih zemljišč in vsebuje:
– prikaz obstoječe komunalne opreme na območju Občine Idrija;
– prikaz predvidenih vlaganj v gradnjo komunalne opreme na območju Občine Idrija;
...
(2) Program opremljanja stavbnih zemljišč za območje Občine Idrija sprejme občinski svet z odlokom.
(3) Program opremljanja obravnava naslednjo komunalno opremo v Občini Idrija:
...
(4) Obračunska območja posamezne komunalne opreme s prikazom komunalne opreme so podana v grafičnih prilogah, ki so sestavni del programa opremljanja stavbnih zemljišč. Program opremljanja stavbnih zemljišč se hrani v prostorih Občine Idrija.
...
KP(i) = (A(tN) - A(tO)) x C(ti) x D(ti) x K
pri čemer je:
...
KP(iO) = (A(tN) - A(tO)) x C(ti) x D(ti) x K
pri čemer je:

– KP(iO)     … komunalni prispevek za določeno vrsto
             komunalne opreme, na katero se je objekt
...
KP(iN) = ((A(p) x C(pi) x D(pi)) + (K x A(t) x C(ti) x D(ti))
pri čemer je:

– KP(iN)     … komunalni prispevek za določeno vrsto
...
KP(i) = (K(N) - K(O)) x C(ti) x D(ti) x A(t)
pri čemer je:
...
C(piS) = C(piO) x 0,5 + C(piN) oziroma
C(tiS) = C(tiO) x 0,5 + C(tiN)
pri čemer je:
...
|        opreme       |                   |        [€]         |
+---------------------+-------------------+--------------------+
|Ceste                |      OBO_C_1      |       36.756.393,13|
+---------------------+-------------------+--------------------+
|Kanalizacija         |      OBO_K_1      |       10.125.793,33|
|                     +-------------------+--------------------+
|                     |      OBO_K_2      |          190.912,82|
|                     +-------------------+--------------------+
|                     |      OBO_K_3      |        2.829.315,59|
|                     +-------------------+--------------------+
|                     |      OBO_K_4      |        1.597.560,18|
+---------------------+-------------------+--------------------+
|Vodovod              |      OBO_V_1      |       21.874.199,68|
+---------------------+-------------------+--------------------+
|Prostori za ravnanje |     OBO_PRO_1     |          232.190,00|
|z odpadki            |                   |                    |
+---------------------+-------------------+--------------------+
|Javne površine       |     OBO_JP_1      |          981.926,56|
|in parkirišča        |                   |                    |
+---------------------+-------------------+--------------------+
...
+------------+-------------+------------+--------------+-------+
|    Vrsta   |    Oznaka   |  Površine  | Vrednost [€] |Cena na|
|   opreme   | obračunskega| parcel [m2]|              | enoto |
|            |   območja   |            |              | (Cpi) |
|            |             |            |              |[€/m2] |
+------------+-------------+------------+--------------+-------+
|Ceste       |   OBO_C_1   |6.767.855,47| 36.756.393,13|  5,431|
+------------+-------------+------------+--------------+-------+
|Kanalizacija|   OBO_K_1   |1.246.175,52| 10.125.793,33|  8,125|
|            +-------------+------------+--------------+-------+
|            |   OBO_K_2   |   56.173,60|    190.912,82|  3,399|
|            +-------------+------------+--------------+-------+
|            |   OBO_K_3   |  389.370,41|  2.829.315,59|  7,266|
|            +-------------+------------+--------------+-------+
|            |   OBO_K_4   |  672.541,27|  1.597.560,18|  2,375|
+------------+-------------+------------+--------------+-------+
|Vodovod     |   OBO_V_1   |5.034.034,26| 21.874.199,68|  4,345|
+------------+-------------+------------+--------------+-------+
|Prostori za |  OBO_PRO_1  |6.767.855,47|    232.190,00|  0,034|
|ravnanje    |             |            |              |       |
|z odpadki   |             |            |              |       |
+------------+-------------+------------+--------------+-------+
|Javne       |   OBO_JP_1  |6.767.855,47|    981.926,56|  0,145|
|površine in |             |            |              |       |
|parkirišča  |             |            |              |       |
+------------+-------------+------------+--------------+-------+
...
|   opreme   | obračunskega|  tlorisne  |              | enoto |
|            |   območja   |  površine  |              | (Cti) |
|            |             |  objektov  |              |[€/m2] |
|            |             |    [m2]    |              |       |
+------------+-------------+------------+--------------+-------+
|Ceste       |   OBO_C_1   |1.656.226,33| 36.756.393,13| 22,193|
+------------+-------------+------------+--------------+-------+
|Kanalizacija|   OBO_K_1   |  469.100,60| 10.125.793,33| 21,586|
|            +-------------+------------+--------------+-------+
|            |   OBO_K_2   |   18.152,90|    190.912,82| 10,517|
|            +-------------+------------+--------------+-------+
|            |   OBO_K_3   |  139.756,90|  2.829.315,59| 20,245|
|            +-------------+------------+--------------+-------+
|            |   OBO_K_4   |  190.066,30|  1.597.560,18|  8,405|
+------------+-------------+------------+--------------+-------+
|Vodovod     |   OBO_V_1   |1.294.496,40| 21.874.199,68| 16,898|
+------------+-------------+------------+--------------+-------+
|Prostori za |  OBO_PRO_1  |1.656.226,33|    232.190,00|  0,140|
|ravnanje z  |             |            |              |       |
|odpadki     |             |            |              |       |
+------------+-------------+------------+--------------+-------+
|Javne       |   OBO_JP_1  |1.656.226,33|    981.926,56|  0,593|
|površine in |             |            |              |       |
|parkirišča  |             |            |              |       |
+------------+-------------+------------+--------------+-------+
...
Razmerje med deležem površine parcele (D(pi)) pri izračunu komunalnega prispevka in deležem neto tlorisne površine stavbe (D(ti)) pri izračunu komunalnega prispevka je D(pi):D(ti)= 0,5:0,5. Tako je delež površine parcele pri izračunu komunalnega prispevka (D(pi)) 0,5, delež neto tlorisne površine objekta pri izračunu komunalnega prispevka (D(ti)) pa 0,5.
...
(1) Sredstva, zbrana po tem odloku, so sredstva proračuna Občine Idrija.
(2) Občina Idrija lahko sredstva zbrana po tem odloku porablja samo za namen opremljanja stavbnih zemljišč v skladu z načrtom razvojnih programov občinskega proračuna.
...
(2) Šteje se, da je investitor v primeru iz prvega odstavka tega člena, na ta način v naravi plačal komunalni prispevek Občini Idrija za izvedbo komunalne opreme, ki jo je zgradil. Investitor je dolžan plačati še preostali del komunalnega prispevka, kolikor bo obremenil že zgrajeno komunalno opremo, na katero bo priključil komunalno opremo, katere investitor je.
