...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2007-01-4212"
---
...
Priloga I: Bistvene zdravstvene in varnostne zahteve v zvezi z načrtovanjem in konstrukcijo dvigal in varnostnih komponent

Priloga II: Vsebina ES-izjave o skladnosti za varnostne komponente in za montirana dvigala

Priloga III: Oznaka CE skladnosti

Priloga IV: Seznam varnostnih komponent (10. člen)

Priloga V: ES-Pregled tipa (modul B)

Priloga VI: Končni pregled

Priloga VII: Minimalna merila, ki jih morajo upoštevati države članice za priglasitev organov

Priloga VIII: Zagotavljanje kakovosti izdelka (modul E)

Priloga IX: Popolno zagotavljanje kakovosti (modul H)

Priloga X: Preverjanje posameznega izdelka (modul G)

Priloga XI: Skladnost s tipom z naključnim preverjanjem (modul C)

Priloga XII: Zagotavljanje kakovosti izdelka za dvigala (modul E)

Priloga XIII: Popolno zagotavljanje kakovosti za dvigala (modul H)

Priloga XIV: Zagotavljanje kakovosti proizvodnje (modul D)

Priloga XV: Izboljšanje varnosti obstoječih dvigal
