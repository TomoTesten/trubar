...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2012-01-1632"
---
...
### 1.1 Delovanje športnih zvez na državni ravni na področju interesne športne vzgoje otrok, mladine in interesne športne dejavnosti študentov
...
+---+-----------------------------------------------+-----------+
|   |Število dodatnih ur tedensko na skupino je 3   |         50|
+---+-----------------------------------------------+-----------+
|   |Število dodatnih ur tedensko na skupino je 2   |         30|
+---+-----------------------------------------------+-----------+
|   |Število dodatnih ur tedensko na skupino je 1   |         10|
+---+-----------------------------------------------+-----------+
...
### 1.3 Interesna športna dejavnost študentov
...
### 1.3.1 Tekmovanja med visokošolskimi zavodi v izbranih športnih panogah
...
+----+---------------------------------------------+------------+
|    |Število visokošolskih zavodov, ki tekmujejo, |          25|
|    |je najmanj 16                                |            |
+----+---------------------------------------------+------------+
|    |Število visokošolskih zavodov, ki tekmujejo, |          15|
|    |je najmanj 8                                 |            |
+----+---------------------------------------------+------------+
|    |Število visokošolskih zavodov, ki tekmujejo, |           5|
|    |je najmanj 3                                 |            |
+----+---------------------------------------------+------------+
|    |Možnost vertikalnega napredovanja na državni |          10|
|    |ravni in mednarodna študentska tekmovanja    |            |
+----+---------------------------------------------+------------+
|2   |KRITERIJ VKLJUČENOSTI                        |   skupaj 35|
+----+---------------------------------------------+------------+
|    |Število študentov, ki tekmujejo, je glede na |          35|
|    |vpisane študente 40 % ali več                |            |
+----+---------------------------------------------+------------+
|    |Število študentov, ki tekmujejo, je glede na |          20|
|    |vpisane študente od 20 % do 40 %             |            |
+----+---------------------------------------------+------------+
|    |Število študentov, ki tekmujejo, je glede na |          10|
|    |vpisane študente manj kot 20 %               |            |
+----+---------------------------------------------+------------+
|3   |NIVO IZVAJANJA TEKMOVANJ                     |   skupaj 30|
+----+---------------------------------------------+------------+
...
Za sofinanciranje 80-urnih programov v izbranih športnih panogah lahko kandidirajo športne organizacije, ki izpolnjujejo naslednje pogoje:
...
+----+--------------------------------------------+-------------+
|    |Celoten program je namenjen udeležencem     |           30|
|    |različnega spola in športnega predznanja    |             |
+----+--------------------------------------------+-------------+
|    |Samo del programa je namenjen udeležencem   |           15|
|    |različnega spola in športnega predznanja    |             |
+----+--------------------------------------------+-------------+
...
+----+--------------------------------------------+-------------+
|    |Maloprodajna cena za udeleženca             |           25|
|    |je do 30 evrov                              |             |
+----+--------------------------------------------+-------------+
|    |Maloprodajna cena za udeleženca             |           10|
|    |je od 30 do 50 evrov                        |             |
+----+--------------------------------------------+-------------+
|    |Maloprodajna cena za udeleženca             |            0|
|    |je 50 evrov ali več                         |             |
+----+--------------------------------------------+-------------+
...
– so pri točkovanju zbrali najmanj 60 točk.
...
Za sofinanciranje dejavnosti iz 2. točke prejšnjega odstavka lahko kandidirajo samo NPŠZ.
...
Dejavnosti, določene v 1. in 2. točki prvega odstavka 19. člena tega pravilnika, se lahko sofinancira največ do višine 70 % vrednosti programa izvajalca za vsako od teh dejavnosti.
Če se v posameznem letu poveča obseg sredstev v letnem programu športa za dejavnosti iz 1. in 2. točke prvega odstavka 19. člena tega pravilnika, se sofinanciranje posamezne NPŠZ za vsako od teh dejavnosti lahko poveča za največ 20 odstotnih točk nad odstotkom povečanja obsega sredstev v letnem programu športa za te dejavnosti ali zmanjša za največ 20 % glede na predhodno leto.
Če se v posameznem letu zmanjša obseg sredstev v letnem programu športa za dejavnosti iz 1. in 2. točke prvega odstavka 19. člena tega pravilnika, se sofinanciranje posamezne NPŠZ za vsako od teh dejavnosti lahko poveča za največ 20 % glede na predhodno leto ali zmanjša za največ 20 odstotnih točk nad odstotkom zmanjšanja obsega sredstev v letnem programu športa za te dejavnosti.
...
+-----------------+------------+--------------------------------+
|     RAZRED      |MEJA RAZREDA|       ŠT. REG. ŠPORTNIKOV      |
|  RAZŠIRJENOSTI  |            |         (razširjenost)         |
|                 |            +--------------+-----------------+
|                 |            |Skupini A in B|    Skupina C    |
+-----------------+------------+--------------+-----------------+
|       1.        |  nad 1950  |   2000 točk  |    1000 točk    |
+-----------------+------------+--------------+-----------------+
|       2.        |  1451–1950 |   1500 točk  |     750 točk    |
+-----------------+------------+--------------+-----------------+
|       3.        |  1001–1450 |   1000 točk  |     500 točk    |
+-----------------+------------+--------------+-----------------+
|       4.        |  501–1000  |   500 točk   |     250 točk    |
+-----------------+------------+--------------+-----------------+
|       5.        |    0-500   |       –      |        –        |
+-----------------+------------+--------------+-----------------+
...
|                 |            |Skupini A in B|    Skupina C    |
+-----------------+------------+--------------+-----------------+
|       1.        |   nad 200  |   1000 točk  |     500 točk    |
+-----------------+------------+--------------+-----------------+
|       2.        |   156–200  |   750 točk   |     300 točk    |
+-----------------+------------+--------------+-----------------+
|       3.        |   101–155  |   500 točk   |     150 točk    |
+-----------------+------------+--------------+-----------------+
|       4.        |   51–100   |   250 točk   |        –        |
+-----------------+------------+--------------+-----------------+
|       5.        |    0–50    |       –      |        –        |
...
|                 |            |Skupini A in B|    Skupina C    |
+-----------------+------------+--------------+-----------------+
|       1.        |  nad 110   |   3000 točk  |    1000 točk    |
+-----------------+------------+--------------+-----------------+
|       2.        |   86–110   |   2000 točk  |     750 točk    |
+-----------------+------------+--------------+-----------------+
|       3.        |   46–85    |   1000 točk  |     500 točk    |
+-----------------+------------+--------------+-----------------+
|       4.        |   30–45    |   500 točk   |     250 točk    |
+-----------------+------------+--------------+-----------------+
|       5.        |    0–30    |       –      |        –        |
+-----------------+------------+--------------+-----------------+
...
|KATEGORIZACIJA                           |      št. točk     |
+-----------------------------------------+-------------------+
|ŠPORTNIK SVETOVNEGA RAZREDA              |        300        |
+-----------------------------------------+-------------------+
|ŠPORTNIK MEDNARODNEGA RAZREDA            |        150        |
+-----------------------------------------+-------------------+
|ŠPORTNIK PERSPEKTIVNEGA RAZREDA          |         90        |
+-----------------------------------------+-------------------+
...
| PANOGE  |                          |                          |
+---------+--------+--------+--------+--------+--------+--------+
|    1    |1. mesto|2. mesto|3. mesto|   1.   |2. mesto|3. mesto|
|         |        |        |        | mesto  |        |        |
+---------+--------+--------+--------+--------+--------+--------+
...
Za osvojitev olimpijske medalje v ekipni konkurenci v individualnih športih se vsakemu posameznemu članu ekipe izplača nagrada v višini 75 % nagrade, določene za nosilce olimpijskih medalj v posamični konkurenci.
...
Sofinancira se nadstandardno zdravstveno zavarovanje vrhunskih športnikov, ki imajo status mednarodnega, svetovnega in perspektivnega razreda, in sicer v višini do 25 % vrednosti zavarovanja.
...
2. olimpijski komite poda predlog števila sofinanciranih programov za posamezne športne panoge,
...
V izbranih programih NPŠŠ se plačilo strokovnim delavcem sofinancira praviloma za obdobje štirih let. Za možnost nadaljevanja sofinanciranja programov NPŠŠ, katerih sofinanciranje poteka v skladu z večletno pogodbo, morajo izvajalci vsako leto predložiti poročilo o delu in finančno poročilo za preteklo leto, ustrezna dokazila o lastnem financiranju 20 % plačila strokovnega delavca, izračunanega v skladu z 48. členom tega pravilnika, in mnenje pristojnega organa NPŠZ o programu, izvajalcu in strokovnem delavcu. Programe, katerih sofinanciranje poteka v skladu z večletno pogodbo, se ne vrednoti po merilih iz 47. člena tega pravilnika.
...
+-------------------+-----------------------------+-------------+
|Regijska pokritost |Delo strokovnih delavcev v   |     20      |
|                   |regiji, kjer še ni ustreznega|             |
|                   |kadra za izvajanje programa  |             |
|                   |NPŠŠ                         |             |
|                   |Delo strokovnih delavcev v   |      0      |
|                   |regiji, kjer je že ustrezen  |             |
|                   |kader za izvajanje programa  |             |
|                   |NPŠŠ                         |             |
+-------------------+-----------------------------+-------------+
|Individualni       |– razdelanost programa dela  |     0–2     |
|štiriletni program |po posameznih letih          |             |
|za posamezno NPŠŠ  |– razdelanost programa dela z|     0–2     |
|                   |različnimi starostnimi       |             |
|                   |kategorijami športnikov, pri |             |
|                   |čemer je nujno, da program   |             |
|                   |obsega vse starostne         |             |
|                   |kategorije v skladu z        |             |
|                   |značilnostmi in pravili      |             |
|                   |posamezne športne panoge     |             |
|                   |– deficitarnost športne      |     0–2     |
|                   |panoge in zaposlovanje       |             |
|                   |strokovnih delavcev v okolju,|             |
|                   |kjer še nimajo zaposlenega   |             |
|                   |strokovnega delavca          |             |
|                   |– skladnost individualnega   |     0–2     |
|                   |štiriletnega programa s      |             |
|                   |prioritetami dolgoročnega    |             |
|                   |programa NPŠŠ                |             |
|                   |– reference strokovnega      |     0–2     |
|                   |kadra, ki izvaja program     |             |
+-------------------+-----------------------------+-------------+
|Dolgoročni program |– določitev smernic razvoja  |     0–3     |
|organiziranosti in |in prioritete NPŠŠ (kadrovske|             |
|delovanja NPŠŠ za  |in vsebinske)                |             |
|posamezno športno  |– organizacijska shema NPŠŠ  |     0–5     |
|panogo oziroma     |(način zagotavljanja         |             |
|disciplino         |decentralizacije izvajanja   |             |
|                   |programov, način povezovanja |             |
|                   |med zvezo in društvi,        |             |
...
|                   |– opis okvirnih programov za |     0–3     |
|                   |posamezne starostne          |             |
...
|                   |obsega vse starostne         |             |
|                   |kategorije                   |             |
|                   |– organizacija dela med      |     0–1     |
|                   |trenerji nosilci posameznega |             |
|                   |programa in drugimi          |             |
|                   |strokovnimi delavci, ki      |             |
|                   |sodelujejo pri izvajanju     |             |
|                   |posameznega programa         |             |
|                   |– opredelitev zagotavljanja  |     0–2     |
|                   |potrebnih materialnih        |             |
|                   |sredstev (oprema, objekti) za|             |
|                   |izvajanje programov NPŠŠ     |             |
|                   |– način vodenja in           |     0–2     |
|                   |koordiniranja NPŠŠ           |             |
|                   |– izdelan sistem ocenjevanja,|     0–2     |
|                   |spremljanja in poročanja o   |             |
|                   |izvajanju programov NPŠŠ     |             |
|                   |– način zagotavljanja pogojev|     0–3     |
|                   |strokovnim delavcem          |             |
|                   |v programih NPŠŠ, da izvajajo|             |
|                   |predvsem vzgojno-            |             |
|                   |izobraževalna dela           |             |
|                   |– opredelitev povezovanja z  |     0–1     |
...
Ministrstvo sofinancira plačilo strokovnemu delavcu v višini 80 % zneska v skladu z naslednjo preglednico:

+-----------------------------------+------------+--------------+
|   Vrsta programa usposabljanja    |    Naziv   | Plačni razred|
|         ali izobraževanja         |            |              |
+-----------------------------------+------------+--------------+
|program usposobljenosti druge ali  |            |      26      |
|tretje stopnje                     |            |              |
+-----------------------------------+------------+--------------+
|višješolski študijski program      |    brez    |      26      |
+-----------------------------------+------------+--------------+
|                                   |   mentor   |      29      |
+-----------------------------------+------------+--------------+
|                                   | svetovalec |      31      |
...
|                                   |   svetnik  |      34      |
+-----------------------------------+------------+--------------+
|univerzitetni študijski program,   |    brez    |      29      |
...
|športnika   |Meril za izbiro kandidatov v primeru|    dijaka   |
|            |omejitve vpisa v športni oddelek    |             |
|            +------------------------------------+-------------+
|            |Status B, pridobljen na podlagi     | 2 za vsakega|
|            |Meril za izbiro kandidatov v primeru|    dijaka   |
|            |omejitve vpisa v športni oddelek    |             |
|            +------------------------------------+-------------+
...
Sofinancira se lahko največ 15 prijaviteljev, katerih programi pri točkovanju na podlagi meril iz 58. člena tega pravilnika zberejo najmanj 70 točk.
...
Programe se ovrednoti po merilih iz naslednje pregled­nice:
...
+-----+-------------------------------------------+-------------+
|     |Maloprodajna cena za udeleženca je do 30   |      20     |
|     |evrov                                      |             |
+-----+-------------------------------------------+-------------+
|     |Maloprodajna cena za udeleženca je od 30 do|      10     |
|     |50 evrov                                   |             |
+-----+-------------------------------------------+-------------+
|     |Maloprodajna cena za udeleženca je 50 evrov|      0      |
|     |ali več                                    |             |
+-----+-------------------------------------------+-------------+
...
3. izvajanje programa iz prejšnje točke vodi strokovni delavec z univerzitetno izobrazbo in ustrezno usposobljenostjo ter
...
|    |izvajanje programov športne rekreacije      |             |
+----+--------------------------------------------+-------------+
...
Ministrstvo sofinancira plačilo strokovnemu delavcu v višini 50 % zneska v skladu z naslednjo preglednico:

+----------------------+--------------------+------------------+
|Vrsta programa        |       Naziv        |   Plačni razred  |
|izobraževanja         |                    |                  |
+----------------------+--------------------+------------------+
|višješolski študijski |        brez        |        24        |
|program               |                    |                  |
+----------------------+--------------------+------------------+
|                      |       mentor       |        27        |
+----------------------+--------------------+------------------+
...
Sofinancira se plačilo strokovnih delavcev v višini 50 % vrednosti, izračunane v skladu z merili iz prejšnjega člena, praviloma za obdobje štirih let.
Višino sofinanciranja plačila strokovnim delavcem ministrstvo usklajuje praviloma enkrat letno, in sicer po stanju na dan sprejema sklepa o sofinanciranju oziroma na dan podpisa aneksa k pogodbi o sofinanciranju.
...
+----+--------------------------------------------+-------------+
|    |Propagandne dejavnosti potekajo v treh ali  |      50     |
|    |več vrstah medijev                          |             |
|    |Propagandne aktivnosti potekajo v dveh      |      30     |
|    |vrstah medijev                              |             |
|    |Propagandne aktivnosti potekajo v eni vrsti |      10     |
|    |medijev                                     |             |
+----+--------------------------------------------+-------------+
...
### 3.5 Informiranje o športni rekreaciji
...
+----+--------------------------------------------+-------------+
|    |Informiranje poteka v treh ali več vrstah   |     30      |
|    |medijev                                     |             |
|    |Informiranje poteka v dveh vrstah medijev   |     20      |
|    |Informiranje poteka v eni vrsti medijev     |     10      |
+----+--------------------------------------------+-------------+
|2   |ČASOVNI KRITERIJČASOVNI KRITERIJ            |  skupaj 30  |
+----+--------------------------------------------+-------------+
...
+----+--------------------------------------------+-------------+
|    |Informiranje vsebuje vse pomembne           |     20      |
|    |informacije za uporabnika                   |             |
|    |Informiranje ne vsebuje vseh pomembnih      |     10      |
|    |informacij za uporabnika                    |             |
+----+--------------------------------------------+-------------+
...
1. programe usposabljanja strokovnih delavcev v športu in
2. programe spopolnjevanja strokovnih delavcev v športu, ki jih je določil strokovni svet.
...
+-----+---------------------------------------------+-----------+
|8.   |Kriterij pripravljene ali načrtovane podporne|    0–10   |
|     |obvezne strokovne literature, profesionalne  |           |
|     |kompetence in dosežki poglavitnih            |           |
|     |strokovnjakov                                |           |
+-----+---------------------------------------------+-----------+
...
– predložijo projekt, iz katerega sta razvidna vsebina in natančen finančni načrt.
...
3. s cenikom storitev morajo biti predhodno pisno seznanjene NPŠZ in
...
Sofinancira se do 75 % vrednosti programa, preostala sredstva mora izvajalec pridobiti sam. Višina sredstev za sofinanciranje meritev, analiz in svetovanja je določena z letnim programom športa.
...
Za sofinanciranje dejavnosti iz prejšnjega člena lahko kandidira nosilec dejavnosti preprečevanja uporabe nedovoljenih poživil in postopkov, če predloži program, iz katerega morata biti razvidna vsebina in natančen finančni načrt.
Višina sredstev za sofinanciranje dejavnosti preprečevanja uporabe nedovoljenih poživil in postopkov je določena z letnim programom športa.
...
+---------------------+-------------------+---------------------+
|    Vsota točk za    |  % sofinanciranja |   % sofinanciranja  |
|       projekt       | dela na projektih |     materialnih     |
|                     |                   |       stroškov      |
+---------------------+-------------------+---------------------+
|     50–59 točk      |        5 %        |         1 %         |
+---------------------+-------------------+---------------------+
...
|     |proračuna                                    |           |
+-----+---------------------------------------------+-----------+
|     |Vlaganja v programe športa v preteklih petih |    0–5    |
|     |letih (brez investicij)                      |           |
+-----+---------------------------------------------+-----------+
|     |Pokrivanje stroškov obratovanja              |    0–5    |
+-----+---------------------------------------------+-----------+
|4    |ŠIRŠI UČINKI PROJEKTA                        | skupaj 15 |
+-----+---------------------------------------------+-----------+
|     |Investicija dopolnjuje mrežo javnih športnih |    0–5    |
|     |objektov – javni interes v športu            |           |
+-----+---------------------------------------------+-----------+
...
Sredstva za sofinanciranje na podlagi tega člena lahko predstavljajo do 20 % vrednosti posamezne investicije. V skladu s sklepom vlade ali v primeru sofinanciranja posamezne investicije iz sredstev evropske kohezijske politike je lahko delež sofinanciranja, določen v tem odstavku, tudi večji.
...
Sofinancira se adaptacija, rekonstrukcija in tehnološka posodobitev športnih objektov. Sredstva za sofinanciranje adaptacije, rekonstrukcije in tehnološke posodobitve športnih objektov lahko predstavljajo največ 20 % vrednosti investicije. V skladu s sklepom vlade ali v primeru sofinanciranja posamezne investicije iz sredstev evropske kohezijske politike je lahko delež sofinanciranja, določen v tem členu, tudi večji.
...
Sofinancira se športna oprema v višini do 50 % vrednosti investicije.
...
Z dnem uveljavitve tega pravilnika preneha veljati Pravilnik o merilih za sofinanciranje izvajanja letnega programa športa na državni ravni (Uradni list RS, št. 6/07, 86/08, 51/09, 103/10 in 36/11).


### 100. člen

Postopki, začeti pred uveljavitvijo tega pravilnika, se končajo v skladu s Pravilnikom o merilih za sofinanciranje izvajanja letnega programa športa na državni ravni (Uradni list RS, št. 6/07, 86/08, 51/09, 103/10 in 36/11).
