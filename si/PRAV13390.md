...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2018-01-1685"
---
...
(1)
Monitoring lastnosti goriv na plovilih se izvaja:
...
(1)
Izvajalec monitoringa mora najpozneje do 31. marca tekočega leta za preteklo leto poročati:
...
V prilogi 2 se v 2. točki na koncu prve alineje doda oznaka »
(1)
«, na koncu druge alineje doda oznaka »
(2)
«, v četrti alineji pa se oznaka opombe »
(1)
« nadomesti z oznako »
(3)
«.
...
»
(1)
Lahko se uporabijo tudi specificirane analitične metode, ki nadomestijo SIST EN 228:2012, če se izkaže, da so rezultati vsaj tako natančni kakor po analitični metodi, ki se nadomešča.

(2)
Lahko se uporabijo tudi specificirane analitične metode, ki nadomestijo SIST EN 590:2013, če se izkaže, da so rezultati vsaj tako natančni kakor po analitični metodi, ki se nadomešča.«.

Na koncu priloge 2 se oznaka opombe »
(1)
« nadomesti z oznako »
(3)
«.
