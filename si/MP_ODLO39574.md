---
kratica: MP_ODLO39574
naziv: "Odlok o proračunu Občine Jesenice za leto 2016 (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2015-01-4171"
---

# Odlok o proračunu Občine Jesenice za leto 2016 (ODLO)

Na podlagi 29. člena Zakona o javnih financah (Uradni list RS, št. 79/99 in sprem.), 29. člena Zakona o lokalni samoupravi (Uradni list RS, št. 72/93 in sprem.), 13. člena Statuta Občine Jesenice (Uradni list RS, št. 1/06 in sprem.) je Občinski svet Občine Jesenice na 10. seji dne 22. 12. 2015 sprejel Odlok o proračunu Občine Jesenice za leto 2016

O D L O K

o proračunu Občine Jesenice za leto 2016
...
S tem odlokom se za Občino Jesenice za leto 2016 določajo proračun, postopki izvrševanja proračuna, posebnosti ravnanja z občinskim finančnim premoženjem ter obseg zadolževanja in poroštev občine in javnega sektorja na ravni občine (v nadaljnjem besedilu: proračun).
...
6. podskupina kontov (trimestna številka) je del postavke, ki v skladu s predpisanim kontnim načrtom okvirno določa ekonomski namen dela izdatkov postavke; 7. konto (K- štirimestna številka) je del postavke, ki v skladu s predpisanim kontnim načrtom natančno določa ekonomski namen izdatkov postavke in je temeljna enota za izvrševanje proračuna.
...
(PRIMANJKLJAJ) (70+71)–(40+41) (Tekoči prihodki minus tekoči odhodki
in tekoči transferi)
1.548.693
B.
...
Občina Jesenice v letu 2016 razpolaga s sredstvi, ki bodo vplačana na podračun proračuna do konca leta.
...
Sredstva proračuna za leto 2016 se nakazujejo proračunskim uporabnikom za izvajanje programov, opredeljenih v posebnem delu proračuna, do konca proračunskega leta, ki je enako koledarskemu letu.
...
Projekti, ki niso uvrščeni v načrt razvojnih programov tekočega leta in se jim zaključek financiranja zaradi prenosa plačil iz predhodnega leta prestavi v tekoče leto, se po uveljavitve proračuna uvrstijo v načrt razvojnih programov tekočega leta.
...
Proračunska rezerva se v letu 2016 oblikuje v višini 70.000,00 evrov.
...
Zaradi kritja presežka odhodkov in izdatkov nad prihodki in prejemki proračuna leta 2016 se občina v letu 2016 lahko zadolži za največ 500.000,00 €.

Javno komunalno podjetje JEKO-IN se v letu 2016 lahko zadolži za obnovo skladišča največ do višine 250.000 €.

Javni zavod GARS se v letu 2016 lahko zadolži za nakup gasilskih vozil v skupni višini 500.000,00 €.
...
Če bo v letu 2017 potrebno začasno financiranje občine, se uporablja ta odlok in sklep župana o določitvi začasnega financiranja.

23. člen

Odlok o proračunu Občine Jesenice za leto 2016 začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.
