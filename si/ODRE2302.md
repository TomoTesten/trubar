...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2015-01-0288"
---
...
a) povprečna cena zemeljskega plina iz prenosnega omrežja,
b) uparjeni utekočinjeni naftni plin (odvzem prek števca) iz distribucijskega omrežja za gospodinjske odjemalce po odjemnih skupinah,
c) para in topla voda za daljinsko ogrevanje;
2. PRODAJA GORIVA
a) neosvinčeni motorni bencini (NMB-95, 98 ali več oktanski motorni bencin),
b) dizelsko gorivo,
c) ekstra lahko kurilno olje (KOEL),
č) kurilno olje srednje (mazut),
d) letalsko gorivo,
e) utekočinjeni naftni plin v jeklenkah in plinohramih za pogon in ogrevanje.
...
Ta odredba začne veljati 6. marca 2015 in velja šest mesecev.
