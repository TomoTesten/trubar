---
kratica: MP_ODLO7508
naziv: "Odlok o ustanovitvi javnega vzgojno-izobraževalnega zavoda Vrtec Vrhovci (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2004-01-1181"
---

# Odlok o ustanovitvi javnega vzgojno-izobraževalnega zavoda Vrtec Vrhovci (ODLO)
...
## O D L O K
o ustanovitvi javnega vzgojno-izobraževalnega zavoda Vrtec Vrhovci
...
S tem odlokom Mestna občina Ljubljana, Mestni trg 1, Ljubljana (v nadaljevanju: ustanovitelj) ustanavlja za izvajanje javne službe vzgoje in varstva predšolskih otrok javni vzgojno-izobraževalni zavod Vrtec Vrhovci (v nadaljevanju: vrtec).
...
Ime vrtca je: Vrtec Vrhovci.
Sedež vrtca je: Vrhovci cesta XIX/10, Ljubljana.


### 4. člen

V vrtcu se za izvajanje programa za predšolske otroke na različnih lokacijah organizira tri enote vrtca:
– Enota Vrhovci, ki deluje na lokaciji Vrhovci cesta XIX/10, Ljubljana,
– Enota Brdo, ki deluje na lokaciji Stantetova ulica 1a, Ljubljana,
...
Predstavnike delavcev vrtca izvolijo delavci vrtca na neposrednih in tajnih volitvah tako, da izvolijo po dva predstavnika izmed delavcev enote Vrhovci in enote Rožnik ter enega predstavnika izmed delavcev enote Brdo.
...
– opravlja v imenu in za račun vrtca finančni načrt z občinami, zavezankami za plačilo razlike med ceno programov predšolske vzgoje in plačili staršev, ki se nanaša na obveznosti plačila za programe v vrtcih občin zavezank,
...
Za čas do imenovanja ravnatelja vrtca, vendar največ za dobo enega leta, opravlja funkcijo vršilke dolžnosti ravnateljice vrtca Klara Janša, ki je pooblaščena, da opravi vse potrebno za začetek dela vrtca.
...
Z dnem vpisa vrtca v sodni register nadaljujejo delo v Vrtcu Vrhovci, delavci, razporejeni skladno z 2., 3. in 4. členom sklepa o izločitvi enot iz javnega vzgojno-izobraževalnega zavoda Viški vrtci in njihovem organiziranju v samostojne zavode (Uradni list RS, št. 114/03).
