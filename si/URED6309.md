...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2013-01-1853"
---
...
Priloga 1: Določanje enot obremenitve za gorivo

Priloga 2: Obračun okoljske dajatve za obremenjevanje zraka z emisijo ogljikovega dioksida (Obrazec OBR-CO2)

Priloga 3: Pregled prometa

Priloga 4: Poračun okoljske dajatve CO2 za osebe s seznama (Obrazec Proračun CO2)

Priloga 5: Obračun okoljske dajatve zaradi uporabe fluoriranih toplogrednih plinov ( OBR-F plini)

Priloga 6: Pregled prometa fluoriranih toplogrednih plinov za proizvodnjo opreme in prvo namestitev nepremične opreme (Obrazec Pregled prometa F-plini)

Priloga 7: Prijava dejavnosti zavezancev oziroma plačnikov okoljske dajatve za zgorevanje goriva in uporabo fluoriranih toplogrednih plinov (Obrazec CO2 – Prijava dejavnosti)
