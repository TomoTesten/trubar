---
kratica: PRAV14744
naziv: "Pravilnik o licenciranju vojaškega letališkega osebja"
vrsta: "pravilnik"
datum: 2022-11-25
sop: 2022-01-3614
organ: "Ministrstvo za obrambo"
status: "Veljaven predpis"
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2022-01-3614"
---
...
(1)
Pooblastilo upravljavec sredstev zemeljske oskrbe obsega vožnjo, upravljanje sredstev in opreme za oskrbo zrakoplovov na vojaškem letališču ter ravnanje z njimi.
...
(1)
Pooblastilo parker usmerjevalec obsega:
...
(1)
Pooblastilo upravljavec sistema za zasilno zaustavljanje letal obsega upravljanje in osnovno vzdrževanje sistema za zasilno zaustavljanje letal.
...
(1)
Pooblastilo koordinator in kontrolor oskrbe zrakoplovov obsega:
...
(1)
Pooblastilo koordinator prometa obsega:
...
(1)
Pooblastilo inštruktor zemeljske oskrbe obsega:
...
(1)
Delo pod strokovnim nadzorom v zvezi z zemeljsko oskrbo na vojaškem letališču se opravlja po načrtu uvajanja, ki ga potrdi VLO.
...
(1)
Za pridobitev pooblastila upravljavec sredstev zemeljske oskrbe je treba opraviti preverjanje usposobljenosti za izbrani tip sredstva ali opreme v obliki izpita. Izpit obsega teoretični in praktični del.
...
(1)
Usposabljanje za delo s sistemom za zasilno zaustavljanje letal izvaja proizvajalec sistema ali organizacija, ki jo pooblasti proizvajalec.
...
(1)
Pooblastilo reševalec gasilec obsega:
...
(1)
Pooblastilo vodja intervencije gasilsko reševalne enote na vojaškem letališču obsega:
...
(1)
Pooblastilo koordinator požarne varnosti zrakoplovov in letališč obsega:
...
(1)
Pooblastilo inštruktor požarne varnosti zrakoplovov in letališč obsega:
...
(1)
Delo pod strokovnim nadzorom v zvezi s požarno varnostjo zrakoplovov in letališč se opravlja po načrtu uvajanja, ki ga potrdi VLO.
...
(1)
Pooblastilo voznik polnilec obsega:
...
(1)
Pooblastilo manipulant z gorivom in mazivom obsega:
...
(1)
Pooblastilo inštruktor oskrbovanja zrakoplovov z gorivom in mazivom obsega:
...
(1)
Delo pod strokovnim nadzorom v zvezi z oskrbovanjem zrakoplovov z gorivom in mazivom se opravlja po načrtu uvajanja, ki ga potrdi VLO.
...
(1)
Za pridobitev pooblastila voznik polnilec in pooblastila manipulant z gorivom in mazivom je treba opraviti preverjanje usposobljenosti za izbrani tip sredstva ali opreme v obliki izpita. Izpit obsega teoretični in praktični del.
...
(1)
Usposabljanje za delo v vojaškem skladišču goriva izvaja projektant oziroma izvajalec izgradnje sistema ali organizacija, ki jo pooblasti projektant oziroma izvajalec izgradnje sistema.
...
(1)
Po prenehanju veljavnosti, začasnem odvzemu vojaškega izkaza ali po njegovi omejitvi posameznik vloži vlogo v skladu s 24. členom tega pravilnika.
