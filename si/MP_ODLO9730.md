---
kratica: MP_ODLO9730
naziv: "Odlok o spremembah in dopolnitvah prostorskih ureditvenih pogojev za plansko celoto Š 4 Lavrica (uradno prečiščeno besedilo) (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2005-01-3623"
---

# Odlok o spremembah in dopolnitvah prostorskih ureditvenih pogojev za plansko celoto Š 4 Lavrica (uradno prečiščeno besedilo) (ODLO)
...
Š 4 Lavrica (uradno prečiščeno besedilo)
...
– Odlok o spremembah in dopolnitvah prostorskih ureditvenih pogojev za plansko celoto Š 4 Lavrica (Uradni list RS, št. 81/05).
...
+-------------+---------------+----------------------+------------+
|Nova oznaka  |Naziv območja  |Ureditvena            |Način       |
|             |               |enota/oznaka          |urejanja    |
+-------------+---------------+----------------------+------------+
|ŠSE 4/1      |Orle           |SE1/1, SE 1/2, SE1/3, |PUP-d       |
|             |               |SE1/4, SE 4           |            |
+-------------+---------------+----------------------+------------+
...
Skupna merila in pogoji, določeni v 4. členu odloka o spremembah in dopolnitvah prostorskih ureditvenih pogojih za plansko celoto Š 9 Škofljica (Uradni list RS, št. 81/05), veljajo tudi za vsa območja urejanja v planski celoti Š 4 Lavrica, če ni s posebnimi merili drugače določeno.
...
– Pri umestitvi novozgrajenih objektov v prostor je treba paziti, da je vzdolžna os objekta v smeri ceste, ob kateri je locirana. Izjema so objekti v sklopu domačij, ki oblikujejo notranje gospodarsko dvorišče.
– Za nadomestno gradnjo v sklopu kmečkih dvorišč oziroma domačij velja, da morajo novozgrajeni objekti gabaritno in lokacijsko ustrezati odstranjenim objektom (dovoljeno je odstopanje + 10%) – vendar morajo gabaritna razmerja ostati v okviru predpisanih vrednosti.
...
Dovoljeni so posegi v prostor za potrebe avtoceste po programu upravljavca ceste. Upravljavec ceste o morebitnih gradbenih posegih predhodno seznani občinski svet.
...
– uredi se sprehajalna pot, ki povezuje Lavrico s pastoralnim centrom in se nadaljuje v smeri rekreacijskega območja v dolini potoka Grivek.
Kanalizacija
...
– postopna priključitev vseh porabnikov na kanalizacijsko omrežje, ki bo povezano s kanalizacijskim zbiralnikom Rudnik – Lavrica (Škofljica), ko bo le-ta zgrajen.
...
– Direktni izvozi na Dolenjsko cesto niso dovoljeni, treba je zagotoviti skupne izvoze za več objektov. Pogoje določi upravljavec ceste. Regulacijski odmik od železnice upošteva enaka določila, kot veljajo za območje ŠSE 4/5 Lavrica.
...
– izgradnja transformatorske postaje, priključnega kablovoda do priključnega daljnovoda in razvodnega omrežja,
...
– Za posege na celotnem območju, ki je v naravovarstvenih smernicah opredeljeno kot naravna vrednota, in ožja in širša zavarovana območja je potrebno pridobiti naravovar­stveno soglasje pristojne službe.
...
Kulturna dediščina in naravne vrednote
– Za posege na celotnem območju, ki je v kulturnovar­stvenih smernicah opredeljeno kot kulturna dediščina, in ožja in širša zavarovana območja je potrebno pridobiti kulturnovarstveno soglasje pristojne službe;
...
 
+-------------------+------------+------------+------------+---------+
|Stara oznaka       |Nova oznaka |Naziv       |Ureditvena  |Način    |
|                   |            |območja     |enota/oznaka|urejanja |
+-------------------+------------+------------+------------+---------+
|VS 4/1 del         |ŠSE 4/1     |Orle        |SE1/1, SE   |PUP-d    |
|                   |            |            |1/2,        |         |
|                   |            |            |SE1/3,      |         |
|                   |            |            |SE1/4, SE   |         |
|                   |            |            |4           |         |
+-------------------+------------+------------+------------+---------+
|1. kmet.           |ŠZS 4/1     |motokros    |ZS          |Obln     |
|zemljiš.,+ gozd    |            |            |            |         |
+-------------------+------------+------------+------------+---------+
|1. kmet.           |ŠLN 4/1-1   |kamnolomi   |LN          |Obln     |
|zemljiš.,+ gozd    |            |Orle        |            |         |
+-------------------+------------+------------+------------+---------+
|1. kmet.           |ŠLN 4/1-2   |kamnolomi   |LN          |Obln     |
|zemljiš.,+ gozd    |            |Orle        |            |         |
+-------------------+------------+------------+------------+---------+
...
+-------------------+------------+------------+------------+---------+
|1. kmet. zemljiš.  |ŠDC 4/3     |pastoralni  |DC          |Obln     |
|+ 2. kmet.         |            |center      |            |         |
|zemljiš. + gozd    |            |            |            |         |
+-------------------+------------+------------+------------+---------+
...
+-------------------+------------+------------+------------+---------+
|VS 4/4 del         |ŠSV 4/4 – 1 |Lavrica     |SV          |ZN       |
+-------------------+------------+------------+------------+---------+
|VS 4/4 del         |ŠSV 4/4 – 2 |Lavrica     |SV          |ZN       |
+-------------------+------------+------------+------------+---------+
...
+-------------------+------------+------------+------------+---------+
|del VS 4/8 + VP    |ŠMP 4/4     |Dolenjska   |MP          |PUP-d    |
|4/2                |            |cesta       |            |         |
+-------------------+------------+------------+------------+---------+
|VS 4/5             |ŠSE 4/5     |Lavrica     |SE 1/1, SE  |PUP-d    |
|                   |            |            |1/2         |del,     |
|                   |            |            |            |Obln –   |
|                   |            |            |            |del      |
+-------------------+------------+------------+------------+---------+
...
+-------------------+------------+------------+------------+---------+
|VS 4/10            |ŠSE 4/10    |Erbežnikov  |SE 1        |PUP-d    |
|                   |            |hrib        |            |         |
+-------------------+------------+------------+------------+---------+
|VS 4/11 + 1. kmet. |ŠSE 4/11    |Škofljica   |SE 1        |PUP-d    |
|obm.               |            |            |            |         |
+-------------------+------------+------------+------------+---------+
...
stanovanjskih objektov ob Poti na Debeli hrib – Lavrica, april 2004, JP
...
Priključitev vodovoda Orle na ljubljanski vodovodni sistem VS 4/1, VS 4/4,
JP Vodovod – kanalizacija d.o.o., januar 2001).
