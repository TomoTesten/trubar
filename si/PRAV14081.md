...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2021-01-1408"
---
...
(1)
Ta pravilnik določa tehnične in organizacijske pogoje, omejitve in način uporabe vzletišč, izdajo obratovalnega dovoljenja vzletišča ter vrste zračnega prometa, ki se smejo opravljati na vzletišču.
...
(1)
Vzletišču se določi območje vzletišča in točke javljanja za zagotavljanje varnosti letalskih operacij.
...
(1)
Strip mora biti utrjen in širok najmanj 30 m.
...
(1)
Omejitvene ravnine so priletne, vzletne in bočne ravnine.
...
(1)
VPS se zaznamuje z označbami, ki so lahko nepremične ali premične. Nepremične označbe so kotniki in trakovi. Premične označbe so zastavice ali A-table.
...
(1)
Izpostavljeni objekti, drevesa in druga nevarna mesta izven VPS na območju vzletišča, ki lahko ogrozijo letenje, se zaznamujejo z rdečimi zastavicami.
...
(1)
Na vzletišču mora obratovalec vzletišča med njegovo uporabo zagotoviti meteorološko in protipožarno opremo ter opremo za prvo pomoč.
...
(1)
Obratovalec vzletišča mora zagotoviti, da je vzletišče urejeno in vzdrževano v skladu s tem pravilnikom ter navodili za uporabo vzletišča. Obratovalec vzletišča je odgovoren za posodabljanje navodil za uporabo vzletišča.
...
(1)
Vlogo za izdajo obratovalnega dovoljenja vzletišča in vpis vzletišča v Vpisnik vzletišč Republike Slovenije vloži vlagatelj pri agenciji.
...
(1)
Tipe zrakoplovov, za katere se uporablja vzletišče za lastno uporabo in osebe, ki lahko uporabljajo vzletišče za lastno uporabo, določi vlagatelj ali obratovalec vzletišča v navodilih za uporabo vzletišča.
...
(1)
Vzletišča za helikopterje morajo izpolnjevati naslednje dodatne zahteve:
...
(1)
Vlagatelj ali obratovalec vzletišča mora vzletišče opredeliti kot enostransko vzletišče.
...
(1)
Globina vode stripa mora biti ob najnižji vodi, ki jo je mogoče pričakovati na kateremkoli mestu, najmanj 1,5 m.
...
Priloga 1: Grafične priloge

Priloga 2: Navodila za uporabo vzletišča
