...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2006-01-1101"
---

# Pravilnik o metodologiji za posredovanje in analizo podatkov o plačah v javnem sektorju

Na podlagi četrtega odstavka 38. člena Zakona o sistemu plač v javnem sektorju (Uradni list RS, št. 70/05 – uradno prečiščeno besedilo in 14/06) izdaja minister za javno upravo
...
(1) Podatki, ki se zbirajo in analizirajo v informacijskem sistemu, so določeni v 2. in 3. členu Uredbe o enotni metodologiji in obrazcih za obračun in izplačilo plač v javnem sektorju (Uradni list RS, št. 122/05 in 20/06).
...
– zadnja plača pred prvim obračunom plač v skladu ZSPJS (Z111)
– osnovna plača (Z108/Z114)
...
– vrste izplačil za odpravo nesorazmerja (Z113/Z115/A040)
...
– obračunski sklop (OBRAČUNSKI) identificira podatke zaposlenega (davčna številka) in sumarne podatke iz obračuna plače. Tu je tudi podatek "Država zaposlitve", ki določa devizno plačo, če država zaposlitve ni "Slovenija";
...
|  |                       |                                               |
+--+-----------------------+-----------------------------------------------+
|1.|ID obračuna            |Oznaka, da gre za naslovni stavek (vedno "NS") |
|  |                       |                                               |
+--+-----------------------+-----------------------------------------------+
|2.|Datum pošiljanja       |V obliki LLLL-MM-DD (datum, ko je bil obračun  |
|  |obračuna               |poslan)                                        |
|  |                       |                                               |
+--+-----------------------+-----------------------------------------------+
|3.|Čas pošiljanja         |V obliki HH:MM:SS (čas, ko je bil obračun      |
|  |obračuna               |poslan)                                        |
|  |                       |                                               |
+--+-----------------------+-----------------------------------------------+
...
|  |                       |                                               |
+--+-----------------------+-----------------------------------------------+
|4.|Mesec obračuna         |V obliki MM (mesec, za katerega se obračunava) |
|  |                       |                                               |
+--+-----------------------+-----------------------------------------------+
...
|  |                       |                                               |
+--+-----------------------+-----------------------------------------------+
|9.|Oznaka obračuna        |0 – redna transakcija, 1 – storno transakcija, |
|  |                       |2 – preskusna transakcija                      |
|  |                       |                                               |
+--+-----------------------+-----------------------------------------------+
...
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
|3. |Povprečna mesečna    |Numerično (prazno, kadar "OS" vsebuje združene  |
|   |obveznost            |podatke za obračun zaposlenega na več delovnih  |
|   |                     |mestih)                                         |
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
|4. |Valuta izplačila     |Numerična šifra valute po standardu ISO 4217    |
|   |plače                |                                                |
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
...
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
|6. |Država zaposlitve    |Država zaposlitve javnega uslužbenca (Z520)     |
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
...
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
|9. |Bruto bruto plača    |Numerično (pri zaposlenem na več delovnih       |
|   |                     |mestih se uporabi ustrezen delež skupne bruto   |
|   |                     |bruto plače)                                    |
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
|10.|Osnova za izračun    |Numerično (pri zaposlenem na več delovnih       |
|   |prispevkov           |mestih se uporabi ustrezen delež skupne osnove) |
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
...
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
|12.|Neto plača I         |Numerično (pri zaposlenem na več delovnih       |
|   |                     |mestih se uporabi ustrezen delež skupne neto    |
|   |                     |plače)                                          |
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
|13.|Neto izplačilo       |Numerično (pri zaposlenem na več delovnih       |
|   |                     |mestih se uporabi ustrezen delež skupnega neto  |
|   |                     |izplačila)                                      |
|   |                     |                                                |
+---+---------------------+------------------------------------------------+
...
|      |                          |                                         |
+------+--------------------------+-----------------------------------------+
|2.    |Plačni razred delovnega   |ZSPJS, priloga 1 (Z380)                  |
|      |mesta                     |                                         |
|      |                          |                                         |
+------+--------------------------+-----------------------------------------+
|3.    |Zadnja plača pred prvim   |Numerično (Z111)                         |
|      |obračunom plač v skladu   |                                         |
|      |ZSPJS                     |                                         |
|      |                          |                                         |
+------+--------------------------+-----------------------------------------+
|4.    |Osnovna plača             |Numerično (Z108/Z114)                    |
|      |                          |– osnovna plača – za obračun II (Z114)   |
|      |                          |– osnovna plača – za obračun V (Z108)    |
+------+--------------------------+-----------------------------------------+
|5.    |Prevedena osnovna plača   |Numerično (Z105)                         |
|      |                          |                                         |
+------+--------------------------+-----------------------------------------+
|6.    |Korekcijska osnovna plača |Numerično (Z106)                         |
|      |                          |                                         |
+------+--------------------------+-----------------------------------------+
|7.    |Osnovna plača – za obračun|Numerično (Z116)                         |
|      |III                       |                                         |
|      |                          |                                         |
+------+--------------------------+-----------------------------------------+
|8.    |Osnovna plača – za obračun|Numerično (Z118)                         |
|      |IV                        |                                         |
|      |                          |                                         |
+------+--------------------------+-----------------------------------------+
|9.    |Osnovna plača za krajši   |Numerično (Z071)                         |
|      |delovni čas               |                                         |
|      |                          |                                         |
+------+--------------------------+-----------------------------------------+
|10.   |Vrste izplačil za odpravo |Numerično (Z113 / Z115 / A040)           |
|      |nesorazmerja              |– razlika odprave nesorazmerja (Z113)    |
|      |                          |– zmanjšanje po uredbi (Z115)            |
|      |                          |– razlika do plače glede na 49. člen     |
|      |                          |ZSPJS (A040)                             |
+------+--------------------------+-----------------------------------------+
...
|      |                         |                                         |
+------+-------------------------+-----------------------------------------+
|1.    |Šifra vrste izplačila    |Tipi izplačil: A, B, C, D, E, F, G, H, J |
...
|      |                         |                                         |
+------+-------------------------+-----------------------------------------+
|3.    |Mesec obračuna           |V obliki MM (če se izplačuje za različno |
|      |                         |obdobje, kakor je navedeno v "NS")       |
|      |                         |                                         |
+------+-------------------------+-----------------------------------------+
|4.    |Leto obračuna            |V obliki LLLL (če se izplačuje za        |
|      |                         |različno obdobje, kakor je navedeno v    |
|      |                         |"NS")                                    |
|      |                         |                                         |
+------+-------------------------+-----------------------------------------+
|5.    |Število ur               |Obvezno za vse vrste izplačil, ki pri    |
|      |                         |načinu izračuna upoštevajo število ur    |
|      |                         |                                         |
+------+-------------------------+-----------------------------------------+
...
Z dnem uveljavitve tega pravilnika preneha veljati Pravilnik o metodologiji za posredovanje in analizo podatkov o plačah v javnem sektorju (Uradni list RS, št. 97/03, 126/03 – ZSPJS, 35/04 in 71/04).
...
Ta pravilnik začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije, uporabljati pa se začne z dnem prvega obračuna plač v skladu z ZSPJS, razen za direktorje v javnem sektorju in funkcionarje, za katere se začne uporabljati naslednji dan po objavi.
