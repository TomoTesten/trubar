---
kratica: MP_ODLO48900
naziv: "Odlok o ustanovitvi zavoda javni Zavod – Turizem Pivka (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2023-01-3661"
---

# Odlok o ustanovitvi zavoda javni Zavod – Turizem Pivka (ODLO)

Na podlagi 3. in 8. člena Zakona o zavodih (Uradni list RS, št. 12/91, 45I/94 – Odl. US, 8/96, 18/98 – Odl. US, 36/00 – ZPDZC, 127/06 – ZJZP) ter 16. člena Statuta Občine Pivka (Uradni list RS, št. 58/99, 77/00, 24/01, 110/05, 52/07, 54/10, 111/13 in 96/22) je Občinski svet Občine Pivka na redni 7. seji dne 28. 11. 2023 sprejel
...
Skladno z Odlokom o izločitvi organizacijskih enot in preimenovanju Javnega zavoda »Zavod za upravljanje dediščine in turizem Pivka«, sprejetim na 15. seji Občinskega sveta Občine Pivka, dne 8. 4. 2021, se ustanovi Javni zavod – Turizem Pivka, katerega ustanovitelj je Občina Pivka (v nadaljevanju: zavod).
...
Poslanstvo zavoda je upravljanje s kulturno in naravno dediščino ter izvajanje dejavnosti načrtovanja, organiziranja in spodbujanja razvoja turizma na območju Občine Pivka.

Zavod je ustanovljen za opravljanje dejavnosti in storitev, ki jih opravlja v javnem interesu kot javno službo v Občini Pivka, in sicer:

a) za naloge, ki jih opravlja z namenom uresničevanja javnega interesa v kulturi:

– opravlja naloge s področja varstva kulturne in naravne dediščine in upravlja z objekti, ki so bili razglašeni za javno infrastrukturo na področju kulture ter spomeniki lokalnega pomena,

– na podlagi zbiralne politike in poslanstva muzeja evidentira, zbira, dokumentira, digitalizira in raziskuje premično ter nematerialno kulturno dediščino,

– zbirke in ostalo dokumentarno gradivo varuje in hrani v skladu s predpisi, standardi in normami muzejske stroke ter poslanstvom muzeja in jih predstavlja javnosti,

– postavlja stalne razstave in občasne razstave ter skrbi za druge oblike predstavljanja v državi in tujini,

– pripravlja, organizira in izvaja izobraževanja, seminarje, predavanja, delavnice, okrogle mize in srečanja,

– pripravlja strokovne podlage, študije, ocene in elaborate,

– posoja muzejsko gradivo za priložnostne razstave in posebne potrebe,

– sodeluje z zainteresiranimi organizacijami, ki v okviru svoje dejavnosti ali v zvezi z njo pripravljajo zbirke, razstave in druge oblike predstavljanja dediščine,
...
– strokovno sodeluje s fizičnimi in pravnimi osebami zasebnega prava, ki imajo zbirke premične dediščine ter sodeluje pri urejanju in predstavljanju zbirk,
...
– skrbi za filmsko kulturo,

– upravlja z Ekomuzejem Pivških presihajočih jezer ter z Interpretacijskim centrom za velike zveri DINA.

b) za opravljanje dejavnosti spodbujanja razvoja turizma
opravlja v javnem interesu:

– informacijsko-turistične dejavnosti, ki vključujejo:
...
– spodbujanje razvoja celovitih turističnih proizvodov turističnega območja ter kreiranje turističnih projektov,

– trženje celovite turistične ponudbe na ravni turističnega območja,

– promocijo turizma v digitalnem okolju,
...
– opravlja naloge lokalne turistične organizacije oziroma TIC-a,

– opravlja druge naloge v soglasju z ustanoviteljem.

4. člen

Dejavnosti iz prejšnjega člena, ki jih zavod izvaja, so po Standardni klasifikaciji dejavnosti (Uradni list RS, št. 69/07 in 17/08) naslednje:
...
Glavna dejavnost Javnega zavoda je dejavnost muzejev R91.020

Zavod lahko spremeni ali razširi dejavnost le s soglasjem ustanoviteljice.

5. člen

V okviru dejavnosti iz prejšnjega člena lahko zavod glede na svoje prostorske, tehnične in kadrovske zmogljivosti izvaja zlasti sledeče tržne dejavnosti:

1. oblikovanje, trženje in prodajo spominkov, literature, izdelkov lokalnega izvora in podobnih izdelkov, pri čemer imajo izdelki turističnega območja prednost pri predstavitvi, ponudbi in prodaji;

2. nudenje gostinskih, izobraževalnih, razstaviščnih, muzejskih in drugih storitev za obiskovalce in izvajalce prireditev v objektih v upravljanju in na prireditvah;

3. izvajanje informacijske dejavnosti;

4. nudenje storitev za druge;

5. dajanje objektov, tehnične, prireditvene in druge opreme v upravljanju v najem ter nudenje pomoči in tehnične podpore za izvedbo posameznih promocijskih dogodkov drugim organizatorjem.

Opravljanje dejavnosti iz prejšnjega odstavka ne sme ogroziti izvajanja osnovnih dejavnosti zavoda (javne službe).
...
Javni zavod je v skladu s predpisi dolžan pripraviti cenik za prodajo blaga in storitev na trgu in ga dati v potrditev svetu zavoda. Za potrebe prodaje trgovskega blaga v muzejski trgovini zavod pripravi in predloži svetu zavoda v potrditev interne usmeritve zavoda za določitev trgovskih razlik v ceni, ki jih je pri poslovanju dolžan upoštevati ter pri tem posvečati posebno pozornost temu, da pri prodaji trgovskega blaga ne prihaja do izgub ali pa do nedovoljenega prelivanja sredstev iz javne v tržno dejavnost.

IV. ORGANIZACIJA JAVNEGA ZAVODA

6. člen

Natančnejše organiziranje javnega zavoda, vodenje strokovnega dela in vodenje finančnega poslovanja določi statut zavoda.
...
– najmanj specializacija po visokošolski izobrazbi (prejšnja) ali visokošolska univerzitetna izobrazba (prejšnja) ali magistrska izobrazba (II. bolonjska),
...
Javni zavod nima v lasti stvarnega premoženja, razen če posebni zakon določa drugače.

Za upravljanje s premoženjem je zavod odgovoren ustanovitelju.

Zavod in ustanoviteljica s pogodbo o upravljanju določita nepremično in premično premoženje v lasti ustanovitelja, ki je predmet upravljanja in način upravljanja s tem premoženjem.
...
Nepremičnine, ki so last ustanovitelja, se zavodu prenesejo v upravljanje v skladu z zakonodajo.
...
– iz sredstev ustanovitelja za dogovorjeni del turistične, kulturne, športne in turistične dejavnosti,

– iz drugih virov po programu zavoda,

– iz drugih zakonitih virov.

Sredstva za izvajanje javne službe, ki jih zagotavljajo pogodbeni partnerji, so namenjena za plačilo dela zaposlenih, splošne stroške delovanja, programske in neprogramske materialne stroške.
...
Pravne posle v zvezi z razpolaganjem s stvarnim premoženjem lahko zavod opravlja samo s predhodnim soglasjem ustanovitelja.
...
V kolikor ni s tem odlokom ali posebnim predpisom določeno, da o določenem vprašanju odloča v imenu občine kot ustanovitelja občinski svet, sprejema odločitev župan.
...
Z dnem uveljavitve tega odloka preneha veljati Odlok o ustanovitvi zavoda Javni zavod – Turizem Pivka (Uradni list RS, št. 64/21).
