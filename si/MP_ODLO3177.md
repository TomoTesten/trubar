---
kratica: MP_ODLO3177
naziv: "Odlok o pomožnih objektih (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2001-01-0898"
---

# Odlok o pomožnih objektih (ODLO)

Na podlagi drugega odstavka 51. člena zakona o urejanju naselij in drugih posegov v prostor (Uradni list SRS, št. 18/84, 37/85, 29/86 in Uradni list RS, št. 26/90, 18/93, 47/93, 71/93 in 44/97) ter 16. člena statuta Občine Rogatec (Uradni list RS, št. 35/99) je Občinski svet občine Rogatec na 16. redni seji dne 7. 2. 2001 sprejel
...
Ta odlok določa vrsto, namen, največjo velikost in način gradnje pomožnih objektov za graditev katerih, na območju Občine Rogatec, lokacijsko dovoljenje ni potrebno.
...
– stanovanjska hiša: osnovni stanovanjski objekt, ki je po velikosti in obliki prilagojen gradbeni strukturi družinskih hiš,
...
– garaža za osebni avto: pomožni objekt enostavne gradbene konstrukcije brez stropne betonske plošče oziroma vnaprej izdelan montažni objekt,
– nadstrešek: pomožni objekt, ki ga sestavlja vertikalno in horizontalno ogrodje iz kvalitetnih materialov oziroma nadstrešek brez kritin in zaprtih stranic, bogato ozelenjen,
...
4. zimski vrt, površina do 15 m2, zasteklenitev balkonov oziroma teras,
5. vetrolov, površina do 4 m2,
6. pokrito zbirno mesto za komunalne odpadke, površina do 4 m2,
7. zunanje stopnice,
8. drvarnica, shramba, vrtna uta, lota za orodje, kolesarnica, površina do 15 m2,
...
Pomožni objekti, ki jih je dovoljeno graditi na gradbeni parceli proizvodnih, poslovnih, javnih in drugih nestanovanjskih objektov:
...
1. objekti navedeni v 1. do 15. točke prvega odstavka tega člena, velikost drvarnice pri kmetijah, površina do 30 m2,
...
Pomožni objekti, ki predstavljajo urbano opremo in ureditev zunanjega prostora v naseljih Občine Rogatec:
...
9. posegi v zvezi z odpravljanjem arhitekturnih ovir za ljudi za omejenimi možnostmi gibanja,
10. pomične zapore na vhodih na parkirišča, dvorišča.
Pomožni objekti, ki jih je dovoljeno ograditi na celotnem območju Občine Rogatec:
...
4. tipski rezervoarji za utekočinjen naftni plin prostornine do 5 m3, ki morajo biti vkopani v zemljo, in priključek na objekt,
...
9. enojni kozolec,
10. lovska preža,
11. trim steze, klopi, počivališča, pokrita stojala za kolesa ipd. ob poljski in ob gozdnih poteh,
12. gozdne vlake in gozdne pešpoti,
13. montažni plastenjak,
14. objekti za raziskovalne namene, velikost do 12 m2.
...
Pomožni objekti so lahko lesni, zidani ali iz drugih gradbenih materialov ter kvalitetno oblikovani. Naklon strehe, smer slemena in kritina morajo biti prilagojeni obstoječim objektom in krajinski arhitekturi.
...
Pred izdajo odločbe o dovolitvi priglašenih del je potrebno pridobiti urbanistično mnenje o ustreznosti posega, ki ga izda Oddelek za okolje in prostor občine Rogatec.


### 9. člen

Že zgrajeni pomožni objekti, ki niso legalizirani, in ležijo na stavbnih zemljiščih, se lahko po tem odloku legalizirajo.
