---
kratica: URED3446
naziv: "Uredba o koncesiji za odvzem naplavin iz reke Save in Završnice iz zadrževalnikov proda na vplivnem območju HE Moste, HE Završnica in HE Mavčiče"
vrsta: "uredba"
datum: 2004-07-29
sop: 2004-01-3716
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2004-01-3716"
---

# Uredba o koncesiji za odvzem naplavin iz reke Save in Završnice iz zadrževalnikov proda na vplivnem območju HE Moste, HE Završnica in HE Mavčiče
...
## U R E D B O
o koncesiji za odvzem naplavin iz reke Save in Završnice iz zadrževalnikov proda na vplivnem območju HE Moste, HE Završnica in HE Mavčiče
...
(1) Ta uredba je koncesijski akt, na podlagi katerega se podeli koncesija za odvzem naplavin iz zadrževalnikov proda na vplivnem območju HE Moste in HE Mavčiče na rekI Savi in iz zadrževalnika proda na vplivnem območju HE Završnica na reki Završnici.
(2) Koncesija iz prejšnjega odstavka se podeli imetniku koncesije za energetsko izkoriščanje vode v HE Moste, HE Završnica oziroma HE Mavčiče, in sicer za izkoriščanje naplavin iz zadrževalnikov proda, ki so na vplivnem območju teh elektrarn.
(3) Imetniki koncesije za energetsko izkoriščanje reke Save v HE Moste, HE Završnica oziroma HE Mavčiče imajo pravico odvzema naplavin na območjih delov reke Save oziroma reke Završnice iz naslednje tabele:

+----------------------+-------------+--------------------+------------------+
|                      |             |                    |    KOORDINATE    |
|                      |    OBČINA   |KOORDINATE GORVODNE |DOLVODNE MEJE DELA|
|       DELI REK       |      HE     |   MEJE DELA REKE   |       REKE       |
|                      |             |  Y              X  | Y               X|
+----------------------+-------------+--------------------+------------------+
|  reka Sava – prodni  |             |                    |                  |
|zadrževalnik Javornik |   Jesenice  | 429 450    142 920 |430 210    142 315|
|                      |   HE Moste  |                    |                  |
+----------------------+-------------+--------------------+------------------+
|  reka Sava – prodni  |             |                    |                  |
|zadrževalnik Majdičev |    Kranj    |                    |                  |
|         Log          |  HE Mavčiče | 450 253    122 531 |450 214    122 203|
|                      |             |                    |                  |
+----------------------+-------------+--------------------+------------------+
|   reka Završnica –   |             |                    |                  |
|     lovilna jama     |  Žirovnica  | 434 106    140 611 |435 995    140 625|
|akumulacije Završnica | HE Završnica|                    |                  |
+----------------------+-------------+--------------------+------------------+

(4) Območje posameznega dela rek Save in Završnice iz tabele v prejšnjem odstavku je določeno s koordinatami gorvodne meje in dolvodne meje dela reke, ki so prevzete iz državnega koordinatnega sistema (v Gauss-Krügerjevi projekciji), odčitane v temeljnih topografskih načrtih Republike Slovenije v merilu 1: 5.000.
...
Imetnik koncesije za energetsko izkoriščanje vode v hidroelektrarnah iz drugega odstavka prejšnjega člena pridobi koncesijo za:
...
(1) Oseba, ki je pridobila pravico odvzema naplavin na delih rek Save in Završnice iz tabele v 1. členu te uredbe (v nadaljnjem besedilu: koncesionar), mora poleg predpisanih pogojev zagotoviti odvzem naplavin izključno v skladu koncesijsko pogodbo in letnimi aneksi, in sicer samo, če:
...
(2) Količina v koledarskem letu odvzetih naplavin na območju posameznega dela rek Save in Završnice, ki je predmet koncesije, ne sme presegati količin, ki so določene s posebnimi pogoji v koncesijski pogodbi in letnih aneksih.
...
(4) Koncesionar ne sme pripravljati frakcij peska iz odvzetih naplavin na območju strug rek Save in Završnice. Mesta za pripravo frakcij se določijo v koncesijski pogodbi.
...
(1) Prihodki od plačila za koncesijo so vir proračuna Republike Slovenije in proračuna občin, na območju katerih so deli rek Save in Završnice, ki so namenjeni odvzemu naplavin.
