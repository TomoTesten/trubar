...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2019-01-2018"
---
...
(1)
Ta pravilnik ureja vodenje in upravljanje registra revizijskih družb, registra revizijskih podjetij, registra revizijskih subjektov tretjih držav in registra pooblaščenih revizorjev, ki jih vodi Agencija za javni nadzor nad revidiranjem (v nadaljevanju: Agencija), podatke, ki se vodijo v registrih, način pridobivanja podatkov, ki se vodijo v registrih, vpis sprememb in način dostopa do podatkov iz registrov.
...
(1)
Agencija vodi in upravlja registre v elektronski obliki.
...
(1)
Agencija vpiše spremembe podatkov v registru iz prejšnjega člena tega pravilnika na podlagi obvestil o spremembah podatkov družb, ki so predmet vpisa, ali po uradni dolžnosti.
...
(1)
Agencija vodi register pooblaščenih revizorjev, ki vsebuje naslednje podatke:
...
(1)
Agencija vpiše spremembe podatkov v registru iz prejšnjega člena tega pravilnika na podlagi obvestil o spremembah podatkov fizičnih oseb, ki so predmet vpisa, ali po uradni dolžnosti.
...
(1)
Agencija vodi registre tako, da se delijo na javni in poslovni del.
...
(1)
Agencija pripravi na podlagi vloge izpise iz registrov. Pri izpisih iz registra pooblaščenih revizorjev da Agencija le izpis o podatkih iz javnega dela registra.
