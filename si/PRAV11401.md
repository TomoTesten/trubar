...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2012-01-2338"
---

# Pravilnik o metodologiji za posredovanje in analizo podatkov o plačah v javnem sektorju

Na podlagi četrtega odstavka 38. člena Zakona o sistemu plač v javnem sektorju (Uradni list RS, št. 108/09 – uradno prečiščeno besedilo, 13/10, 59/10, 85/10, 94/10 – ZIU, 107/10, 35/11, 110/11 – ZDIU12, 27/12 – odl. US in 40/12 – ZUJF) izdaja minister za pravosodje in javno upravo
...
(1) Ta pravilnik določa metodologijo za posredovanje in analizo podatkov o plačah in drugih izplačilih (v nadaljnjem besedilu: plače) v javnem sektorju (v nadaljnjem besedilu: metodologija) v skladu z 38. in 39. členom Zakona o sistemu plač v javnem sektorju (v nadaljnjem besedilu: ZSPJS).
...
Določbe tega pravilnika veljajo za vse uporabnike proračuna, kot jih določa Sklep, ki ureja subjekte, za katere velja Zakon o sistemu plač v javnem sektorju.
...
(3) Če podatke o plačah pošilja drug poslovni subjekt, ga mora za to pooblastiti uporabnik proračuna. Uporabnik proračuna predloži agenciji pred prvim pošiljanjem podatkov pooblastilo za poročanje ISPAP prek sistema e-pooblastil agencije. Če pošiljatelj nima šifre proračunskega uporabnika, mu agencija dodeli ustrezno šifro za pošiljanje podatkov (v nadaljnjem besedilu: šifra pošiljatelja).
(4) Uporabnik proračuna mora izpolnjeno pooblastilo iz prejšnjega odstavka posredovati agenciji vsaj 30 dni pred prvim pošiljanjem podatkov o plačah v javnem sektorju.
(5) Elementi plače A040, Z104, Z105, Z106, Z107, Z108, Z111, Z113, Z114, Z115 in Z610, ki jih določa uredba, ki ureja enotno metodologijo in obrazce za obračun in izplačilo plač v javnem sektorju, se uporabljajo in posredujejo samo za namen obračuna, pri katerem je razlog za izplačilo nastal pred 1. 6. 2012.
...
(1) Podatki o plačah, ki se zbirajo v informacijskem sistemu so namenjeni za analize podatkov o plačah, ki jih pripravlja ministrstvo, pristojno za sistem plač v javnem sektorju.
...
– neto plača I (Z290)
– neto izplačilo (Z300) oziroma (Z490) pri plači za delo v tujino
(d) Podatki o delovnem mestu:
...
– zvišanje osnovne plače po 1. odstavek 19. člen ZSPJS (Z590)
– zvišana osnovna plača FJU – 1. odstavek 19. člen ZSPJS (Z591)
– znesek zvišanja osnovne plače po 2. odstavku 19. členu ZSPJS (Z593)
– zvišana osnovna plača FJU – 2. odstavek 19. člen ZSPJS (Z592)
...
– zvišanje osnovne plače v  % po drugem stavku drugega odstavka 59. člena Zakona o službi v Slovenski vojski (Uradni list RS, št. 68/07 in 58/08 − ZSPJS-I; v nadaljnjem besedilu: ZSSloV) (Z560)
...
– odbitek plače po Zakonu, ki ureja integriteto in preprečevanje korupcije (Uradni list RS, št. 69/11 – uradno prečiščeno besedilo; v nadaljnjem besedilu: ZIntPK) (Z620)
– osnova za izračun plače za delo v tujini (Z470)
– osnova za izračun plače za delo v tujini za pripadnike SV na operacijah kriznega odzivanja (OKO) in civilne zaščite (Z471)
– indeks življenjskih stroškov Organizacije združenih narodov (Z450)
...
(e) Podatki o porabi ur za obdobje obračuna plače:
...
(f) Podatki o vrsti in znesku dodatkov za obdobje obračuna:
...
– bruto znesek izplačila za vrsto izplačila (Z040)
– neto znesek izplačila za vrsto izplačila
(g) Podatki o vrsti in znesku izplačil za delovno uspešnost za obdobje obračuna:
– šifra vrste izplačila (tipi izplačil D – delovna uspešnost)
– vrsta izplačila – opis (opis vrste izplačila)
– obdobje obračuna vrste izplačila
– bruto znesek izplačila za vrsto izplačila (Z040)
– neto znesek izplačila za vrsto izplačila
(h) Podatki o drugih izplačilih:
...
|  #  |Podatek               |Opis                              |
+-----+----------------------+----------------------------------+
| 1.  |ID obračuna           |oznaka, da gre za naslovni stavek |
|     |                      |(vedno "NS")                      |
+-----+----------------------+----------------------------------+
| 2.  |Datum pošiljanja      |v obliki LLLL-MM-DD (datum, ko je |
|     |obračuna              |bil obračun poslan)               |
+-----+----------------------+----------------------------------+
| 3.  |Čas pošiljanja        |v obliki HH:MM:SS (čas, ko je bil |
|     |obračuna              |obračun poslan)                   |
+-----+----------------------+----------------------------------+
...
|     |uporabnika             |                                 |
+-----+-----------------------+---------------------------------+
| 3.  |Elektronski naslov     |elektronski naslov odgovorne     |
|     |                       |osebe                            |
+-----+-----------------------+---------------------------------+
| 4.  |Mesec obračuna         |v obliki MM (mesec, za katerega  |
|     |                       |se obračunava)                   |
+-----+-----------------------+---------------------------------+
| 5.  |Leto obračuna          |v obliki LLLL (leto, za katero se|
|     |                       |obračunava)                      |
+-----+-----------------------+---------------------------------+
...
|  #  |Podatek                |Opis                             |
+-----+-----------------------+---------------------------------+
|  1. |Zaporedna številka     |numerično                        |
|     |obračuna               |                                 |
+-----+-----------------------+---------------------------------+
|  2. |Šifra zaposlenega      |davčna številka zaposlenega      |
+-----+-----------------------+---------------------------------+
|  3. |Povprečna mesečna      |numerično                        |
|     |obveznost              |                                 |
+-----+-----------------------+---------------------------------+
|  4. |Valuta izplačila plače |numerična šifra valute po        |
|     |                       |standardu ISO 4217               |
+-----+-----------------------+---------------------------------+
|  5. |Devizni tečaj          |srednji tečaj Banke Slovenija za |
|     |                       |valuto izplačila                 |
+-----+-----------------------+---------------------------------+
...
|     |stroškov Organizacije  |Organizacije združenih narodov   |
|     |združenih narodov      |(Z450)                           |
+-----+-----------------------+---------------------------------+
|  8. |Bruto plača in         |numerično (Z080)                 |
|     |nadomestila            |                                 |
+-----+-----------------------+---------------------------------+
|  9. |Bruto bruto plača      |Numerično (Z280)                 |
+-----+-----------------------+---------------------------------+
| 10. |Osnova za izračun      |numerično (pri zaposlenem na več |
|     |prispevkov             |delovnih mestih se uporabi       |
...
+-----+-----------------------+---------------------------------+
| 13. |Neto izplačilo         |numerično (Z300) oziroma (Z490)  |
|     |                       |pri plači za delo v tujino       |
+-----+-----------------------+---------------------------------+
...
|  #  |Podatek                                  |Opis           |
+-----+-----------------------------------------+---------------+
|  1. |šifra funkcije ali delovnega mesta iz    |alfanumerično  |
|     |kataloga delovnih mest, nazivov in       |(Z370)         |
|     |funkcij v javnem sektorju                |               |
+-----+-----------------------------------------+---------------+
|  2. |šifra naziva iz kataloga delovnih mest,  |numerično      |
|     |nazivov in funkcij v javnem sektorju     |(Z371)         |
+-----+-----------------------------------------+---------------+
|  3. |Plačni razred FDMN                       |numerično      |
|     |                                         |(Z381)         |
+-----+-----------------------------------------+---------------+
|  4. |vrednost plačnega razreda FDMN           |numerično      |
|     |                                         |(Z073)         |
+-----+-----------------------------------------+---------------+
|  5. |znižanje osnovne plače 14. člen ZSPJS    |numerično      |
|     |                                         |(Z117)         |
+-----+-----------------------------------------+---------------+
|  6. |znižana osnovna plača FJU – 14. člen     |numerično      |
|     |ZSPJS                                    |(Z116)         |
+-----+-----------------------------------------+---------------+
|  7. |zvišanje osnovne plače 15. člen ZSPJS    |numerično      |
|     |                                         |(Z119)         |
+-----+-----------------------------------------+---------------+
|  8. |zvišana osnovna plača  FJU – 15. člen    |numerično      |
|     |ZSPJS                                    |(Z118)         |
+-----+-----------------------------------------+---------------+
|  9. |zvišanje osnovne plače po 1. odst. 19.   |numerično      |
|     |členu ZSPJS                              |(Z590)         |
+-----+-----------------------------------------+---------------+
| 10. |zvišana osnovna plača FJU – 1. odstavek  |numerično      |
|     |19. člen ZSPJS                           |(Z591)         |
+-----+-----------------------------------------+---------------+
| 11. |znesek zvišanja osnovne plače po 2.      |numerično      |
|     |odstavku 19. členu ZSPJS                 |(Z593)         |
+-----+-----------------------------------------+---------------+
| 12. |zvišana osnovna plača FJU – 2. odstavek  |numerično      |
|     |19. člen ZSPJS                           |(Z592)         |
+-----+-----------------------------------------+---------------+
| 13. |osnovna plača za pripravnika – 9.a člen  |numerično      |
|     |ZSPJS                                    |(Z580)         |
+-----+-----------------------------------------+---------------+
| 14. |osnovna plača FJU                        |numerično      |
|     |                                         |(Z070)         |
+-----+-----------------------------------------+---------------+
| 15. |plačni razred javnega uslužbenca oziroma |numerično      |
|     |funkcionarja z napredovanji, katerega    |(Z380)         |
|     |nominalna vrednost je izražena v izrazih:|               |
|     |Z070 ali Z116 ali Z115 ali Z118 ali Z580 |               |
|     |ali Z581 ali Z591 ali Z592               |               |
+-----+-----------------------------------------+---------------+
| 16. |zvišanje osnovne plače v % po drugem     |numerično      |
|     |stavku drugega odstavka 59. ZSSloV       |(Z560)         |
+-----+-----------------------------------------+---------------+
| 17. |zvišana osnovna plača FJU – 59. člen     |numerično      |
|     |ZSSloV                                   |(Z571)         |
+-----+-----------------------------------------+---------------+
| 18. |osnovna plača za pripravnika MORS        |numerično      |
|     |                                         |(Z581)         |
+-----+-----------------------------------------+---------------+
| 19. |osnovna plača za krajši delovni čas      |numerično      |
|     |                                         |(Z071)         |
+-----+-----------------------------------------+---------------+
| 20. |delež zaposlitve FJU na funkciji ali     |numerično      |
|     |delovnem mestu                           |(Z550)         |
+-----+-----------------------------------------+---------------+
| 21. |delež osnovne plače FJU                  |numerično      |
|     |                                         |(Z551)         |
+-----+-----------------------------------------+---------------+
| 22. |faktor za izračun povečane pedagoške     |numerično      |
|     |oziroma učne obveznosti                  |(Z600)         |
+-----+-----------------------------------------+---------------+
| 23. |vrednost zvišane/znižane pedagoške       |numerično      |
|     |oziroma učne ure                         |(Z601)         |
+-----+-----------------------------------------+---------------+
| 24. |faktor za izračun dodatne tedenske       |numerično      |
|     |pedagoške obveznosti visokošolskih       |(Z602)         |
|     |učiteljev in sodelavcev                  |               |
+-----+-----------------------------------------+---------------+
| 25. |mesečna vrednost dodatne tedenske        |numerično      |
|     |pedagoške obveznosti                     |(Z603)         |
+-----+-----------------------------------------+---------------+
| 26. |vrednost zmanjšane pedagoške oziroma učne|numerično      |
|     |obveznosti                               |(Z604)         |
+-----+-----------------------------------------+---------------+
| 27. |disciplinska sankcija za pravosodne      |numerično      |
|     |funkcionarje – odbitek bruto plače       |(Z611)         |
+-----+-----------------------------------------+---------------+
| 28. |odbitek plače po ZIntPK                  |numerično      |
|     |                                         |(Z620)         |
+-----+-----------------------------------------+---------------+
| 29. |osnova za izračun plače za delo v tujini |numerično      |
|     |                                         |(Z470)         |
+-----+-----------------------------------------+---------------+
| 30. |osnova za izračun plače za delo v tujini |numerično      |
|     |za pripadnike SV na operacijah kriznega  |(Z471)         |
|     |odzivanja (OKO) in civilne zaščite       |               |
+-----+-----------------------------------------+---------------+
| 31. |indeks življenjskih stroškov Organizacije|numerično      |
|     |združenih narodov                        |(Z450)         |
+-----+-----------------------------------------+---------------+
| 32. |razlika do plače glede na 49. člen ZSPJS |numerično      |
|     |                                         |(A040)         |
+-----+-----------------------------------------+---------------+
| 33. |primerljivi znesek plače, določen po     |numerično      |
|     |ZSPJS                                    |(Z104)         |
+-----+-----------------------------------------+---------------+
| 34. |prevedena osnovna plača                  |numerično      |
|     |                                         |(Z105)         |
+-----+-----------------------------------------+---------------+
| 35. |korekcijska osnovna plača                |numerično      |
|     |                                         |(Z106)         |
+-----+-----------------------------------------+---------------+
| 36. |razlika za odpravo nesorazmerja          |numerično      |
|     |                                         |(Z107)         |
+-----+-----------------------------------------+---------------+
| 37. |osnovna plača – za obračun V             |numerično      |
|     |                                         |(Z108)         |
+-----+-----------------------------------------+---------------+
| 38. |primerljivi znesek plače, določen po     |numerično      |
|     |predpisih in kolektivnih pogodbah, ki se |(Z111)         |
|     |uporabljajo do začetka izplačila plač po |               |
|     |ZSPJS                                    |               |
+-----+-----------------------------------------+---------------+
| 39. |delež razlike za odpravo nesorazmerja    |numerično      |
|     |                                         |(Z113)         |
+-----+-----------------------------------------+---------------+
| 40. |osnovna plača – za obračun II            |numerično      |
|     |                                         |(Z114)         |
+-----+-----------------------------------------+---------------+
| 41. |zmanjšanje po uredbi                     |numerično      |
|     |                                         |(Z115)         |
+-----+-----------------------------------------+---------------+
| 42. |odbitek plače funkcionarja               |numerično      |
|     |                                         |(Z610)         |
+-----+-----------------------------------------+---------------+
...
|  #  |Podatek            |Opis                                 |
+-----+-------------------+-------------------------------------+
| 1.  |Šifra vrste        |šifra vrste izplačil iz 3. člena     |
|     |izplačila          |uredbe, ki imajo vrednost polja B1   |
|     |                   |enako 1                              |
+-----+-------------------+-------------------------------------+
...
|     |                   |različno obdobje, kakor je navedeno  |
|     |                   |v "NS")                              |
+-----+-------------------+-------------------------------------+
| 4.  |Leto obračuna      |v obliki LLLL (če se izplačuje za    |
|     |                   |različno obdobje, kakor je navedeno  |
|     |                   |v "NS")                              |
+-----+-------------------+-------------------------------------+
| 5.  |Število ur         |obvezno za vse vrste izplačil, ki    |
|     |                   |pri načinu izračuna upoštevajo       |
|     |                   |število ur (Z060).                   |
+-----+-------------------+-------------------------------------+
| 6.  |Število normiranih |obvezno za vse vrste izplačil, ki    |
|     |ur                 |pri načinu izračuna upoštevajo       |
|     |                   |število ur (Z061).                   |
+-----+-------------------+-------------------------------------+
| 7.  |Bruto znesek       |numerično – bruto znesek v valuti iz |
|     |izplačila          |obračunskega stavka po srednjem      |
|     |                   |tečaju Banke Slovenije na dan        |
|     |                   |izplačila (Z040).                    |
+-----+-------------------+-------------------------------------+
| 8.  |Neto znesek        |numerično – neto znesek v valuti iz  |
|     |izplačila          |obračunskega stavka po srednjem      |
|     |                   |tečaju Banke Slovenije na dan        |
|     |                   |izplačila (Z040).                    |
+-----+-------------------+-------------------------------------+

(f) Kontrolni sklop, ki se posreduje ločeno za vsakega proračunskega uporabnika
...
|     |izplačil            |"VRSTEIZPL"                         |
+-----+--------------------+------------------------------------+
|  3. |Vsota vrst          |skupna vsota vseh vrst izplačila A –|
|     |izplačila A – bruto |numerično                           |
+-----+--------------------+------------------------------------+
|  4. |Vsota vrst          |skupna vsota vseh vrst izplačila A –|
|     |izplačila A – neto  |numerično                           |
+-----+--------------------+------------------------------------+
|  5. |Vsota vrst          |skupna vsota vseh vrst izplačila B –|
|     |izplačila B – bruto |numerično                           |
+-----+--------------------+------------------------------------+
|  6. |Vsota vrst          |skupna vsota vseh vrst izplačila B –|
|     |izplačila B – neto  |numerično                           |
+-----+--------------------+------------------------------------+
|  7. |Vsota vrst          |skupna vsota vseh vrst izplačila C –|
|     |izplačila C – bruto |numerično                           |
+-----+--------------------+------------------------------------+
|  8. |Vsota vrst          |skupna vsota vseh vrst izplačila C –|
|     |izplačila C – neto  |numerično                           |
+-----+--------------------+------------------------------------+
|  9. |Vsota vrst          |skupna vsota vseh vrst izplačila D –|
|     |izplačila D – bruto |numerično                           |
+-----+--------------------+------------------------------------+
| 10. |Vsota vrst          |skupna vsota vseh vrst izplačila D –|
|     |izplačila D – neto  |numerično                           |
+-----+--------------------+------------------------------------+
...
Z dnem uveljavitve tega pravilnika preneha veljati Pravilnik o metodologiji za posredovanje in analizo podatkov o plačah v javnem sektorju (Uradni list RS, št. 33/09), uporablja pa se do 30. septembra 2012.
...
Ta pravilnik začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije, uporabljati pa se začne 1. oktobra 2012.
