...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2018-01-0006"
---
...
Povprečna vrednost tekočih stroškov MO Ljubljana (TS
MOL
) za obdobje od leta (t – 5) do leta (t – 2) se izračuna po enačbi:
...
Povprečna vrednost tekočih stroškov mestnih občin (TS
MO
) za obdobje od leta (t – 5) do leta (t – 2) se izračuna po enačbi:
...
Povprečna vrednost tekočih prihodkov MO Ljubljana (TP
MOL
) za obdobje od leta (t – 5) do leta (t – 2) se izračuna po enačbi:
...
Povprečna vrednost tekočih prihodkov mestnih občin (TP
MO
) za obdobje od leta (t – 5) do leta (t – 2) se izračuna po enačbi:
