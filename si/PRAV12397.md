...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2016-01-1003"
---
...
(1)
Gospodarski subjekt organom za nadzor trga na zahtevo identificira:
...
(1)
Za dvigalo se uporabi eden od naslednjih postopkov ugotavljanja skladnosti:
...
(1)
Izjava EU o skladnosti potrjuje, da je bilo dokazano izpolnjevanje bistvenih zdravstvenih in varnostnih zahtev iz Priloge 1 tega pravilnika.
...
(1)
Oznako CE se namesti vidno, čitljivo in neizbrisljivo na vsako kabino dvigala in na vsako varnostno komponento ali, kadar to ni mogoče, na etiketo, ki je neločljivo nameščena na varnostno komponento.
...
(1)
Organ za ugotavljanje skladnosti mora izpolnjevati zahteve iz zakona, ki ureja tehnične zahteve za proizvode in ugotavljanje skladnosti in so podrobneje določene v drugem do dvanajstem odstavku tega člena.
...
(1)
Kadar organ za ugotavljanje skladnosti za določene naloge, povezane z ugotavljanjem skladnosti, sklene pogodbo s podizvajalci ali jih prenese na odvisno družbo, zagotovi, da podizvajalec ali odvisna družba izpolnjuje zahteve iz 23. člena tega pravilnika in o tem obvesti ministrstvo.
...
(2) Zahtevku za priglasitev je priložen opis dejavnosti ugotavljanja skladnosti, postopka ali postopkov za ugotavljanje skladnosti ter dvigala ali varnostne komponente, za katere navedeni organ trdi, da je usposobljen, ter akreditacijska listina, ki jo izda Slovenska akreditacija, ki potrjuje, da organ za ugotavljanje skladnosti izpolnjuje zahteve iz
23. člena tega pravilnika in da je akreditiran za celoten obseg dejavnosti, za katerega vlaga zahtevek za priglasitev.
...
(1)
Ministrstvo lahko priglasi samo tisti organ za ugotavljanje skladnosti, ki izpolnjuje zahteve iz 23. člena tega pravilnika.
...
(1)
Priglašeni organ izvaja ugotavljanje skladnosti v skladu s postopki ugotavljanja skladnosti iz 16. in 17. člena tega pravilnika.
...
(1)
Kadar Komisija ugotovi, da je bil ukrep druge države članice EU v zvezi z dvigalom upravičen, organi za nadzor trga Republike Slovenije sprejmejo potrebne ukrepe, da zagotovijo odpoklic dvigala s trga ali omejitev ali prepoved dajanja neskladnega dvigala na trg ali v uporabo.
...
(1)
Organi za nadzor trga od zadevnega gospodarskega subjekta zahtevajo, da zadevno neskladnost odpravi, kadar ugotovijo eno od naslednjih dejstev:
...
(1)
Nadzor nad izvajanjem tega pravilnika opravljajo v skladu z veljavnimi predpisi:
...
(1)
Strokovno osebje za izvajanje pregledov dvigal izpolnjuje naslednje pogoje:
...
(1)
Ne sme se ovirati dajanja dvigal na trg ali omogočanja dostopnosti varnostnih komponent na trgu, ki jih zajema Pravilnik o varnosti dvigal (Uradni list RS, št. 83/07 in 81/11) in so bili dani na trg pred 20. aprilom 2016, če so skladni z navedenim pravilnikom.
...
Priloga 1: Bistvene zdravstvene in varnostne zahteve

Priloga 2: Vsebina izjave EU o skladnosti za varnostne komponente

Priloga 3: Seznam varnostnih komponent
