---
kratica: PRAV6731
naziv: "Pravilnik o vsebini in obliki vloge za dodelitev sredstev za odpravo posledic potresa v Posočju 12. julija 2004"
vrsta: "pravilnik"
datum: 2005-03-29
sop: 2005-01-1086
organ: "Ministrstvo za okolje in prostor"
status: "Veljaven predpis"
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2005-01-1086"
---

# Pravilnik o vsebini in obliki vloge za dodelitev sredstev za odpravo posledic potresa v Posočju 12. julija 2004
...
## P R A V I L N I K
o vsebini in obliki vloge za dodelitev sredstev za odpravo posledic potresa v Posočju 12. julija 2004
...
S tem pravilnikom se določa vsebina, oblika in način izpolnjevanja vlog za dodelitev sredstev za odpravo posledic potresa v Posočju 12. julija 2004 (v nadaljnjem besedilu: vloga) na objektih in stavbah, za katere je Vlada Republike Slovenije na 161. dopisni seji s sklepom številka 224-18/2004-12 dne 2. 12. 2004 v Rebalansu Programa odprave posledic potresa v Posočju 12. julija 2004 določila, da so upravičeni do sredstev državnega proračuna za odpravo posledic potresa.


### 2. člen

S tem pravilnikom se za vložnike vlog določa minimalna obvezna vsebina dokazil in drugih podatkov, ki jih je treba predložiti ob vložitvi vloge.


### 3. člen

Vsebina izpolnjene vloge mora obsegati tiste po­datke, ki omogočajo komisiji za odpravo posledic nesreč, da odloča o višini sredstev državne pomoči za obnovo objekta ali njegovega dela, ki predstavlja tehnično, tehnološko in funkcionalno celoto in je v lasti oziroma solastnini vložnika oziroma ima v takšnem objektu vložnik stanovanje ali poslovni prostor v najemu.
...
### II. VLOGE ZA ODPRAVO POSLEDIC POTRESA
...
(2) Podatke vpisujejo v obrazce pooblaščene osebe Državne tehnične pisarne (v nadaljnjem besedilu: uradna oseba), ustanovljene v skladu z določbami Zakona o popotresni obnovi objektov in spodbujanju razvoja v Posočju (Uradni list RS, št. 45/98, 67/98, 110/99, 59/01, 110/02-ZGO-1 in 86/04) na zahtevo vložnika. Vsaka zahteva se vpiše v samostojen obrazec.
...
1. višina škode na objektu,
2. višina sredstev, potrebna za obnovo,
3. neto tlorisna površina objekta oziroma dela objekta, ki se ga obnavlja,
4. strošek za 1m2 novo gradnje objekta v obnovi oziroma dela objekta, ki se ga obnavlja, in
5. višina stroška za novo gradnjo prostora enakega namena s površino, ki je enaka 5% neto tlorisne površine v obnovi.


### 12. člen

(1) Tretji sklop vsebinskega dela ima naslov “Za dodelitev sredstev – temeljni program” in ima tri razdelke.
(2) Podatki, ki se vpisujejo v tretji sklop vsebinskega dela, so podatki, na podlagi katerih se objekt, ki naj bi se obnovil, razvrsti v ustrezno kategorijo oziroma vrsto popotresne obnove objekta, ter podatki o predloženih dokazilih in drugi dokumentaciji.
...
(1) O vseh spisih, v katere so bile vložene zaključene vloge v skladu s prejšnjim členom, pristojna služba organa uradne osebe vzpostavi, vodi in vzdržuje knjigo o vlogah za odpravo posledic potresa (v nadaljnjem besedilu: evidenčna knjiga).
...
(2) Podatki iz prejšnjega odstavka se vpišejo najpozneje takrat, ko organ uradne osebe komisiji za odprav posledic nesreč pošlje vlogo oziroma spis v odločitev.
...
Priloga 1: Vloga za dodelitev sredstev za odpravo potresa v Posočju 12. julija 2004
