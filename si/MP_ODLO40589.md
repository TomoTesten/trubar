---
kratica: MP_ODLO40589
naziv: "Odlok o javni gasilski službi v Občini Brežice (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2016-01-2976"
---

# Odlok o javni gasilski službi v Občini Brežice (ODLO)
...
(1)
Gasilstvo je obvezna lokalna javna služba, katere trajno in nemoteno opravljanje zagotavlja občina.
...
(1)
Naloge gašenja in reševanja ob požarih, druge, zlasti preventivne naloge varstva pred požarom, določene naloge zaščite in reševanja ljudi ter premoženja ob naravnih in drugih nesrečah ter določene storitve opravljajo gasilske enote prostovoljnih gasilskih društev.
...
(1)
Gasilske enote v občini so prostovoljne, glede na območje delovanja pa teritorialne.
...
(1)
Gasilske enote prostovoljnih gasilskih društev opravljajo javno gasilsko službo skladno z veljavno zakonodajo in s tem odlokom. Za opravljanje javne gasilske službe mora gasilska enota z občino skleniti pogodbo o opravljanju javne gasilske službe. S pogodbo se določijo medsebojne pravice in obveznosti pogodbenih strank pri izvajanju javne gasilske službe.
...
(1)
Gasilska zaščitna in reševalna oprema, gasilski domovi in orodišča ne morejo biti predmet izvršbe ali stečaja.
...
(1)
Prostovoljnemu gasilcu pripadajo med usposabljanjem in intervencijo nadomestila v skladu z vejavnimi predpisi.
...
(1)
Občina krije izgubljeni zaslužek in nadomestilo plač, stroške za prehrano iz 18. člena tega odloka ter prispevke in stroške iz 19. člena tega odloka.
...
(1)
Prostovoljna gasilska društva v občini se povezujejo v Gasilsko zvezo Brežice (v nadaljnjem besedilu: gasilska zveza).
...
(1)
Gasilska zveza, v katero se povezujejo prostovoljna gasilska društva v občini, daje:
...
(1)
Delodajalec je dolžan omogočiti opravičeno odsotnost z dela v skladu s splošnimi predpisi o delovnih razmerjih operativnemu gasilcu, ki je bil med delom pozvan k opravljanju nalog zaščite, reševanja in pomoči zaradi požara ali druge nesreče v skladu z načrtom obveščanja in aktiviranja gasilskih enot iz prejšnjega člena in je član gasilske enote, ki opravlja javno gasilsko službo.
...
(1)
Vodja intervencije iz prejšnjega člena tega odloka ima pravice in dolžnosti, da:
...
(1)
Lastniki oziroma uporabniki zemljišč, stavb in drugih objektov morajo ob požaru ali drugi nesreči gasilcem in drugim sodelujočim v intervenciji dovoliti:
...
(1)
Stroške intervencije, ki izhajajo iz nalog gasilstva v skladu s tem odlokom krije občina.
