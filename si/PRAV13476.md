---
kratica: PRAV13476
naziv: "Splošni akt o strokovnem izpitu za pooblaščenega arhitekta, pooblaščenega krajinskega arhitekta in pooblaščenega prostorskega načrtovalca"
vrsta: "pravilnik"
datum: 2018-06-12
sop: 2018-01-2007
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2018-01-2007"
---

# Splošni akt o strokovnem izpitu za pooblaščenega arhitekta, pooblaščenega krajinskega arhitekta in pooblaščenega prostorskega načrtovalca
...
(1)
Ta splošni akt določa podrobnejše pogoje, način, postopek opravljanja strokovnega izpita in obseg izpitnih vsebin za pooblaščenega arhitekta, pooblaščenega krajinskega arhitekta in pooblaščenega prostorskega načrtovalca (v nadaljnjem besedilu: strokovni izpit).
...
(1)
Kandidat mora imeti izobrazbo, pridobljeno v skladu z Zakonom o arhitekturni in inženirski dejavnosti (Uradni list RS, št. 61/17; v nadaljnjem besedilu: ZAID), ter druga strokovna znanja in kompetence, ki so potrebne za izvajanje nalog s strokovnega področja, za katero kandidat pridobiva poklicni naziv.
...
(1)
ZAPS zagotavlja opravljanje strokovnih izpitov za pooblaščenega arhitekta, pooblaščenega krajinskega arhitekta in pooblaščenega prostorskega načrtovalca.
...
(1)
Na predlog strokovnih svetov matičnih sekcij imenuje člane izpitnih komisij upravni odbor ZAPS, in sicer:
...
(1)
Izpitna komisija za opravljanje posameznega izpita ima najmanj tri člane, od katerih je eden predsednik.
...
(1)
Kandidat lahko pristopi k strokovnem izpitu, če je oddal popolno prijavo najmanj 60 dni pred razpisanim rokom za strokovni izpit.
...
(1)
Če je kandidat v prijavi k strokovnemu izpitu navedel, da bo izdelal pisno nalogo, mu izpitna komisija na podlagi poročila mentorja določi naslov naloge.
...
(1)
Če kandidat ne pristopi k opravljanju strokovnega izpita ali če odstopi, ko je strokovni izpit že začel opravljati, se šteje, da strokovnega izpita ni opravil, o čemur mu pristojna služba ZAPS po uradni dolžnosti izda sklep, zoper katerega je dovoljena pritožba.
...
(1)
Pristojna služba ZAPS razpiše za vsako strokovno področje najmanj dva izpitna roka na leto.
...
(1)
Izpitna komisija ugotovi uspeh kandidata na podlagi ocen iz posameznih vsebinskih sklopov. Uspeh kandidata se oceni z ocenama »je opravil« ali »ni opravil«.
...
(1)
Kandidatu, ki je opravil strokovni izpit, pristojna služba ZAPS izda potrdilo o opravljenem strokovnem izpitu na obrazcu iz Priloge 2, ki je sestavni del tega splošnega akta.
...
(1)
Stroške strokovnega izpita plača kandidat, če se je na izpit prijavil sam, oziroma njegov delodajalec, če je on prijavil kandidata na strokovni izpit.
...
(1)
Predsedniku in članom izpitne komisije za delo v izpitni komisiji pripadata nagrada in nadomestilo za potne stroške. Nagrada in potni stroški predsednika in članov izpitne komisije so skupaj s stroški ZAPS vključeni v skupni znesek izpitnih stroškov.
...
(1)
Za vsakega kandidata, pristojna služba ZAPS vzpostavi, vodi in vzdržuje spis, ki vsebuje vse listine in dokumente v zvezi z opravljanjem strokovnega izpita.
...
(1)
Za kandidate, ki so opravili strokovni izpit, ZAPS vzpostavi, vodi in vzdržuje knjigo strokovnih izpitov. Knjiga strokovnih izpitov se vzpostavi, vodi in vzdržuje ločeno po področjih strokovnih izpitov.
...
(1)
Kandidat ima pravico do ugovora zoper postopek pri opravljanju strokovnega izpita ali oceno v osmih dneh po končanem strokovnem izpitu.
