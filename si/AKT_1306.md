...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2023-01-0375"
---
...
(1)
Sistem RDS se lahko uporablja na podlagi odločb o dodelitvi radijskih frekvenc, katerih imetniki so:
...
(1)
Kodo za podatkovno skupino PI določi agencija z odločbo o dodelitvi radijskih frekvenc na podlagi programa, za katerega se izdaja odločba.
...
(1)
Osemznakovno ime programa za podatkovno skupino PS določi agencija z odločbo o dodelitvi radijskih frekvenc na podlagi imena programa, za katerega se izdaja odločba v skladu s pravili za tvorjenje osemznakovnega imena programa za podatkovno skupino PS, določenimi v tem splošnem aktu.
...
(1)
Uporaba aktivne zastavice v podatkovni skupini TP je dovoljena samo za tiste radijske postaje, ki oddajajo program, ki vsebuje obvestila o cestnem prometu, ki so signalizirana prek zastavice v podatkovni skupini TA.
...
(1)
Podatkovna skupina RP je namenjena prenosu informacij za storitve osebnega klica (angl. »paging«) prek sistema RDS.
