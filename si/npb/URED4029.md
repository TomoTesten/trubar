...
npb: "NPB 3"
veljaOd: 2006-07-25
vir: "https://pisrs.si/pregledNpb?id=URED4029"
---
...
Neuradno prečiščeno besedilo Uredbe o izvedbi rednega letnega javnega razpis za sofinanciranje ustvarjanja programskih vsebin medijev obsega:
-       Uredbo o izvedbi rednega letnega javnega razpisa za sofinanciranje ustvarjanja programskih vsebin medijev (Uradni list RS, št. 78/06 z dne 25. 7. 2006),
-       Uredbo o spremembi Uredbe o izvedbi rednega letnega javnega razpisa za sofinanciranje ustvarjanja programskih vsebin medijev (Uradni list RS, št. 4/11 z dne 21. 1. 2011),
-       Uredbo o spremembah in dopolnitvah Uredbe o izvedbi rednega letnega javnega razpisa za sofinanciranje ustvarjanja programskih vsebin medijev (Uradni list RS, št. 8/12 z dne 3. 2. 2012),
-       Zakon o medijih - ZMed-1 (Uradni list RS, št. 69/25 z dne 12. 9. 2025).

## UREDBA


## o izvedbi rednega letnega javnega razpisa za sofinanciranje ustvarjanja programskih vsebin medijev (prenehala veljati)
...
(2) Projekti se sofinancirajo v največ 50-odstotnem deležu upravičenih stroškov iz sredstev proračuna Republike Slovenije. Projekti se lahko sofinancirajo tudi iz drugih javnih virov, vendar skupaj ne sme presegati 50 % vseh upravičenih stroškov projekta.
(3) (črtan) .
(4) (črtan) .
