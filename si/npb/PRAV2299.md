...
npb: "NPB 3"
veljaOd: 1995-03-10
vir: "https://pisrs.si/pregledNpb?id=PRAV2299"
---

# Pravilnik o štipendiranju

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o štipendiranju obsega :
-        Pravilnik o štipendiranju (Uradni list RS, št. 14/95 z dne 10. 3. 1995),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o štipendiranju (Uradni list RS, št. 19/96 z dne 5. 4. 1996),
-        Pravilnik o spremembi in dopolnitvah pravilnika o štipendiranju (Uradni list RS, št. 83/02 z dne 27. 9. 2002),
-        Pravilnik o spremembah in dopolnitvah pravilnika o štipendiranju (Uradni list RS, št. 34/04 z dne 8. 4. 2004).
...
Študijski uspeh Izobraževanje v kraju stalnega prebivanja št. točk Izobraževanje izven kraja stalnega prebivanja št. točk 6,0 do 7,0 570 1040 7,1 do 7,3 685 1155 7,4 do 7,6 775 1245 7,7 do 7,8 835 1305 7,9 do 8,1 920 1390 8,2 do 8,3 980 1450 8,4 do 8,6 1070 1540 8,7 do 8,9 1155 1625 9,00 do 10,0 1465 1935
...
Na podlagi kriterijev, ki jih določi komisija iz 6. člena pravilnika, Ministrstvo za pravosodje lahko štipendistom odobri povračilo stroškov za dodatno izobraževanje tujih jezikov. (črtan)

### 4. člen

Višino točke iz prejšnjega člena določa Vlada Republike Slovenije in se usklajuje glede na rast izhodiščne plače za prvi tarifni razred (koeficient 1.00) po kolektivni pogodbi za negospodarske dejavnosti.
...
Višina štipendije se med šolskim letom valorizira glede na rast plač delavcev v republiških upravnih organih. (črtan)
IV. POSTOPEK DODELJEVANJA ŠTIPENDIJ

### 5. člen

Štipendija se dodeli na podlagi razpisa, ki se objavi v Uradnem listu Republike Slovenije in vsebuje naslednje podatke:
...
Pravilnik o štipendiranju (Uradni list RS, št. 14/95 ) vsebuje naslednji končni določbi:
...
Pravilnik o spremembah in dopolnitvah Pravilnika o štipendiranju (Uradni list RS, št. 19/96 ) vsebuje naslednjo končno določbo:
»3. člen
Ta pravilnik začne veljati osmi dan po objavi v Uradnem listu Republike Slovenije.«.
Pravilnik o spremembi in dopolnitvah Pravilnika o štipendiranju (Uradni list RS, št. 83/02 ) vsebuje naslednjo končno določbo:
»2. člen
Ta pravilnik začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
Pravilnik o spremembah in dopolnitvah Pravilnika o štipendiranju (Uradni list RS, št. 34/04 ) vsebuje naslednji prehodni in končno določbo:
