---
kratica: URED740
naziv: "Uredba o merilih za kategorizacijo javnih cest"
sop: 1997-01-2576
npb: "NPB 1"
veljaOd: 1997-08-08
vir: "https://pisrs.si/pregledNpb?id=URED740"
---

# Uredba o merilih za kategorizacijo javnih cest

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Uredbe o merilih za kategorizacijo javnih cest obsega:
-        Uredbo o merilih za kategorizacijo javnih cest (Uradni list RS, št. 49/97 z dne 8. 8. 1997),
-        Uredbo o spremembi Uredbe o merilih za kategorizacijo javnih cest (Uradni list RS, št. 113/09 z dne 31. 12. 2009).
...
(5) Nivo rednega vzdrževanja lokalnih cest iz drugega lokalnih cestah.
(6) Javne ceste v naseljih, katerih pretežna prometna funkcija je dostop do posameznih lokacij v zaključenih prostorskih (ulice, stanovanjske ceste, industrijske ceste in druge dostopne ceste), se kategorizirajo kot javne poti.
...
-        najvišja kategorija se dodeli javni cesti, ki izpolnjuje merila pa so si po svoji teži medsebojno enakovredna;
...
(1) Po zgraditvi avtoceste ali hitre ceste se obstoječa državna cesta ali odsek te ceste, ki poteka vzporedno z novozgrajeno daljinsko cesto in povezuje najmanj dve središči regionalnega pomena, prekategorizira med regionalne ceste tako, da se zagotovi nepretrgana vzporedna povezava te kategorije.
...
Uredba o merilih za kategorizacijo javnih cest (Uradni list RS, št. 49/97 ) vsebuje naslednje prehodne in končne določbe:
...
(1) Predlogi za spremembe in dopolnitve kategorizacije državnih cest se dajejo po postopku, določenim v 17. merilih iz 11. in 12. člena te uredbe.
(2) Predloge sprememb in dopolnitev kategorizacije občinskih cest pošlje občina v predhoden pregled in mnenje Direkciji Republike Slovenije za ceste. Direkcija Republike Slovenije za ceste mora mnenje o predlogu, določeno v po njegovem prejemu. Če v predlogu ugotovi sporne kategorizacije posameznih občinskih cest, razvrstitve lokalnih cest v podkategorije ali označitve občinskih cest, o tem pisno obvesti občino in Ministrstvo za promet in zveze. Sporne rešitve v kategorizaciji občinskih cest se rešujejo po postopku, kot ga določa zakon.
...
Uredba o spremembi Uredbe o merilih za kategorizacijo javnih cest (Uradni list RS, št. 113/09 ) vsebuje naslednjo končno določbo:
»2. člen
Ta uredba začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
