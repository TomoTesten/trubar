---
kratica: PRAV13853
naziv: "Pravilnik o pogojih in merilih za izdajatelja pomnilniških kartic za zapisovalno opremo v cestnih prevozih ter načinu oblikovanja in določanja cene za izdajo kartice"
sop: 2020-01-0063
npb: "Osnovni"
veljaOd: 2020-01-17
vir: "https://pisrs.si/pregledNpb?id=PRAV13853"
---

# Pravilnik o pogojih in merilih za izdajatelja pomnilniških kartic za zapisovalno opremo v cestnih prevozih ter načinu oblikovanja in določanja cene za izdajo kartice
...
-  obsegati morajo najmanj 60 m 2 v najmanj treh prostorih (sobah) z ustreznimi pomožnimi prostori;
...
TC = 150 * (C v - C) / (C v - C m )
C m –  minimalna lastna cena
C v –   maksimalna lastna cena
...
TP 1 = 6 * (P - P m ) / (P v - P m )
P m –  najmanjše število uradnih ur v tednu
P v –   največje število uradnih ur v tednu
P –    število uradnih ur v tednu posameznega vlagatelja
TP 1 –     število točk za alinejo »število uradnih ur v tednu«
...
TP 2 = 1
TP 2 – število točk za alinejo »načini vlaganja zahtev za kartico«
...
TP 3 = 1
TP 3 – število točk za alinejo »način zagotavljanja pomoči uporabnikom«
Skupno število točk za merilo »prijaznost« je:
TP = TP 1 + TP 2 + TP 3 (število točk za merilo »prijaznost«)
...
ministrica
za infrastrukturo
Priloga: Posamezne postavke cene za določitev lastne cene tahografskih kartic
