---
kratica: PRAV9143
naziv: "Pravilnik o programu in načinu opravljanja strokovnega izpita za opravljanje funkcije upravitelja v postopkih zaradi insolventnosti in prisilne likvidacije"
sop: 2008-01-3362
npb: "NPB 2"
veljaOd: 2008-07-25
vir: "https://pisrs.si/pregledNpb?id=PRAV9143"
---
...
Neuradno prečiščeno besedilo Pravilnika o programu in načinu opravljanja strokovnega izpita za opravljanje funkcije upravitelja v postopkih zaradi insolventnosti in prisilne likvidacije obsega:
-        Pravilnik o programu in načinu opravljanja strokovnega izpita za opravljanje funkcije upravitelja v postopkih zaradi insolventnosti in prisilne likvidacije (Uradni list RS, št. 76/08 z dne 25. 7. 2008),
-        Pravilnik o spremembi in dopolnitvi Pravilnika o programu in načinu opravljanja strokovnega izpita za opravljanje funkcije upravitelja v postopkih zaradi insolventnosti in prisilne likvidacije (Uradni list RS, št. 7/11 z dne 4. 2. 2011),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o programu in načinu opravljanja strokovnega izpita za opravljanje funkcije upravitelja v postopkih zaradi insolventnosti in prisilne likvidacije (Uradni list RS, št. 38/22 z dne 18. 3. 2022).

## PRAVILNIK


## o programu in načinu opravljanja strokovnega izpita za opravljanje funkcije upravitelja v postopkih zaradi insolventnosti in prisilne likvidacije
...
(5) Pripravljalne seminarje izvajajo strokovnjaki s pravnega in ekonomskega področja. Minister z odredbo določi višino plačila v neto znesku za delo in povračilo stroškov izvajalcem pripravljalnih seminarjev.
(6) Stroške izvedbe pripravljalnih seminarjev na podlagi izstavljenega računa krije kandidat po ceniku, ki ga sprejme Vlada Republike Slovenije, na predlog ministra. Če se kandidat pripravljalnega seminarja ne udeleži, se mu že plačani stroški ne vrnejo, razen če po postopku in pod pogoji, ki jih za odstop od izpita določa 19. člen tega pravilnika, izkaže, da se seminarja ni udeležil iz upravičenega razloga.
IV. PRIJAVA K IZPITU
...
(3) Ustni del izpita opravlja kandidat najpozneje sedem delovnih dni po opravljenem pisnem delu izpita.
...
(3) Kandidat, ki izpita ni opravil, lahko v naslednjem izpitnem roku z novo prijavo ponovno opravlja izpit.
(4) Kandidat ima pravico celoten izpit opravljati največ trikrat.
...
(2) Potrdilo podpiše predsednik izpitne komisije. Potrdilo o opravljenem izpitu se izda v dveh izvodih, od katerih prejme enega kandidat, drugi pa ostane v spisu ministrstva.
...
(2) O upravičenosti razlogov za odstop od izpita odloči minister na podlagi pisne obrazložitve in predloženih dokazil kandidata. Kandidat mora poslati pisno obrazložitev v sedmih dneh od dneva, določenega za opravljanje izpita.
...
Obrazec št. 1: Potrdilo o opravljenem izpitu
Obrazec št. 2: Zapisnik o poteku izpita
