---
kratica: NAVO221
naziv: "Pravilnik za izdelavo in potrditev etažnega načrta"
sop: 2000-01-0096
npb: "NPB 1"
veljaOd: 2000-01-13
vir: "https://pisrs.si/pregledNpb?id=NAVO221"
---

# Pravilnik za izdelavo in potrditev etažnega načrta

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika za izdelavo in potrditev etažnega načrta obsega:
-       Navodilo za izdelavo in potrditev etažnega načrta (Uradni list RS, št. 2/00 z dne 13. 1. 2000),
-       Pravilnik o spremembah navodila za izdelavo in potrditev etažnega načrta (Uradni list RS, št. 43/03 z dne 9. 5. 2003).
...
(1) Etažni načrt se izdela na obrazcih z vsebino in v obliki, določeni s tem pravilnikom.
(2) Obrazci etažnega načrta EN 1, EN 2, EN 3-g, EN 3-i in EN 4 so sestavni del tega pravilnika in so objavljeni skupaj z njim.
...
(2) V načrtu delov stavbe se v merilu 1:200 prikaže oblika in velikost delov stavbe s prostori. Prostori se označijo z oznakami A1 do An (prostori iz točke a) drugega odstavka 8. člena tega pravilnika), z oznakami B1 do Bn (prostori iz točke b) drugega odstavka 8. člena tega pravilnika) in z oznakami C1 do Cn (prostori iz točke c) drugega odstavka 8. člena tega pravilnika). Mere prostorov so kotirane in izražene v metrih, zaokrožene na dve decimalki. Debeline zidov se ne kotirajo. Zidovi debeline do vključno 0,12 m se rišejo z enojno črto, zidovi debeline nad 0,12 m pa z dvojno črto. Zidovi debeline nad 0,12 m se senčijo, razen na mestih vrat in oken. Vhod v posamezen del stavbe se označi s puščico.
...
Nadaljnji imetnik pravice na posameznem delu stavbe lahko etažni načrt preriše in ga dopolni v skladu s tem pravilnikom.
...
(1) Po vložitvi zahtevka za potrditev etažnega načrta (v nadaljevanju: zahtevek) geodetska uprava preveri, ali je imetnik pravice na posameznem delu stavbe (v nadaljevanju: vlagatelj) zahtevku predložil vsa z zakonom predpisana dokazila in če je etažni načrt izdelan v skladu s tem pravilnikom.
...
-       če etažni načrt ni izdelan v skladu s tem pravilnikom.
...
(5) Podatki iz drugega odstavka 14. člena tega pravilnika se evidentirajo v evidenco o stavbah ne glede na določili prvega in drugega odstavka tega člena.
...
(2) Dokler geodetska uprava ne prejeme pravnomočnega zemljiškoknjižnega sklepa o vpisu lastninske pravice na posameznem delu stavbe, izdaja podatke o delih stavbe v obliki kopije potrdila iz šestega odstavka 12. člena tega pravilnika.
Obrazec EN 1
Obrazec EN 2
Obrazec EN 3g
Obrazec EN 3i
Obrazec EN4
Izjava o skladnosti
Navodilo za izdelavo in potrditev etažnega načrta (Uradni list RS, št. 2/00 ) vsebuje naslednjo končno določbo:
»VII. KONČNA DOLOČBA
...
Pravilnik o spremembah navodila za izdelavo in potrditev etažnega načrta (Uradni list RS, št. 43/03 ) spreminja 18. člen navodila tako, da se glasi:

### »18. člen


### (rok veljavnosti pravilnika)
