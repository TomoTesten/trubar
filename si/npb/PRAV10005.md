...
npb: "NPB 1"
veljaOd: 2010-11-15
vir: "https://pisrs.si/pregledNpb?id=PRAV10005"
---

# Pravilnik o načrtih za gospodarjenje z gozdovi in upravljanje z divjadjo

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o načrtih za gospodarjenje z gozdovi in upravljanje z divjadjo obsega:
-        Pravilnik o načrtih za gospodarjenje z gozdovi in upravljanje z divjadjo (Uradni list RS, št. 91/10 z dne 15. 11. 2010),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o načrtih za gospodarjenje z gozdovi in upravljanje z divjadjo (Uradni list RS, št. 200/20 z dne 29. 12. 2020).
...
-        ugotovitev o odvzemu posameznih vrst divjadi po številu in strukturi;
...
(3) Na ravni GGO se določijo naslednji ukrepi:
...
-        usmeritve za določitev ukrepov v populacijah divjadi v LUO ali v posameznih predelih LUO;
-        določitev osrednjih in robnih površin življenjskega prostora posameznih populacij divjadi za doseganje želene ciljne številčnosti ter smeri širjenja populacij divjadi v LUO ali v posameznih predelih LUO;
...
(2) Minister, pristojen za gozdarstvo in lovstvo (v nadaljnjem besedilu: minister), podpiše območni načrt, ko ga sprejme Vlada Republike Slovenije.
...
(2) Na ravni GGE se poleg podatkov iz prvega odstavka tega člena navedejo tudi:
...
-        lesna zaloga in prirastek z opisom načina njunega ugotavljanja ter možni posek, in sicer po gospodarskih kategorijah in RGR ter lastniških kategorijah;
-        objedenost mladja; vir: ploskve posebnih popisov;
-        število odmrlega drevja – samo za RGR, v katerih se ugotavlja lesna zaloga s stalnimi vzorčnimi ploskvami; vir: stalne vzorčne ploskve.
(3) Na ravni RGR se poleg podatkov iz prvega odstavka tega člena navedeta tudi površina mladovja in podmladka ter njuna sestava po drevesnih vrstah; vir: opisi sestojev.
(4) Po lastniških kategorijah se navedejo gozdni fondi in njihove spremembe glede na podatke iz preteklega gozdnogospodarskega načrta GGE.
(5) Na ravni odseka se navedejo:
...
(1) Površina gozdov se ugotavlja s projekcijo ustreznih posnetkov, pridobljenih z metodami daljinskega zaznavanja in se po potrebi preveri na terenu.
...
-        rastišče ima v povprečju proizvodno zmogljivost 4 m³ ali več na hektar letno;
...
(7) V drugih gozdovih se lesna zaloga in prirastek ocenjujeta okularno. Ne glede na pogoje iz prejšnjega odstavka se lahko okularno ocenjuje tudi lesna zaloga v RGR, katerih rastišča imajo v povprečju proizvodno zmogljivost 4 m³ ali več na hektar letno, če obsegajo gozdove z zelo nekakovostnim drevjem in nizko lesno zalogo.
...
5. Analiza preteklega gospodarjenja z gozdovi
...
(1) Analiza preteklega gospodarjenja z gozdovi zajema:
...
-        možni posek po vrstah sečenj, ločeno za iglavce in listavce in po lastniških kategorijah;
-        potrebna gojitvena in varstvena dela po lastniških kategorijah;
-        potrebni ukrepi za izboljšanje življenjskih razmer prosto živečih živali;
...
(1) Po odsekih se določijo naslednje usmeritve za gospodarjenje z gozdovi v odseku:
...
(2) Območja iz druge in tretje alinee točke i) prejšnjega odstavka se določijo kot tista območja, kjer je gradnja gozdnih prometnic potrebna in dopustna z vseh vidikov trajnostnega gospodarjenja z gozdovi.
...
(1) Podlaga za evidentiranje poseka so terenski obrazec za vpis drevja za posek, v katerega se vpisuje za posek izbrano drevje po drevesnih vrstah, debelinskih stopnjah, vrstah in vzrokih poseka ter evidentiranje nedovoljenih posekov.
...
(6) ZGS posreduje ministrstvu vlogo za sprejem gozdnogospodarskega načrta GGE, h kateri morajo biti priloženi najmanj:
...
Letni gozdnogospodarski načrt GGE vsebuje usmeritve in ukrepe za gospodarjenje z gozdovi v GGE, ki okvirno temeljijo na usmeritvah preteklega gozdnogospodarskega načrta GGE oziroma njegove morebitne spremembe ali dopolnitve, in sicer na ravneh RGR razredov, lastniških kategorij in GGE. Potrebna gojitvena, varstvena in druga dela za zagotavljanje ekoloških in socialnih funkcij gozda se določijo tudi na ravni odsekov.
...
ZGS spremlja uresničevanje gozdnogojitvenih načrtov na nivoju oddelka oziroma odseka ter jih glede na spremembe v gozdu zaradi izvajanja gozdnogojitvenih ukrepov ali drugih razlogov sproti dopolnjuje.
...
(2) V primerih večjih odstopanj na nivoju LUO in lovišč ter LPN, se mora na podlagi poziva lovske inšpekcije po zaključku leta opraviti strokovna presoja izvrševanja načrtovanih ukrepov. Presojo opravi ministrstvo, pristojno za divjad in lovstvo. Na podlagi strokovne presoje se sprejmejo nadaljnji ukrepi.
...
(2) Letni načrt lovišča in LPN se pripravi na obrazcu Letni načrt lovišča oziroma lovišča s posebnim namenom, ki je kot Priloga 2 sestavni del tega pravilnika.
(3) Letni načrt lovišča oziroma LPN iz Priloge 2 vodijo upravljavci tudi v elektronski obliki, ki mora biti stalno na vpogled resornemu ministrstvu, ZGS in lovski inšpekciji. Upravljavec lovišča oziroma LPN mora imeti v arhivu shranjeno podpisano in žigosano tiskano verzijo načrta.
...
Priloga 1: Ukrepi v življenjskem okolju divjadi
Priloga 2: Letni načrt lovišča oziroma lovišča s posebnim namenom za leto _________
Priloga 3: (črtana)
Priloga 4: (črtana)
Priloga 5: (črtana)
Priloga 6: (črtana)
Pravilnik o načrtih za gospodarjenje z gozdovi in upravljanje z divjadjo (Uradni list RS, št. 91/10 ) vsebuje naslednji končni določbi:
»X. KONČNI DOLOČBI
...
Pravilnik o spremembah in dopolnitvah Pravilnika o načrtih za gospodarjenje z gozdovi in upravljanje z divjadjo (Uradni list RS, št. 200/20 ) vsebuje naslednjo končno določbo:
»KONČNA DOLOČBA
66. člen
