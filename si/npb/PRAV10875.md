...
npb: "NPB 3"
veljaOd: 2011-12-21
vir: "https://pisrs.si/pregledNpb?id=PRAV10875"
---

# Pravilnik o obrazcih, vrstah izvršb in poteku avtomatiziranega izvršilnega postopka

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o obrazcih, vrstah izvršb in poteku avtomatiziranega izvršilnega postopka obsega:
-        Pravilnik o obrazcih, vrstah izvršb in poteku avtomatiziranega izvršilnega postopka (Uradni list RS, št. 104/11 z dne 21. 12. 2011),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o obrazcih, vrstah izvršb in poteku avtomatiziranega izvršilnega postopka (Uradni list RS, št. 88/14 z dne 8. 12. 2014),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o obrazcih, vrstah izvršb in poteku avtomatiziranega izvršilnega postopka (Uradni list RS, št. 44/16 z dne 24. 6. 2016),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o obrazcih, vrstah izvršb in poteku avtomatiziranega izvršilnega postopka (Uradni list RS, št. 13/21 z dne 29. 1. 2021).
...
(7) Elektronsko obvestilo je obvestilo, ki ga organizacija za plačilni promet pošlje sodišču skladno s prvim stavkom desetega odstavka 141. člena zakona.
...
(9) Elektronska priloga je v elektronsko obliko pretvorjena pisna listina, ki se priloži k elektronski vlogi skladno z desetim odstavkom 29. člena zakona.
...
(1) Uporabniki informacijskega sistema e-sodstvo, kot jih določa predpis iz 2. člena tega pravilnika, lahko v e-Izvršba-postopku opravljajo e-opravila v skladu s tem členom.
...
(5) Samostojni zunanji kvalificirani uporabniki, profesionalni uporabniki iz skupin notarji, odvetniki, upravitelji, Državno odvetništvo Republike Slovenije, občinska odvetništva lahko v e-Izvršba-postopku opravljajo posamezna e-Izvršba-opravila, in sicer:
...
-        opravijo pregled izvedenih procesnih dejanj v postopku, v katerem so vložili elektronsko vlogo.
(8) Samostojni zunanji kvalificirani uporabniki, uporabniki – stranke ali udeleženci postopka in samostojni zunanji kvalificirani uporabniki, profesionalni uporabniki iz skupine nepremičninske družbe lahko v e-Izvršba-postopku opravljajo vsa e-opravila iz prve in druge alineje petega odstavka tega člena, kot tudi naslednja e-opravila:
...
(11) V zadevah, v katerih organizacije za plačilni promet nastopajo kot izvrševalci sklepov o izvršbi, lahko kot samostojni zunanji kvalificirani uporabniki, uporabniki – stranke ali udeleženci postopka v e-Izvršba-postopku opravijo le naslednji e-opravili iz skupine »Vloge in druga pisanja«, in sicer posredujejo sodišču obvestilo organizacije za plačilni promet o nerealiziranem sklepu o izvršbi po 141. členu zakona ter vložijo vlogo. Enako velja v teh zadevah za pooblaščence samostojnih uporabnikov organizacij za plačilni promet.
(12) Informacijski sistem e-sodstvo mora omogočiti izvajanje e-Izvršba-opravil vsak delavnik od 8.00 do 20.00 ure.
...
Za e-Izvršba-opravila se smiselno uporabljajo pravila predpisa iz 2. člena tega pravilnika, če ni v tem pravilniku drugače določeno.
...
(2) Če elektronska vloga po zakonu ali po presoji predlagatelja vsebuje tudi obrazložitev, uporabnik besedilo obrazložitve oblikuje kot poseben elektronski dokument (nestandardiziran del besedila elektronske vloge), ki ustreza zahtevam iz 24. člena predpisa iz 2. člena tega pravilnika, in elektronski dokument priloži e-Izvršba-opravilu z uporabo ustrezne funkcionalnosti modula e-Izvršba-opravila in ga podpiše s svojim varnim elektronskim podpisom.
...
-        da se elektronska vloga opremi s časovnim žigom časa prejema elektronske vloge,
-        da se uporabniku na podportalu e-Izvršba prikaže obvestilo o času prejema elektronske vloge,
...
(3) Osebe, ki želijo izdati obrazce iz prvega odstavka 12. člena, prvega do tretjega odstavka 13. člena in prvega odstavka 16. člena tega pravilnika, morajo pred začetkom izdajanja pri CIF pridobiti potrebno število sklicnih številk (referenc), ki jih natisnejo na izdane obrazce.
...
(5) Prejeti predlog za izvršbo se na CoVL skenira skupaj z vsemi prilogami. S tem se ustvari elektronski spis.
...
(2) Če je predlogu za izvršbo priložen predlog za oprostitev plačila sodne takse, se o predlogu za oprostitev plačila sodne takse odloča istočasno z avtomatizirano obdelavo predloga za izvršbo.
...
(1) Elektronske vloge, navedene v Prilogi 5, se po elektronski poti lahko pošljejo podpisane na način iz prve alineje prejšnjega člena, razen predloga za izvršbo za izterjavo denarne terjatve na podlagi verodostojne listine, ki se po elektronski poti lahko pošlje podpisan tudi na način iz druge ali tretje alineje prejšnjega člena.
