---
kratica: URED7069
naziv: "Uredba o koncesiji za rabo termalne vode za ogrevanje in potrebe kopališča – Zdravilišče Radenci iz vrtin T-4/88 in T-5/03"
sop: 2015-01-3428
npb: "NPB 3"
veljaOd: 2015-11-20
vir: "https://pisrs.si/pregledNpb?id=URED7069"
---
...
Neuradno prečiščeno besedilo Uredbe o koncesiji za rabo termalne vode za ogrevanje in potrebe kopališča – Zdravilišče Radenci iz vrtin T-4/88 in T-5/03 obsega:
-        Uredbo o koncesiji za rabo termalne vode za ogrevanje in potrebe kopališča – Zdravilišče Radenci iz vrtin T-4/88 in T-5/03 (Uradni list RS, št. 88/15 z dne 20. 11. 2015),
-        Uredbo o spremembah in dopolnitvi Uredbe o koncesiji za rabo termalne vode za ogrevanje in potrebe kopališča – Zdravilišče Radenci iz vrtin T-4/88 in T-5/03 (Uradni list RS, št. 14/18 z dne 2. 3. 2018),
-        Uredbo o spremembah Uredbe o koncesiji za rabo termalne vode za ogrevanje in potrebe kopališča – Zdravilišče Radenci iz vrtin T-4/88 in T-5/03 (Uradni list RS, št. 67/21 z dne 30. 4. 2021),
-        Uredbo o spremembi Uredbe o koncesiji za rabo termalne vode za ogrevanje in potrebe kopališča – Zdravilišče Radenci iz vrtin T-4/88 in T-5/03 (Uradni list RS, št. 34/23 z dne 24. 3. 2023).
...
(1) Koncesija se podeli brez javnega razpisa pravni ali fizični osebi, ki ima v posesti in uporablja objekte za črpanje in odvzem termomineralne vode za izvajanje dejavnosti kopališč in ogrevanje v objektih Zdravilišča Radenci.
...
3.      ima pravnomočno uporabno dovoljenje za objekte, v katerih se rabi termomineralna voda za dejavnost kopališč, in
...
(1) Oseba, ki pridobi koncesijo (v nadaljnjem besedilu: koncesionar), mora pri izvajanju koncesije izpolnjevati naslednje okoljevarstvene pogoje, pogoje varstvenega režima in načina rabe termomineralne vode:
...
4.      zagotavljati, da je izkoristek toplotne energije odvzete termomineralne vode več kot 70 odstotkov, na način in v roku, ki sta določena s koncesijsko pogodbo. Izkoristek toplotne energije odvzete termomineralne vode se izračuna v skladu s prilogo 1, ki je sestavni del te uredbe;
...
7.      skrbeti za najmanjšo mogočo porabo termomineralne vode, ponovno uporabo termomineralne vode ter uporabo drugih metod in tehnik varčevanja z vodo;
8.      izvajati ukrepe iz predpisa, ki ureja načrt upravljanja voda za vodni območji Donave in Jadranskega morja, in
9.      uporabljati termomineralno vodo izključno za lastne potrebe, za katere se podeljuje koncesija.
...
1.      skrbeti za varstvo objektov in naprav za rabo termomineralne vode ter za njihovo redno vzdrževanje;
2.      vzpostaviti stalen nadzor nad objekti in napravami za rabo termomineralne vode ter zagotavljati dostop samo pooblaščenim osebam koncesionarja;
3.      dopustiti izvajanje meritev za potrebe državnega monitoringa termomineralnih voda na vseh vrtinah, ki jih upravlja;
4.      po navodilu koncedenta sodelovati pri izvajanju kratkotrajne (do 24-urne) popolne prekinitve odvzema vode, ki ga zaradi ocenjevanja količinskega stanja termomineralne vode praviloma enkrat letno istočasno izvedejo vsi koncesionarji, ki odvzemajo vodo iz istega termalnega vodonosnika (prekinitveni test);
5.      zagotoviti koncedentu brezplačen dostop do podatkov o dosedanjih raziskavah, ki lahko dajo podatke o termomineralni vodi;
...
(4) Koncesionar mora s tehničnimi ali drugimi ukrepi, vključno z zmanjšanjem dovoljene rabe termomineralne vode, v določenem obdobju prilagoditi izvajanje koncesije novim razmeram, če pride do:
1.      značilnega trenda zniževanja gladine termomineralne vode, ki zajema vsaj šestletno obdobje,
2.      značilnega trenda negativnih učinkov dolgoročnih sprememb režima toka termomineralne vode,
...
(6) Koncesionar mora odvzemati termomineralno vodo in izvajati koncesijo tako, da ne vpliva na drugo dovoljeno posebno rabo vode.
...
(1) Koncesionar mora zagotavljati izvajanje monitoringa, ki obsega monitoring odvzetih količin termomineralne vode ter monitoring vpliva rabe vode in nadzor nad hidravličnimi značilnostmi vrtine v skladu z zahtevami iz priloge 2 te uredbe.
...
Koncesionar plačuje plačilo za koncesijo za vsako leto rabe termomineralne vode posebej ves čas trajanja koncesije.
...
-        Q dej : letna količina iz vseh vrtin odvzete termomineralne vode v m 3 oziroma zmogljivost objekta za črpanje za obdobje, ko ni na razpolago meritev načrpane termomineralne vode, izražena brez enote za količino (m 3 ),
...
-        ΔT: temperaturna razlika med povprečno letno temperaturo termomineralne vode na ustju vrtine in 12 °C, izražena brez enote za stopinje (°),
-        D: faktor izhodiščne vrednosti enote posebne rabe vode.
(3) Višina plačila za koncesijo se v primeru vračanja neonesnažene termomineralne vode v vodonosnik za posamezno koledarsko leto izračuna po naslednji enačbi:
V koncesija_R = 0,15 × C × ((Q dej – 80 % Q vrnjene ) + (Q vod_prav – 80 % Q vrnjene )) / 2 × ΔT × 4,2 × D
kjer je:
-        Q vrnjena : letna količina vrnjene termomineralne vode v vodonosnik v m 3 , izražena brez enote za količino (m 3 ).
(4) Poročanje o količini vrnjene neonesnažene termomineralne vode iz prejšnjega odstavka se podrobneje uredi s koncesijsko pogodbo.
...
1.      globini črpanja in temperaturi termomineralne vode na ustju vrtine,
2.      stanju termomineralnih voda na vodnem telesu iz petega odstavka 1. člena te uredbe,
3.      uporabljanju termomineralne vode za oskrbo s pitno vodo,
...
Priloga 1: Izračun izkoristka toplotne energije odvzete termomineralne vode
