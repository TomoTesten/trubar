---
kratica: URED3348
naziv: "Uredba o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev"
sop: 2004-01-4596
npb: "NPB 5"
veljaOd: 2004-10-11
vir: "https://pisrs.si/pregledNpb?id=URED3348"
---

# Uredba o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Uredbe o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev obsega:
-       Uredbo o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev (Uradni list RS, št. 110/04 z dne 11. 10. 2004),
-       Uredbo o spremembi in dopolnitvi Uredbe o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev (Uradni list RS, št. 124/04 z dne 19. 11. 2004),
...
-       Zakon o spremembah in dopolnitvah Zakona o uveljavljanju pravic iz javnih sredstev – ZUPJS-C (Uradni list RS, št. 99/13 z dne 3. 12. 2013),
-       Uredbo o spremembi in dopolnitvi Uredbe o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev (Uradni list RS, št. 42/15 z dne 16. 6. 2015).
...
(4) V primeru, ko je zaradi spremembe v višini periodičnih dohodkov iz prejšnjega odstavka upravičenec prejel tudi poračun za nazaj, je dolžan to v enkratnem znesku povrniti zavezancem, oziroma plačnikom, ki so namesto njega v celoti ali delno plačevali storitev. Upravičenec do storitve pomoč družini na domu je v okviru prejetega poračuna dodatka za pomoč in postrežbo dolžan povrniti znesek v višini enega odstotka dodatka za pomoč in postrežbo za vsako uro opravljene storitve.
...
Uredba o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev (Uradni list RS, št. 110/04 ) vsebuje naslednje prehodne in končne določbe:
...
Oprostitve plačil storitev, o katerih do uveljavitve te uredbe še ni bilo odločeno, se določijo po tej uredbi.
...
Uredba o spremembi in dopolnitvi Uredbe o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev (Uradni list RS, št. 124/04 ) spreminja 42. člen uredbe tako, da se glasi:
...
spreminja 44. člen uredbe tako, da se glasi:
...
Zakon o usklajevanju transferjev posameznikom in gospodinjstvom v Republiki Sloveniji – ZUTPG (Uradni list RS, št. 114/06 ) določa:
»8. člen
...
Zakon o uveljavljanju pravic iz javnih sredstev – ZUPJS (Uradni list RS, št. 62/10 ) določa:
»62. člen
...
Zakon o spremembah in dopolnitvah Zakona o uveljavljanju pravic iz javnih sredstev – ZUPJS-C (Uradni list RS, št. 99/13 ) določa:
»32. člen
[…]
...
Uredba o spremembi in dopolnitvi Uredbe o merilih za določanje oprostitev pri plačilih socialno varstvenih storitev (Uradni list RS, št. 42/15 ) vsebuje naslednjo končno določbo:
»2. člen
