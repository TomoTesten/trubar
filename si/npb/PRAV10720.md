...
npb: "NPB 2"
veljaOd: 2011-05-03
vir: "https://pisrs.si/pregledNpb?id=PRAV10720"
---

# Pravilnik o obliki in vsebini vpisnikov in pomožnih knjig pri prekrškovnih organih

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o obliki in vsebini vpisnikov in pomožnih knjig pri prekrškovnih organih obsega:
-        Pravilnik o obliki in vsebini vpisnikov in pomožnih knjig pri prekrškovnih organih (Uradni list RS, št. 33/11 z dne 3. 5. 2011),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o obliki in vsebini vpisnikov in pomožnih knjig pri prekrškovnih organih (Uradni list RS, št. 69/13 z dne 23. 8. 2013),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o obliki in vsebini vpisnikov in pomožnih knjig pri prekrškovnih organih (Uradni list RS, št. 55/17 z dne 6. 10. 2017).
...
85.   opombe.
(2) Pod rubriko »opombe« se vpišejo podatek o tem, kje je zadeva, drugi vpisi, določeni s tem pravilnikom in drugi podatki, če je to potrebno. V rubriko »opombe« se vpisujejo tudi podatki v zvezi z vloženim predlogom za vrnitev v prejšnje stanje (npr. datum predloga, vrsta odločitve, vložitev pravnega sredstva).
(3) V zadevah kršitev predpisov o ustavljanju in parkiranju vozil v cestnem prometu se v vpisnik Pn poleg podatkov iz prvega odstavka tega člena vpisujejo tudi naslednji podatki:
...
(1) V vpisniku Obp se za vsako zadevo vpišejo naslednji podatki:
...
(2) Na seznam odvzetih predmetov se vpisujejo naslednji podatki:
...
(1) V evidenco zapadle, neplačane globe, sodne takse, stroškov postopka, odvzete premoženjske koristi in kazni za kršitev postopka se vpisujejo zadeve v zvezi z izvrševanjem zapadle, neplačane globe, sodne takse, stroškov postopka, odvzete premoženjske koristi in kazni za kršitev postopka.
