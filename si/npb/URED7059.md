---
kratica: URED7059
naziv: "Uredba o koncesiji za rabo termalne vode iz izvira Toplica za dejavnost kopališč in naravnih zdravilišč – Terme Topolšica"
sop: 2015-01-3414
npb: "NPB 2"
veljaOd: 2015-11-13
vir: "https://pisrs.si/pregledNpb?id=URED7059"
---
...
Neuradno prečiščeno besedilo Uredbe o koncesiji za rabo termalne vode iz izvira Toplica za dejavnost kopališč in naravnih zdravilišč – Terme Topolšica obsega:
-        Uredbo o koncesiji za rabo termalne vode iz izvira Toplica za dejavnost kopališč in naravnih zdravilišč – Terme Topolšica (Uradni list RS, št. 87/15 z dne 13. 11. 2015),
-        Uredbo o spremembah in dopolnitvah Uredbe o koncesiji za rabo termalne vode iz izvira Toplica za dejavnost kopališč in naravnih zdravilišč – Terme Topolšica (Uradni list RS, št. 39/19 z dne 21. 6. 2019),
-        Uredbo o spremembah in dopolnitvi Uredbe o koncesiji za rabo termalne vode iz izvira Toplica za dejavnost kopališč in naravnih zdravilišč – Terme Topolšica (Uradni list RS, št. 54/23 z dne 12. 5. 2023).

## UREDBA


## o koncesiji za rabo termalne vode iz izvira Toplica za dejavnost kopališč in naravnih zdravilišč – Terme Topolšica
...
(1) Ta uredba je koncesijski akt, na podlagi katerega Vlada Republike Slovenije (v nadaljnjem besedilu: vlada) podeli koncesijo za rabo termalne vode iz izvira Toplica za ogrevanje in hlajenje ter dejavnost kopališč in naravnih zdravilišč – Terme Topolšica (v nadaljnjem besedilu: koncesija), (ID znak 948-1345/3-0), koordinate (n: 140.511,362, e: 501.317,074, z: 372,37).
(2) Obseg vodne pravice, izražen kot največja dovoljena skupna letna prostornina (količina) rabe vode iz termalnega izvira Toplica iz prejšnjega odstavka, je 125.000 m 3 /leto. Največja dovoljena trenutna prostornina (količina) rabe podzemne vode iz termalnega izvira Toplica je 20,0 l/s.
(3) Koncesija se podeli za rabo termalne vode za potrebe dejavnosti bazenskega kopališča s klasifikacijsko številko 3.1.2., za rabo vode za ogrevanje s klasifikacijsko številko 4.2.1. in za rabo mineralne, termalne ali termomineralne vode, ki ni opredeljena drugje (hlajenje), s klasifikacijsko številko 13.2.2., v skladu s predpisom, ki ureja klasifikacijo vrst posebne rabe vode in naplavin.
...
(5) Območje koncesije obsega območje termalnega izvira Toplica iz prvega odstavka tega člena in zajema termalno podzemno vodo iz vodnega telesa podzemne vode Spodnji del Savinje do Sotle (VTPodV_1009), in sicer iz tretjega vodonosnika.
(6) Napajalno območje termalnega izvira Toplica iz prvega odstavka tega člena ter meja tega območja se prikažeta na digitalnem podatkovnem sloju v državnem koordinatnem sistemu in objavita v informacijskem sistemu okolja.
...
(1) Koncesija se podeli brez javnega razpisa pravni ali fizični osebi, ki ima v posesti in uporablja objekte za črpanje in odvzem termalne vode za ogrevanje in hlajenje ter izvajanje dejavnosti kopališč v objektih kopališč Term Topolšica.
