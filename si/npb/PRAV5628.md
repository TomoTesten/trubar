...
npb: "NPB 5"
veljaOd: 2004-03-31
vir: "https://pisrs.si/pregledNpb?id=PRAV5628"
---

# Pravilnik o požarni varnosti v stavbah

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno  prečiščeno besedilo Pravilnika o požarni varnosti v stavbah obsega:
-        Pravilnik o požarni varnosti v stavbah (Uradni list RS, št. 31/04 z dne 31. 3. 2004),
-        Pravilnik o spremembi pravilnika o požarni varnosti v stavbah (Uradni list RS, št. 10/05 z dne 4. 2. 2005),
-        Pravilnik o spremembah in dopolnitvah pravilnika o požarni varnosti v stavbah (Uradni list RS, št. 83/05 z dne 12. 9. 2005),
-        Pravilnik o spremembah in dopolnitvah pravilnika o požarni varnosti v stavbah (Uradni list RS, št. 14/07 z dne 16. 2. 2007),
-        Pravilnik o zasnovi in študiji požarne varnosti (Uradni list RS, št. 12/03 z dne 7. 2. 2013),
...
(1) V tehnični smernici iz 7. člena tega pravilnika se določijo zahtevani razredi gradbenih materialov glede na odziv na ogenj in se pri tem upošteva mesto njihove vgraditve v skladu s predpisi o požarni klasifikaciji gradbenih proizvodov.
(2) V tehnični smernici iz 7. člena tega pravilnika se določijo zahtevane požarne lastnosti stavb oziroma delov stavb v skladu s požarno klasifikacijo iz priloge 2, ki je sestavni del tega pravilnika.
...
Priloga 2: Požarna klasifikacija stavb in delov stavb
Priloga 3: ( prenehala veljati )
Pravilnik o požarni varnosti v stavbah (Uradni list RS, št. 31/04 ) vsebuje naslednje prehodne in končne določbe:
...
Pravilnik o spremembi pravilnika o požarni varnosti v stavbah (Uradni list RS, št. 10/05 ) spreminja 19. člen pravilnika tako, da se glasi:
...
Pravilnik o spremembah in dopolnitvah pravilnika o požarni varnosti v stavbah (Uradni list RS, št. 83/05 ) vsebuje naslednje prehodne in končne določbe:
»3. člen
...
5. člen
Ta pravilnik začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
Pravilnik o spremembah in dopolnitvah pravilnika o požarni varnosti v stavbah (Uradni list RS, št. 14/07 ) vsebuje naslednjo prehodno in končno določbo:
»9. člen
...
10. člen
Ta pravilnik začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
Pravilnik o zasnovi in študiji požarne varnosti (Uradni list RS, št. 12/03 ) vsebuje naslednjo končno določbo:
»12. člen

### (začetek veljavnosti)

Ta pravilnik začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
Gradbeni zakon - GZ (Uradni list RS, št. 61/17 ) v zvezi s prenehanjem veljavnosti 15. člena pravilnika določa:
»122. člen
