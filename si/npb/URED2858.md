---
kratica: URED2858
naziv: "Uredba o določitvi obrambnih potreb"
sop: 2003-01-1221
npb: "NPB 1"
veljaOd: 2003-03-27
vir: "https://pisrs.si/pregledNpb?id=URED2858"
---

# Uredba o določitvi obrambnih potreb

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Uredbe o določitvi obrambnih potreb obsega:
-    Uredbo o določitvi obrambnih potreb (Uradni list RS, št. 30/03 z dne 27. 3. 2003),
-    Uredbo o spremembah in dopolnitvah Uredbe o določitvi obrambnih potreb (Uradni list RS, št. 87/25 z dne 12. 11. 2025).
...
-  objekti in območja z infrastrukturnim omrežjem, namenjena za operativne in bojne naloge vojske, kot so poveljniška mesta, ognjeni, radarski in drugi senzorski položaji,
...
3.     območij omejene in nadzorovane rabe prostora, ki obsegajo varnostna in vplivna območja objektov, na katerih so potrebne omejitve iz varnostnih ali tehničnih razlogov in so ob območjih izključne in možne izključne rabe. To so predvsem varnostna in vplivna območja:
...
-  ognjenih položajev,
-  vojaških radarskih in drugih senzorskih položajev,
...
3. OBRAMBNE POTREBE, KI JIH JE TREBA UPOŠTEVATI PRI PROJEKTIRANJU IN GRADITVI OBJEKTOV
...
-     skupno uporabo objektov, naprav in napeljav gospodarske javne infrastrukture, kot so telekomunikacijsko omrežje, antenski stolpi, javna letališča, pristanišča in podobno,
-     načrtovano onesposobitev objekta, kot je vgradnja konstrukcijskih rešitev za rušenje in podobno,
...
-  skladišča nafte in naftnih derivatov zmogljivosti več kot 1000 m 3 ;
3.     vodnogospodarski objekti, naprave in posegi:
-  vodni zbiralniki nad 100.000 m 3 vsebine,
...
-  skladišča vnetljivih tekočin s kapaciteto 250 m 3 in več,
-  rezervoarji z napravami za polnjenje in praznjenje gorljivih, strupenih in zdravju škodljivih plinov, s prostornino posameznega rezervoarja nad 100 m 3 ,
...
5.     skladišča, silosi in hladilnice za živila ter skladišča za državne blagovne rezerve z zmogljivostjo več kot 600 m 3 .

### 10. člen

Ministrstvo, pristojno za obrambo, določa obrambne potrebe,
ki jih je treba upoštevati pri projektiranju in gradnji objektov
iz prejšnjega člena ter objektov, načrtovanih na območjih iz 2. in 3. točke 5. člena te uredbe. Investitor objekta oziroma pooblaščeni projektant mora pred začetkom projektiranja in gradnje objekta zaprositi z vlogo za določitev obrambnih potreb pri ministrstvu, pristojnem za obrambo.
