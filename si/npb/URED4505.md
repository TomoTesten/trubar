---
kratica: URED4505
naziv: "Uredba o koncesiji za rabo podzemne vode iz izvira Golobovec nad Podbrdom za stekleničenje in proizvodnjo pijač"
sop: 2007-01-5984
npb: "Osnovni"
veljaOd: 2007-12-24
vir: "https://pisrs.si/pregledNpb?id=URED4505"
---
...
0,08 × (vodno-povračilo) V(koncesija) = ----------------------------------- Q(1) + 2 × Q(2) + 2,66 × Q(3)
kjer so:
...
Če agencija ugotovi, da koncesionar ni posredoval podatkov, potrebnih za izračun višine plačila za koncesijo v predpisanem roku, ali je posredoval napačne podatke, agencija
uporabi za določitev višine plačila za koncesijo podatke o rabi podzemne vode iz svojih evidenc o rabi vode.
IV. NADZOR
...
Priloga 2: Program monitoringa za izkoriščanje vode iz izvira Golobovec nad Podbrdom
