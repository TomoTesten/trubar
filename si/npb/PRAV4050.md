---
kratica: PRAV4050
naziv: "Pravilnik o registrih prijav in pravic industrijske lastnine ter potrdilu o prednostni pravici"
sop: 2001-01-5000
npb: "NPB 2"
veljaOd: 2001-12-14
vir: "https://pisrs.si/pregledNpb?id=PRAV4050"
---
...
Neuradno prečiščeno besedilo Pravilnika o registrih prijav in pravic industrijske lastnine ter potrdilu o prednostni pravici obsega:
-        Pravilnik o registrih prijav in pravic industrijske lastnine ter potrdilu o prednostni pravici (Uradni list RS, št. 102/01 z dne 14. 12. 2001),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o registrih prijav in pravic industrijske lastnine ter potrdilu o prednostni pravici (Uradni list RS, št. 93/20 z dne 3. 7. 2020),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o registrih prijav in pravic industrijske lastnine ter potrdilu o prednostni pravici (Uradni list RS, št. 6/24 z dne 26. 1. 2024).
...
g)     naziv izuma;
h)     razvrstitev izuma po MPK;
i)       podatki o imetniku patenta: priimek, ime in naslov, če gre za fizično osebo, oziroma firma in sedež, če gre za pravno osebo;
j)       podatki o izumitelju: priimek, ime in naslov;
...
m)    navedba, ali gre za patent ali patent s skrajšanim trajanjem;
n)     številka temeljnega patenta, če gre za dopolnilni patent;
o)     številka prvotne prijave, če je bila prijava izločena;
p)     datum objave prijave;
q)     datum vložitve pisnega dokazila po 91. členu zakona (v nadaljnjem besedilu: dokazilo) oziroma dokazil in številke patentov, ki služijo kot dokazilo, oziroma navedba dokumentacije, ki je bila pridobljena po osmem odstavku 92. člena zakona;
r)      številka in datum izdaje ugotovitvene odločbe po 93. členu zakona;
s)     podatki o vzdrževanju patenta;
t)       datum zapadlosti naslednje pristojbine za vzdrževanje patenta;
u)     navedba, ali patent velja;
v)      številka in datum izdaje morebitnega sklepa o vrnitvi v prejšnje stanje po 68. členu zakona;
w)    datum in navedba vzroka prenehanja patenta;
x)      drugi podatki o patentu, če je to potrebno.
...
y)      podatki o razveljavitvi in ugotovitvi ničnosti znamke: priimek, ime in naslov vložnika, če gre za fizično osebo, oziroma firma in sedež, če gre za pravno osebo, priimek in ime oziroma firma morebitnega zastopnika, vrsta postopka: razveljavitev znamke ali ugotovitev ničnosti znamke, datum vložitve zahteve za razveljavitev ali ugotovitev ničnosti znamke, številka in datum izdaje odločbe oziroma sklepa ter navedba, ali je odločba oziroma sklep pravnomočen;
z)     drugi podatki o znamki, če je to potrebno.
...
b)     vrsta spora: upravni spor, ničnost pravic, izpodbijanje pravic, priznanje pravice izumitelja ali oblikovalca do navedbe, razveljavitev znamke, prisilna licenca, izpodbijanje vpisa spremembe v register;
...
h)     zožitev seznama blaga ali storitev pri znamki;
i)       zožitev števila videzov izdelkov pri modelu.
...
Priloga: (črtana)
Pravilnik o registrih prijav in pravic industrijske lastnine ter potrdilu o prednostni pravici (Uradni list RS, št. 102/01 ) vsebuje naslednjo končno določbo:
»VII. KONČNA DOLOČBA

### 16. člen

Ta pravilnik začne veljati petnajsti dan po objavi v Uradnem listu Republike Slovenije.«.
Pravilnik o spremembah in dopolnitvah Pravilnika o registrih prijav in pravic industrijske lastnine ter potrdilu o prednostni pravici (Uradni list RS, št. 93/20 ) vsebuje naslednjo končno določbo:
»KONČNA DOLOČBA
5. člen
Ta pravilnik začne veljati petnajsti dan po objavi v Uradnem listu Republike Slovenije.«.
Pravilnik o spremembah in dopolnitvah Pravilnika o registrih prijav in pravic industrijske lastnine ter potrdilu o prednostni pravici (Uradni list RS, št. 6/24 ) vsebuje naslednjo končno določbo:
»KONČNA DOLOČBA
4. člen
Ta pravilnik začne veljati petnajsti dan po objavi v Uradnem listu Republike Slovenije.«.
