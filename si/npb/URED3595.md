...
npb: "NPB 1"
veljaOd: 2005-09-23
vir: "https://pisrs.si/pregledNpb?id=URED3595"
---

# Uredba o izvajanju uredb (ES) o predhodnih sestavinah za prepovedane droge

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Uredbe o izvajanju uredb (ES) o predhodnih sestavinah za prepovedane droge obsega:
-       Uredbo o izvajanju uredb (ES) o predhodnih sestavinah za prepovedane droge (Uradni list RS, št. 85/05 z dne 23. 9. 2005),
-       Uredbo o spremembah in dopolnitvah Uredbe o izvajanju uredb (ES) o predhodnih sestavinah za prepovedane droge (Uradni list RS, št. 72/09 z dne 18. 9. 2009).
...
(1) Z globo od 4.200 do 104.500 eurov se kaznuje za prekršek pravna oseba ali samostojni podjetnik posameznik, če:
...
Uredba o izvajanju uredb (ES) o predhodnih sestavinah za prepovedane droge (Uradni list RS, št. 85/05 ) vsebuje naslednjo prehodno in končno določbo:
...
Uredba o spremembah in dopolnitvah Uredbe o izvajanju uredb (ES) o predhodnih sestavinah za prepovedane droge (Uradni list RS, št. 72/09 ) vsebuje naslednjo končno določbo:
»5. člen
Ta uredba začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
