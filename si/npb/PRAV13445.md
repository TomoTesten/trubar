---
kratica: PRAV13445
naziv: "Pravilnik o usposabljanju strokovnih delavcev v športu"
sop: 2018-01-2532
npb: "NPB 1"
veljaOd: 2018-07-18
vir: "https://pisrs.si/pregledNpb?id=PRAV13445"
---

# Pravilnik o usposabljanju strokovnih delavcev v športu

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o usposabljanju strokovnih delavcev v športu obsega:
-    Pravilnik o usposabljanju strokovnih delavcev v športu (Uradni list RS, št. 49/18 z dne 18. 7. 2018),
-    Pravilnik o spremembah in dopolnitvah Pravilnika o usposabljanju strokovnih delavcev v športu (Uradni list RS, št. 110/25 z dne 24. 12. 2025).
...
1. diploma o usposobljenosti (v nadaljnjem besedilu: diploma)
je javna listina, ki izkazuje naziv in stopnjo strokovne usposobljenosti;
2. formalno izobraževanje oziroma usposabljanje je izobraževanje
oziroma usposabljanje, ki posamezniku omogoča pridobitev javnoveljavne izobrazbe, poklicne kvalifikacije ali javnoveljavne listine;
3. formalne reference so pridobljena javnoveljavna izobrazba,
javnoveljavna usposobljenost ali poklicna kvalifikacija;
4. kandidat je fizična oseba, ki se prijavi na tečaj;
5. neformalno izobraževanje oziroma usposabljanje je izobraževanje oziroma usposabljanje, ki posamezniku omogoča
pridobivanje, razširjanje, obnavljanje, posodabljanje in poglabljanje znanja, ki se ne dokazuje z javnoveljavno listino;
...
8. spletna aplikacija je programsko orodje, ki je namenjeno
podpori priprave, sprejemanja oziroma potrjevanja, izvajanja in evalvacije programov usposabljanj;
9. stopnja strokovne usposobljenosti je s številko izražena vrsta strokovne usposobljenosti;
10. tečaj je zaokrožena skupina predmetov v okviru sprejetega
programa usposabljanja, ki se lahko izvaja večkrat letno v enem ali več delih;
11. udeleženec je posameznik, ki se udeleži tečaja;
12. usposabljanje je sodelovanje na tečaju;
13. vlagatelj je fizična oseba, ki je oddala vlogo za priznavanje
predhodno pridobljenih kompetenc.
...
(1) Posamezni program usposabljanja za področje športnega
treniranja, športa invalidov, športne rekreacije in športa starejših obsega obvezne ter posebne vsebine. V primeru izrazitih posebnosti posameznih vsebin v okviru istega področja
lahko nosilec programa posebne vsebine delno ali v celoti oblikuje modularno, pri čemer se ohranijo enoten naziv in kompetence
usposobljenega strokovnega delavca.
(2) Šteje, da ima posebna vsebina programa usposabljanja
za področje iz prejšnjega odstavka izrazite posebnosti, če:
– je področje zaokrožena celota v smislu izvajanja športnega
programa in
...
(3) Nosilec programa usposabljanja, ki namerava posebne
vsebine programa izvajati modularno, mora ne glede na javnost podatkov v razvidih iz 76. člena ZŠpo-1 objaviti na svoji spletni strani:
– navedbo naziva in vsebine podpodročja,
– seznam oseb, ki so zaključile usposabljanje za posamezno
podpodročje in podale soglasje za objavo svojih osebnih podatkov na seznamu, in
– povezavo do spletne strani ministrstva, na kateri je objavljen
razvid strokovno izobraženih in strokovno usposobljenih delavcev v športu.
(4) Obvezne vsebine po posameznih stopnjah usposabljanja so določene v 6. oziroma 7. členu tega pravilnika.
(5) Posebne vsebine programa usposabljanja določi nosilec programa usposabljanja, pri čemer upošteva določbe 8. oziroma 9. člena tega pravilnika.
...
– izobrazbo, pridobljeno po javnoveljavnem študijskem programu najmanj druge stopnje oziroma izobrazbo, katere raven ustreza izobrazbi, pridobljeni po javnoveljavnem študijskem
programu druge stopnje in
– formalne oziroma neformalne reference s področja vsebine,
na področju katere izvaja predavanja.
...
(1) Ceno tečaja določi nosilec usposabljanja in na prvi stopnji usposabljanja ne sme presegati zneska povprečne mesečne
neto plače v Republiki Sloveniji, na drugi stopnji usposabljanja
pa ne sme presegati trikratnika zneska povprečne mesečne neto plače v Republiki Sloveniji.
...
### (vložitev predloga za upoštevanje predhodno
pridobljenih kompetenc)

Vloga za upoštevanje predhodno pridobljenih kompetenc se vloži pri izvajalcu usposabljanja. Vlogi priloži listine, ki dokazujejo
uspešno pridobljeno znanje in ki omogočajo primerjavo skladnosti programa usposabljanja, ki ga je vlagatelj opravil s programom usposabljanja, za katerega vlagatelj oddaja vlogo (predmetnik in obseg vsebin, dokazila o usvojenih znanjih in veščinah in podobno).
...
– izpolnjevanje pogojev za pristop v program usposabljanja,
za katerega vlagatelj oddaja vlogo;
– primerljivost trajanja (število ur predhodnega izobraževanja
oziroma usposabljanja glede na obseg predmeta) ter vsebine izobraževanja oziroma usposabljanja, pri katerem se obveznost priznava;
...
– je predhodno izobraževanje oziroma usposabljanje obsegalo
ali presegalo trajanje predmeta oziroma programa usposabljanja
in vsebine ustrezajo vsebinam predmeta oziroma programa usposabljanja, pri katerem se obveznost priznava;
– so reference predavateljev skladne z referencami posamezne
vsebine v programu usposabljanja, za katerega oddaja vlogo;
– izvajalec ugotovi, da je vlagatelj usvojil znanja, potrebna za priznavanje kompetenc.
(4) Nosilec programa usposabljanja vlagatelju, ki ima priznane kompetence po programu usposabljanja v celoti, izda diplomo.
(5) Vlagatelju, za katerega izvajalec programa usposabljanja
ugotovi, da so predhodno usvojeno znanje oziroma vsebine predmetov le delno skladne z znanjem in vsebinami predmetov, ki jih pridobi udeleženec programa usposabljanja pri posameznem predmetu znotraj programa usposabljanja, se omogoči udeležba na tečaju samo pri tistih predmetih, ki jih mora še dodatno opraviti, da pridobi strokovno usposobljenost v skladu s programom usposabljanja ter s tem vse kompetence,
...
Priloga 1: Standardi znanj iz obveznih vsebin programov usposabljanj
Priloga 2: Obrazec za vložitev predloga programa usposabljanja
Priloga 3: Prijavnica na tečaj
Priloga 4: Dnevnik tečaja
Priloga 5: Osebni list udeleženca tečaja
Priloga 6: Diploma o usposobljenosti za strokovno delo v športu
