...
npb: "NPB 3"
veljaOd: 2015-08-14
vir: "https://pisrs.si/pregledNpb?id=PRAV12531"
---

# Pravilnik o izvajanju Zakona o davčnem potrjevanju računov

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o izvajanju Zakona o davčnem potrjevanju računov obsega:
-    Pravilnik o izvajanju Zakona o davčnem potrjevanju računov (Uradni list RS, št. 60/15 z dne 14. 8. 2015),
-    Pravilnik o spremembah Pravilnika o izvajanju Zakona o davčnem potrjevanju računov (Uradni list RS, št. 75/15 z dne 8. 10. 2015),
-    Pravilnik o spremembah in dopolnitvah Pravilnika o izvajanju Zakona o davčnem potrjevanju računov (Uradni list RS, št. 90/15 z dne 27. 11. 2015),
-    Pravilnik o spremembah in dopolnitvah Pravilnika o izvajanju Zakona o davčnem potrjevanju računov (Uradni list RS, št. 15/25 z dne 12. 3. 2025).
...
Ta pravilnik podrobneje ureja izvajanje Zakona o davčnem potrjevanju računov (Uradni list RS, št. 57/15, 69/17,
3/22 – ZDDV-1M, 40/23 in 100/24; v nadaljnjem besedilu:
ZDavPR).
...
(2) Vsi zneski, ki so na računu v tuji valuti, se v sporočilo s podatki o računu iz prejšnjega odstavka vpisujejo v eurih. Za preračun vrednosti iz tuje valute v domačo se uporabi tečaj, ki se skladno s predpisi, ki urejajo davek na dodano vrednost, uporablja za določitev davčne osnove.
...
(1) Podatki o avtomatih, prek katerih se opravlja prodaja
blaga ali storitev, se davčnemu organu posredujejo v okviru
sporočila s podatki o poslovnem prostoru zavezanca v skladu
s Prilogo II k temu pravilniku, ki je njegov sestavni del.
(2) Podatek o oznaki avtomata se vpiše v polje P_4.0
(oznaka poslovnega prostora). Oznaka mora biti enkratna v
okviru oznak poslovnih prostorov na nivoju zavezanca.
(3) Zavezanec za sporočanje v sporočilo s podatki o poslovnem prostoru v polje P_5.31 vpiše oznako vrste avtomata,
s katero se označi, da gre za avtomat za prodajo blaga ali
storitev, za katerega velja obveznost sporočanja podatkov o
prodaji ob vsakokratni prodaji oziroma velja obveznost sporočanja podatkov o prodaji v roku 10 delovnih dni oziroma velja
izjema od obveznosti sporočanja podatkov.
(4) Podatki o lokaciji avtomata se v sporočilo s podatki o
poslovnem prostoru vpišejo v polje P_5.32. Vpišejo se podatki
o naslovu avtomata. Če naslova avtomata ni možno natančno
določiti, se vpiše podatke o najbližjemu obstoječem naslovu.
Če podatki o naslovu niso na razpolago, se navede podatek o
geolokaciji avtomata (zemljepisna širina in dolžina).
(5) Za avtomate iz četrtega odstavka 14.a člena ZDavPR
se kot trenutek prvega pošiljanja podatkov o prodaji prek avtomata šteje prva prodaja blaga ali storitev prek avtomata.
...
(1) Identifikacijska oznaka avtomata je unikatna za vsak
avtomat.
(2) Identifikacijsko oznako avtomata določi zavezanec za
sporočanje v skladu s tretjim odstavkom tega člena.
(3) Identifikacijska oznaka avtomata je podatek o oznaki
avtomata iz drugega odstavka prejšnjega člena. Navede se v
obliki: Oznaka_avtomata (primer: AVTOMAT15).
...
(1) Zavezanec za sporočanje mora vsak avtomat označiti
z identifikacijsko oznako avtomata.
(2) Identifikacijska oznaka mora biti na avtomatu jasno
vidna, berljiva in zaščitena pred uničenjem.
(3) Na avtomatu se pred navedbo identifikacijske oznake avtomata navede kratica IOA in dvopičje (primer: IOA:
AVTOMAT15).
VI.B PODATKI O OPRAVLJENI PRODAJI
PREK AVTOMATA

### 7.č člen


### (vsebina in oblika sporočila s podatki o opravljeni prodaji
prek avtomata)

(1) Vsebina in oblika sporočila s podatki o opravljeni prodaji prek avtomata sta določeni v Prilogi I k temu pravilniku, ki
je njegov sestavni del.
(2) Pri sporočanju podatkov o opravljeni prodaji prek avtomata davčnemu organu se kot številka računa šteje številka
transakcije prodaje, ki je sestavljena iz treh delov:
1. oznake avtomata,
2. oznake elektronske naprave in
3. zaporedne številke transakcije
(3) Za določitev podatka o zaščitni oznaki izvedene prodaje se smiselno uporabljajo določbe 5. člena tega pravilnika
ter drugega odstavka tega člena.
(4) Vsi zneski, ki so v tuji valuti, se v sporočilo s podatki o
opravljeni prodaji prek avtomata iz prvega odstavka tega člena
vpisujejo v eurih. Za preračun vrednosti iz tuje valute v domačo
se uporabi tečaj, ki se skladno s predpisi, ki urejajo davek na
dodano vrednost, uporablja za določitev davčne osnove.
...
(1) Zavezanci dostopajo do informacijskega sistema davčnega organa z vzpostavitvijo varne povezave TLS.
...
(1) Zavezanec za namene izmenjave podatkov o računu iz 10. člena, podatkov o poslovnem prostoru iz 12. člena in podatkov o opravljeni prodaji prek avtomata iz 13.a člena tega pravilnika komunicira z davčnim organom prek svoje dostopne točke.
...
### (postopek izmenjave podatkov o opravljeni prodaji
prek avtomata)

Postopek izmenjave podatkov med zavezancem in informacijskim sistemom davčnega organa o opravljeni prodaji
prek avtomata v skladu z ZDavPR poteka v naslednjih korakih:
1. dostopna točka zavezanca za sporočanje pripravi podatke o opravljeni prodaji prek avtomata;
2. dostopna točka zavezanca za sporočanje pripravi sporočilo s podatki o prodaji v obliki datoteke XML ali JSON objekta
in jo elektronsko podpiše z zasebnim ključem namenskega
digitalnega potrdila iz 2. člena tega pravilnika;
3. dostopna točka zavezanca za sporočanje vzpostavi
povezavo TLS z informacijskim sistemom davčnega organa;
4. po uspešno vzpostavljeni povezavi TLS se izvede klic
spletne storitve;
5. informacijski sistem davčnega organa prejme in obdela sporočilo zavezanca za sporočanje s podatki o opravljeni
prodaji prek avtomata. Če je sporočilo obdelano uspešno, ta sistem pripravi sporočilo z odgovorom v obliki datoteke XML ali
JSON objekta. Sporočilo z odgovorom se elektronsko podpiše
z zasebnim ključem digitalnega potrdila davčnega organa in
pošlje dostopni točki zavezanca za sporočanje;
6. dostopna točka zavezanca za sporočanje prejme sporočilo z odgovorom in z javnim ključem preveri elektronski
podpis digitalnega potrdila davčnega organa;
7. postopek izmenjave podatkov o opravljeni prodaji prek
avtomata se konča.

### 13.b člen


### (postopek v primeru napake pri izmenjavi podatkov
o opravljeni prodaji prek avtomata)

(1) Če pri obdelavi sporočila s podatki o opravljeni prodaji
prek avtomata iz prejšnjega člena pride do napake, informacijski sistem davčnega organa vrne sporočilo z odgovorom v
obliki datoteke XML ali JSON objekta z opisom napake.
(2) V primeru iz prejšnjega odstavka mora zavezanec za
sporočanje odpraviti napako in davčnemu organu ponovno
poslati podatke o opravljeni prodaji prek avtomata. Šteje se, da
je davčnemu organu sporočil podatke o opravljeni prodaji prek
avtomata, ko od davčnega organa prejme potrdilo o prejemu
podatkov.
...
(1) Informacijski sistem davčnega organa je za izvajanje postopka potrjevanja računov in sporočanja podatkov o prodaji prek avtomatov dostopen v preizkusnem in produkcijskem okolju.
...
(3) Programska rešitev zavezanca mora za izvajanje postopka elektronske izmenjave podatkov o računih iz 10. člena, podatkov o poslovnih prostorih iz 12. člena in podatkov o prodaji prek
avtomata iz 13.a člena tega pravilnika izpolnjevati naslednje pogoje:
...
(4) Finančna uprava Republike Slovenije objavi tehnične specifikacije za izmenjavo podatkov o računih iz 10. člena, podatkov o poslovnih prostorih iz 12. člena in podatkov o prodaji prek
avtomata iz 13.a člena tega pravilnika na portalu eDavki.
...
V primeru napake pri obdelavi sporočila s podatki o računu iz 11. člena, sporočila s podatki o poslovnem prostoru zavezanca iz 13. člena in sporočila s podatki o opravljeni prodaji prek avtomata iz 13.b člena tega pravilnika informacijski sistem davčnega organa dostopni točki zavezanca vrne eno izmed naslednjih sporočil o napakah:
...
Priloga I: Vsebina in oblika sporočila s podatki o računu ter o sporočanju podatkov o prodaji prek avtomata
