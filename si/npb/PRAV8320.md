---
kratica: PRAV8320
naziv: "Pravilnik o pogojih za določitev bolezni zaradi izpostavljenosti azbestu in merilih za določitev višine odškodnine"
sop: 2007-01-3303
npb: "NPB 1"
veljaOd: 2007-07-10
vir: "https://pisrs.si/pregledNpb?id=PRAV8320"
---
...
Neuradno prečiščeno besedilo Pravilnika o pogojih za določitev bolezni zaradi izpostavljenosti azbestu in merilih za določitev višine odškodnine obsega:
-       Pravilnik o pogojih za določitev bolezni zaradi izpostavljenosti azbestu in merilih za določitev višine odškodnine (Uradni list RS, št. 61/07 z dne 10. 7. 2007),
-       Pravilnik o spremembah in dopolnitvah Pravilnika o pogojih za določitev bolezni zaradi izpostavljenosti azbestu in merilih za določitev višine odškodnine (Uradni list RS, št. 92/08 z dne 30. 9. 2008).
...
1.7   Najnižja intenziteta izpostavljenosti azbestu: praviloma prekoračena mejna vrednost za azbest 0,1 vl/cm 3 .
...
2.5   Najnižja intenziteta izpostavljenosti azbestu: praviloma prekoračena mejna vrednost za azbest 0,1 vl/cm 3 .
...
IZRAČUN VIŠINE ODŠKODNINE ZMANJŠANJE ŽIVLJENJSKIH FUNKCIJ V % VRSTA BOLEZNI FINANČNA OSNOVA (v eur) Nepomembno 1 Lažje stopnje 2 Srednje stopnje 3 Težje stopnje 4 Pričakovan razvoj bolezni v % Starost (za vsako leto do 75 faktor 0,01) MAKSIMUM Azbestoza 9.866,47 10 20 30 50 50 (75-starost)x0,01 21.423,52 Plaki parietalne plevre 6.434,65 10 20 30 50 20 (75-starost)x0,01 12.207,50 Difuzne zadebelitve plevre 6.434,65 10 20 30 50 20 (75-starost)x0,01 12.207,50 Benigni plevralni izliv 6.434,65 10 20 30 50 30 (75-starost)x0,01 13.281,76 Kronični plevralni izliv 6.434,65 10 20 30 50 80 (75-starost)x0,01 15.851,76 Pljučni rak, maligni mezoteliom in drugi raki, ki so posledica izpostavljenosti azbestu 15.443,16 10 20 30 50 100 (75-starost)x0,01 42.826,48 Skupna višina odškodnine = O + (Ox zmanjšanje življenjskih funkcij) + (Ox pričakovan razvoj bolezni) + (Ox starost)
...
Pravilnik o pogojih za določitev bolezni zaradi izpostavljenosti azbestu in merilih za določitev višine odškodnine (Uradni list RS, št. 61/07 ) vsebuje naslednji končni določbi:
...
Pravilnik o spremembah in dopolnitvah Pravilnika o pogojih za določitev bolezni zaradi izpostavljenosti azbestu in merilih za določitev višine odškodnine (Uradni list RS, št. 92/08 ) vsebuje naslednjo prehodno in končno določbo:
»4. člen
