...
npb: "NPB 1"
veljaOd: 2009-09-18
vir: "https://pisrs.si/pregledNpb?id=PRAV9365"
---

# Pravilnik o opremljenosti železniških postaj in postajališč

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o opremljenosti železniških postaj in postajališč obsega:
-       Pravilnik o opremljenosti železniških postaj in postajališč (Uradni list RS, št. 72/09 z dne 18. 9. 2009),
-       Pravilnik o spremembah in dopolnitvah Pravilnika o opremljenosti železniških postaj in postajališč (Uradni list RS, št. 72/10 z dne 10. 9. 2010).
...
(3) Za dostop oseb z omejeno mobilnostjo na perone je potrebno predvideti dvigala oziroma druge naprave za njihov transport. Ustrezen dostop se lahko zagotovi z izvedbo klančin, tekočih stopnic ali trakov za osebe (stez), dvigal ali dvižnih ploščadi.
...
-       navozni robovi ne smejo biti višji od 20 mm in morajo biti označeni z opozorilnimi pasovi v kontrastni barvi;
...
Priloga 1: Oznake za funkcionalno ovirane osebe
Priloga 2: Višina stopnice železniškega vozila
Priloga 3: Območje na peronu
Priloga 4: Prenosni invalidski voziček
Priloga 5: Splošni opis perona
Pravilnik o opremljenosti železniških postaj in postajališč (Uradni list RS, št. 72/09 ) vsebuje naslednje prehodne in končne določbe:
...
Pravilnik o spremembah in dopolnitvah Pravilnika o opremljenosti železniških postaj in postajališč (Uradni list RS, št. 72/10 ) vsebuje naslednjo prehodno in končno določbo:
