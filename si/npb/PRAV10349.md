...
npb: "Osnovni"
veljaOd: 2012-01-13
vir: "https://pisrs.si/pregledNpb?id=PRAV10349"
---
...
-       prostornino: m 3 , dm 3 , l ali L in
-       dolžino: m, mm.
...
(1) Rok redne overitve rezervoarjev z nazivno prostornino večjo od 10.000 m 3 je 10 let.
(2) Rok redne overitve rezervoarjev z nazivno prostornino manjšo ali enako 10.000 m 3 je 10 let, z možnostjo podaljšanja za 5 let pod pogoji iz VII. poglavja tega pravilnika.
VII. PREGLED IN PRESKUS REZERVOARJA Z NAMENOM PODALJŠANJA VELJAVNOSTI OVERITVE

### 22. člen

Imetnik rezervoarja z nazivno prostornino manjšo ali enako 10.000 m 3 lahko zahteva še v času, ko ima rezervoar veljavno overitev vendar ne prej kot eno leto pred njenim iztekom, pregled in preskus rezervoarja z namenom podaljšanja veljavnosti overitve (v nadaljnjem besedilu: pregled in preskus rezervoarja).
...
potrjena pri najmanj petih različnih višinah rezervoarja,
pri čemer velja, da je:
ΔV k = V k (h+Δh)- V k (h)
ΔV 0 = V 0 (h+Δh)- V 0 (h)
in je:
V k (h) prostornina pri višini tekočine h določena pri pregledu in preskusu rezervoarja, V 0 (h) prostornina pri višini tekočine h določena po veljavni prostorninski tabeli, u k polovica vrednosti največje dopustne razširjene merilne negotovosti iz 5. člena tega pravilnika glede na metodo, s katero se izvaja pregled in preskus rezervoarja, izražena v odstotkih, u 0 standardna merilna negotovost (k=1) veljavne prostorninske tabele, izražena v odstotkih, Δh je višina, ki predstavlja najmanj 5 % nazivne prostornine rezervoarja.
...
dr. Igor Lukšič l.r.
Minister
Priloga 1: Standardne metode za kalibracijo rezervoarja
Priloga 2: Postopki za merjenje prostornine tekočine shranjene v rezervoarju
