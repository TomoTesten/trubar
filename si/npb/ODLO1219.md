...
npb: "NPB 2"
veljaOd: 2003-11-29
vir: "https://pisrs.si/pregledNpb?id=ODLO1219"
---
...
Neuradno prečiščeno besedilo Odloka o višini sredstev za ukrepe kmetijske strukturne politike Programa razvoja podeželja 2000–2006 (SAPARD) obsega:
-       Odlok o višini sredstev za ukrepe kmetijske strukturne politike Programa razvoja podeželja 2000–2006 (SAPARD) (Uradni list RS, št. 77/02 z dne 30. 8. 2002),
-       Odlok o spremembah in dopolnitvah odloka o višini sredstev za ukrepe kmetijske strukturne politike programa razvoja podeželja 2000–2006 (SAPARD) (Uradni list RS, št. 88/03 z dne 11. 9. 2003),
-       Odlok o spremembah in dopolnitvah odloka o višini sredstev za ukrepe kmetijske strukturne politike programa razvoja podeželja 2000–2006 (SAPARD) (Uradni list RS, št. 117/03 z dne 28. 11. 2003).
...
Za sofinanciranje izvajanja programa SAPARD za leto 2000 in za doseganje ciljev, opredeljenih v programu SAPARD, se iz proračuna Republike Slovenije za leta 2002 do 2004 dodelijo nepovratna sredstva:
...
5.   tehnično pomoč do višine 3,482.000 SIT;
...
Za naložbe v kmetijska gospodarstva se sredstva dodelijo za vse namene iz uredbe o ukrepih kmetijske strukturne politike programa razvoja podeželja 2000-2006 (SAPARD; Uradni list RS, št. 107/01, 74/02 in 68/03; v nadaljnjem besedilu: uredba).
...
Za sofinanciranje izvajanja programa SAPARD za leto 2001 in za doseganje ciljev, opredeljenih v programu SAPARD, se iz proračuna Republike Slovenije za leta 2002 do 2005 dodelijo nepovratna sredstva:
A)  s proračunske postavke 1347 SAPARD – lastna udeležba za:
...
4.   razvoj in izboljšanje infrastrukture na podeželju do višine 86,078.000 SIT,
5.   tehnično pomoč do višine 3,179.000 SIT;
B)  s proračunske postavke 1346 SAPARD – tuja donacija za:
...
4.   razvoj in izboljšanje infrastrukture na podeželju do višine 172,156.000 SIT,
...
-       ureditev vodne infrastrukture na podeželju za preskrbo s pitno vodo (2. točka 7. člena uredbe).
Za tehnično pomoč se sredstva dodelijo za vse namene iz uredbe.
III.A PROGRAM SAPARD ZA LETO 2002

### 5.a člen

Za sofinanciranje izvajanja programa SAPARD za leto 2002 in za doseganje ciljev, opredeljenih v programu SAPARD, se iz proračuna Republike Slovenije za leta 2003 do 2006 dodelijo nepovratna sredstva:
A)  s proračunske postavke 1347 SAPARD – lastna udeležba za:
...
-       ureditev vodne infrastrukture na podeželju za preskrbo s pitno vodo (2. točka 7. člena uredbe).
Za tehnično pomoč se sredstva dodelijo za vse namene iz uredbe.
III.B PROGRAM SAPARD ZA LETO 2003
...
Sredstva iz prvega odstavka 2. člena tega odloka se koristijo:
-       za proračunska leta 2002 do 2004:
A)  s proračunske postavke 1347 SAPARD – lastna udeležba, za posamezni namen največ do višine, kot znaša skupni znesek iz prvega odstavka 2. člena tega odloka za posamezen namen, vendar skupno za vse namene največ do višine veljavnega proračuna Republike Slovenije za leta 2002 do 2004;
B)  s proračunske postavke 1346 SAPARD – tuja donacija, za posamezni namen največ do višine, kot znaša skupni znesek iz prvega odstavka 2. člena tega odloka za posamezen namen, vendar skupno za vse namene največ do višine veljavnega proračuna Republike Slovenije za leta 2002 do 2004.
...
Sredstva iz prvega odstavka 5.a člena tega odloka se koristijo iz proračuna Republike Slovenije do 31. decembra 2005.
Sredstva iz prvega odstavka 5.a člena tega odloka se koristijo:
-       za proračunska leta 2003 do 2006:
A)  s proračunske postavke 1347 SAPARD – lastna udeležba, za posamezni namen največ do višine, kot znaša skupni znesek iz prvega odstavka 5.a člena tega odloka za posamezen namen, vendar skupno za vse namene največ do višine veljavnega proračuna Republike Slovenije za leta 2003 do 2006;
B)  s proračunske postavke 1346 SAPARD – tuja donacija, za posamezni namen največ do višine, kot znaša skupni znesek iz prvega odstavka 5.a člena tega odloka za posamezen namen, vendar skupno za vse namene največ do višine veljavnega proračuna Republike Slovenije za leta 2003 do 2006.
