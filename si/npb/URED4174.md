...
npb: "NPB 1"
veljaOd: 2006-05-19
vir: "https://pisrs.si/pregledNpb?id=URED4174"
---
...
Neuradno prečiščeno besedilo Uredbe o izvajanju uredb Sveta (ES) in uredb Komisije (ES) o radioaktivnem onesnaženju živil in krme obsega:
-       Uredbo o izvajanju uredb Sveta (ES) in uredb Komisije (ES) o radioaktivnem onesnaženju živil in krme (Uradni list RS, št. 52/06 z dne 19. 5. 2006),
-       Uredbo o spremembah in dopolnitvi Uredbe o izvajanju uredb Sveta (ES) in uredb Komisije (ES) o radioaktivnem onesnaženju živil in krme (Uradni list RS, št. 38/10 z dne 14. 5. 2010).
...
Z globo od 2.000 do 33.000 eurov se kaznuje za prekršek pravna oseba, če:
-       daje v promet oziroma uvaža živila oziroma krmo, ki ni v skladu z Uredbo 3954/87/ES in z Uredbo 770/90/ES;
...
Uredba o izvajanju uredb Sveta (ES) in uredb Komisije (ES) o radioaktivnem onesnaženju živil in krme (Uradni list RS, št. 52/06 ) vsebuje naslednjo končno določbo:

### »5. člen

Ta uredba začne veljati petnajsti dan po objavi v Uradnem listu Republike Slovenije.«.
Uredba o spremembah in dopolnitvi Uredbe o izvajanju uredb Sveta (ES) in uredb Komisije (ES) o radioaktivnem onesnaženju živil in krme (Uradni list RS, št. 38/10 ) vsebuje naslednjo končno določbo:
»5. člen
