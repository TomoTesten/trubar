...
npb: "NPB 1"
veljaOd: 2013-04-19
vir: "https://pisrs.si/pregledNpb?id=URED6378"
---

# Uredba o razvojnem svetu kohezijske regije

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Uredbe o razvojnem svetu kohezijske regije obsega:
-        Uredbo o razvojnem svetu kohezijske regije (Uradni list RS, št. 33/13 z dne 19. 4. 2013),
-        Uredbo o spremembah in dopolnitvah Uredbe o razvojnem svetu kohezijske regije (Uradni list RS, št. 61/16 z dne 23. 9. 2016).
...
(3) Svet ima sekretarja, ki ga imenuje minister, pristojen za regionalni razvoj, izmed javnih uslužbencev ministrstva, pristojnega za regionalni razvoj (v nadaljnjem besedilu: ministrstvo). Sekretar opravlja administrativno-tehnične naloge za svet.
...
(3) Pri opravljanju svojih nalog svet sodeluje z ministrstvi, regijami, občinami, združenji gospodarskih dejavnosti, samoupravnima narodnima skupnostma ter javnimi in nevladnimi organizacijami. Z regijami drugih držav svet sodeluje na področju regionalnega razvoja ter evropske kohezijske politike in politike razvoja podeželja.
...
(2) Pred odločitvijo Vlade Republike Slovenije mora državni organ, pristojen za evropsko kohezijsko politiko, pridobiti predhodno soglasje sveta k vsebini:
...
(5) Na seje sveta se vabijo javni uslužbenci ministrstva, ki so zadolženi za regije, povezane v kohezijski regiji (v nadaljnjem besedilu: skrbnik regije), in predstavniki regionalnih razvojnih agencij, ki delujejo v kohezijski regiji. K posameznim točkam dnevnega reda se lahko na sejo vabijo tudi drugi udeleženci, ki se določijo s sklicem seje. Skrbniki regij, predstavniki regionalnih razvojnih agencij in drugi udeleženci nimajo pravice glasovanja.
