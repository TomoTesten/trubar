---
kratica: URED6485
naziv: "Uredba o izvajanju Programa ukrepov na področju čebelarstva v Republiki Sloveniji v letih 2014–2016"
sop: 2014-01-0162
npb: "NPB 2"
veljaOd: 2014-01-24
vir: "https://pisrs.si/pregledNpb?id=URED6485"
---
...
Neuradno prečiščeno besedilo Uredbe o izvajanju Programa ukrepov na področju čebelarstva v Republiki Sloveniji v letih 2014–2016 obsega:
-        Uredbo o izvajanju Programa ukrepov na področju čebelarstva v Republiki Sloveniji v letih 2014–2016 (Uradni list RS, št. 6/14 z dne 24. 1. 20104),
-        Uredbo o spremembah in dopolnitvah Uredbe o izvajanju Programa ukrepov na področju čebelarstva v Republiki Sloveniji v letih 2014–2016 (Uradni list RS, št. 54/14 z dne 18. 7. 2014),
-        Uredbo o spremembah in dopolnitvah Uredbe o izvajanju Programa ukrepov na področju čebelarstva v Republiki Sloveniji v letih 2014–2016 (Uradni list RS, št. 26/15 z dne 17. 4. 2015).
...
(4) Namen ukrepa kakovosti medu iz 3. točke prvega odstavka tega člena je spremljanje in zagotavljanje kakovosti in zdravstvene ustreznosti medu ter zmanjšanje ostankov zdravil in drugih škodljivih snovi v medu in čebeljih pridelkih.
...
-        ukrepa iz prve in druge alineje 1. točke prvega odstavka 2. člena te uredbe skupaj največ 270.114 eurov v programskem letu 2014, največ 250.248 eurov v programskem letu 2015 in največ 249.362 eurov v programskem letu 2016;
...
-        ukrep iz 3. točke prvega odstavka 2. člena uredbe največ 45.000 eurov;
-        ukrep iz prve alineje 4. točke prvega odstavka 2. člena te uredbe največ 42.000 eurov;
...
(1) Delež sofinanciranja čebelarske opreme znaša 80 odstotkov skupne neto vrednosti (brez vštetega DDV) izvedenega nakupa čebelarske opreme. Delež sofinanciranja čebeljih panjev s testnimi vložki znaša pri čebelarjih, ki so aktivni koristniki sheme kakovosti že pred letom 2015 ali imajo potrdilo o vključenosti v kontrolo ekološkega čebelarjenja ali imajo certifikat za ekološke čebelje proizvode, do 100 odstotkov skupne neto vrednosti izvedenega nakupa čebeljih panjev s testnimi vložki (brez vštetega DDV). Čebelar je do sredstev v okviru tega ukrepa upravičen samo enkrat v programskem obdobju 2014–2016.
...
(3) Čebelar, ki je v programskem obdobju 2014–2016 prejel sredstva v okviru ukrepa čebelar začetnik, v programskem obdobju 2014–2016 ni upravičen do sredstev v okviru ukrepa sofinanciranje čebelarske opreme.
...
-        tri čebelje družine,
-        posoda za med, ki ustreza za skladiščenje hrane, in
-        točilo za med.
...
### (program kontrole medu)

(1) Program kontrole medu pridelkov sprejme minister in se objavi na spletni strani ministrstva.
(2) Program kontrole medu določa zlasti:
-        cilje ukrepa kakovosti medu,
-        način in dinamiko izvedbe analiz medu ter način vzorčenja,
-        območja, na katerih se izvedejo analize medu, in število analiz medu po statističnih regijah,
-        natančnejšo vsebino za izdelavo analiz medu ter analize stanja glede kakovosti in zdravstvene ustreznosti medu v Republiki Sloveniji,
-        kaj mora ponudnik zagotavljati pri izvajanju analiz medu,
-        vsebino evidence o opravljenih analizah medu,
-        morebitne pogoje, ki jih morajo izpolnjevati izvajalci analiz medu, in
-        natančnejšo vsebino poročila o izvedbi analiz medu.
(3) Podrobnejša specifikacija stroškov analiz medu in analize stanja glede kakovosti in zdravstvene ustreznosti medu v Republiki Sloveniji do višine sredstev iz pete alineje tretjega odstavka 4. člena te uredbe se opredeli v programu kontrole medu.

### 22. člen


### (rezultati analiz medu)

Analizo posameznega vzorca medu, ki se uporabi pri pripravi analize stanja glede kakovosti in zdravstvene ustreznosti medu v Republiki Sloveniji, prejme čebelar brezplačno.
...
(1) Agencija izvaja administrativne kontrole in kontrole na kraju samem.
...
Priloga 1: Vloga na javni razpis
Priloga 2: Obrazec »Uveljavljanje odstopanja od obveznosti v primeru višje sile«
