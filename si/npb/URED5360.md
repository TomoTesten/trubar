...
npb: "NPB 5"
veljaOd: 2010-12-03
vir: "https://pisrs.si/pregledNpb?id=URED5360"
---

# Uredba o koncesiji za izkoriščanje gozdov v lasti Republike Slovenije

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Uredbe o koncesiji za izkoriščanje gozdov v lasti Republike Slovenije obsega:
-        Uredbo o koncesiji za izkoriščanje gozdov v lasti Republike Slovenije (Uradni list RS, št. 98/10 z dne 3. 12. 2010),
-        Uredbo o spremembah in dopolnitvah Uredbe o koncesiji za izkoriščanje gozdov v lasti Republike Slovenije (Uradni list RS, št. 98/12 z dne 17. 12. 2012),
-        Uredbo o spremembah in dopolnitvah Uredbe o koncesiji za izkoriščanje gozdov v lasti Republike Slovenije (Uradni list RS, št. 62/13 z dne 22. 7. 2013),
-        Uredbo o spremembah in dopolnitvah Uredbe o koncesiji za izkoriščanje gozdov v lasti Republike Slovenije (Uradni list RS, št. 90/13 z dne 30. 10. 2013),
-        Uredbo o spremembi Uredbe o koncesiji za izkoriščanje gozdov v lasti Republike Slovenije (Uradni list RS, št. 108/13 z dne 20. 12. 2013),
-        Zakon o gospodarjenju z gozdovi v lasti Republike Slovenije - ZGGLRS (Uradni list RS, št. 9/16 z dne 12. 2. 2016).

## UREDBA


## o koncesiji za izkoriščanje gozdov v lasti Republike Slovenije (prenehala veljati)
...
(1) Koncesija se podeli na podlagi javnega razpisa, razen v primeru iz četrtega odstavka prejšnjega člena.
...
(1) Merilo za izbiro koncesionarja je višina koncesijske dajatve, pri čemer imajo prednost tisti prijavitelji, ki ponudijo višjo koncesijsko dajatev.
...
O izbiri koncesionarja oziroma podelitvi koncesije koncesionarju iz četrtega odstavka 2. člena te uredbe odloči direktor sklada z odločbo. O pritožbi zoper odločbo o izbiri koncesionarja oziroma podelitvi koncesije koncesionarju iz četrtega odstavka 2. člena te uredbe odloča ministrstvo, pristojno za gozdarstvo.
...
-        ne izpolnjuje pogojev iz drugega ali tretjega oziroma četrtega ali petega odstavka 2. člena te uredbe,
...
(4) O odvzemu koncesije odloči direktor sklada z odločbo. O pritožbi zoper odločbo o odvzemu koncesije odloča ministrstvo, pristojno za gozdarstvo. Do pravnomočnosti odločbe o odvzemu koncesije zagotavlja izvedbo vseh potrebnih del za izkoriščanje gozdov, ki so bili predmet koncesije, koncedent.
...
(3) Vsak tovor morajo spremljati odpremnice s podatki o oddelku, odseku, delovišču, količini in kakovosti gozdnih lesnih sortimentov po drevesnih vrstah. Podatki z odpremnic se zbirajo v informacijskem sistemu koncedenta, ki je dostopen koncesionarjem, za gozdne lesne sortimente, ki izhajajo iz gozdov, ki jih imajo v koncesiji. Koncesionar je dolžan odpremnice elektronsko pošiljati koncedentu pred odvozom gozdnih lesnih sortimentov s kamionske ceste.
(4) Ne glede na določbo prejšnjega odstavka koncesionarji iz tretjega in četrtega odstavka 2. člena te uredbe pošljejo odpremnico koncedentu v dveh dneh po opravljenem prevozu.
...
(4) Šteje se, da je tovor gozdnih lesnih sortimentov neskladen z odpremnico, če na škodo koncedenta:
...
(2) Koncedent na svoji spletni strani do konca meseca za pretekli mesec objavi količino in vrednost gozdnih lesnih sortimentov na kamionski cesti.
