---
kratica: PRAV14292
naziv: "Pravilnik o načinu dostopa do svetovalcev za begunce, nagrajevanju in povračilu stroškov svetovalcem za begunce ter merilih za izračun povrnitve stroškov od osebe, ki ima zadostna lastna sredstva"
sop: 2021-01-3098
npb: "NPB 1"
veljaOd: 2021-10-08
vir: "https://pisrs.si/pregledNpb?id=PRAV14292"
---
...
Neuradno prečiščeno besedilo Pravilnika o načinu dostopa do svetovalcev za begunce, nagrajevanju in povračilu stroškov svetovalcem za begunce ter merilih za izračun povrnitve stroškov od osebe, ki ima zadostna lastna sredstva obsega:
-    Pravilnik o načinu dostopa do svetovalcev za begunce, nagrajevanju in povračilu stroškov svetovalcem za begunce ter merilih za izračun povrnitve stroškov od osebe, ki ima zadostna lastna sredstva (Uradni list RS, št. 162/21 z dne 8. 10. 2021),
-    Pravilnik o spremembah in dopolnitvi Pravilnika o načinu dostopa do svetovalcev za begunce, nagrajevanju in povračilu stroškov svetovalcem za begunce ter merilih za izračun povrnitve stroškov od osebe, ki ima zadostna lastna sredstva (Uradni list RS, št. 74/24 z dne 6. 9. 2024).
...
Ta pravilnik določa način dostopa oseb, ki so stranke v postopkih po Zakonu o mednarodni zaščiti (Uradni list RS, št. 16/17 – uradno prečiščeno besedilo, 54/21 in 42/23 – ZZSDT-D; v nadaljnjem besedilu: zakon), (v nadaljnjem besedilu: oseba) do svetovalcev za begunce (v nadaljnjem besedilu: svetovalec), merila za določitev nagrade za opravljeno delo in povračilo stroškov svetovalcem za opravljeno pravno pomoč v zvezi s postopki po zakonu na Upravnem sodišču Republike Slovenije in Vrhovnem sodišču Republike Slovenije ter merila za izračun povrnitve stroškov svetovalcev za begunce od osebe, ki ima zadostna lastna sredstva za preživljanje.
...
Povprečni mesečni znesek lastnih sredstev osebe za preživljanje Odstotek povračila za kritje stroškov svetovalca Večji ali enak od 2.5x minimalnega dohodka 100 % Večji ali enak od 2x minimalnega dohodka 75 % Večji ali enak od 1.5x minimalnega dohodka 50 %
...
Priloga: Obvestilo o dodelitvi svetovalca za podporo in pravno pomoč v postopku pridobitve mednarodne zaščite
