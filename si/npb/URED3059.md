---
kratica: URED3059
naziv: "Uredba o metodologiji za določitev osnov za izračun sredstev za izvajanje javne službe na področju kulture"
sop: 2003-01-4494
npb: "NPB 2"
veljaOd: 2003-10-17
vir: "https://pisrs.si/pregledNpb?id=URED3059"
---
...
Neuradno prečiščeno besedilo Uredbe o metodologiji za določitev osnov za izračun sredstev za izvajanje javne službe na področju kulture obsega:
-       Uredbo o metodologiji za določitev osnov za izračun sredstev za izvajanje javne službe na področju kulture (Uradni list RS, št. 100/03 z dne 17. 10. 2003),
-       Uredbo o spremembi Uredbe o metodologiji za določitev osnov za izračun sredstev za izvajanje javne službe na področju kulture (Uradni list RS, št. 81/09 z dne 16. 10. 2009),
-       Uredbo o dopolnitvi Uredbe o metodologiji za določitev osnov za izračun sredstev za izvajanje javne službe na področju kulture (Uradni list RS, št. 96/13 z dne 22. 11. 2013).
...
Uredba o metodologiji za določitev osnov za izračun sredstev za izvajanje javne službe na področju kulture (Uradni list RS, št. 100/03 ) vsebuje naslednji končni določbi:
...
Uredba o spremembi Uredbe o metodologiji za določitev osnov za izračun sredstev za izvajanje javne službe na področju kulture (Uradni list RS, št. 81/09 ) vsebuje naslednjo končno določbo:
»KONČNA DOLOČBA
2. člen
Ta uredba začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
Uredba o dopolnitvi Uredbe o metodologiji za določitev osnov za izračun sredstev za izvajanje javne službe na področju kulture (Uradni list RS, št. 96/13 ) vsebuje naslednjo končno določbo:
»KONČNA DOLOČBA
2. člen
