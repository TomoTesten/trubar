...
npb: "Osnovni"
veljaOd: 2021-11-05
vir: "https://pisrs.si/pregledNpb?id=URED8348"
---
...
Lastna sredstva na osebo Mesečno povračilo za kritje stroškov ali sorazmernega deleža stroškov materialne oskrbe v odstotkih Enaka ali večja od višine osnovnega zneska minimalnega dohodka do višine 75 % neto minimalne plače 50 % od mesečnega stroška nastanitve v skladu s tretjim odstavkom 6. člena te uredbe Enaka ali večja od višine 75 % neto minimalne plače do višine neto minimalne plače 75 % od mesečnega stroška nastanitve v skladu s tretjim odstavkom 6. člena te uredbe Višja od višine neto minimalne plače 100 % mesečnega stroška nastanitve v skladu s tretjim odstavkom 6. člena te uredbe
...
Priloga 1: Izjava o seznanitvi z izvajanjem videonadzora
Priloga 2: Poročilo o obstoju posebnih potreb glede sprejema oziroma potreb po posameznih jamstvih v postopku
Priloga 3: Potrdilo o lastnih sredstvih
Priloga 4: Seznanitev s pravicami in dolžnostmi
Priloga 5: Vloga za izdajo dovolilnice (prenočitev zunaj azilnega doma)
Priloga 6: Dovolilnica
Priloga 7: Vloga za izdajo dovolilnice (zapustitev območja občine)
Priloga 8: Vloga za razselitev na zasebni naslov
Priloga 9: Poročilo o ogledu stanovanja
Priloga 10: Vloga za razselitev v drugo primerno institucijo
Priloga 11: Nalog za izdajo blaga iz skladišča
