---
kratica: PRAV4071
naziv: "Pravilnik o obliki in vsebini ter o načinu vodenja imenika Zbornice za arhitekturo in prostor Slovenije in Inženirske zbornice Slovenije"
sop: 2003-01-5257
npb: "NPB 4"
veljaOd: 2003-12-11
vir: "https://pisrs.si/pregledNpb?id=PRAV4071"
---
...
Neuradno prečiščeno besedilo Pravilnika o obliki in vsebini ter o načinu vodenja imenika Zbornice za arhitekturo in prostor Slovenije in Inženirske zbornice Slovenije obsega:
-        Pravilnik o obliki in vsebini ter o načinu vodenja imenika Zbornice za arhitekturo in prostor Slovenije in Inženirske zbornice Slovenije (Uradni list RS, št. 123/03 z dne 11. 12. 2003),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o obliki in vsebini ter o načinu vodenja imenika Zbornice za arhitekturo in prostor Slovenije in Inženirske zbornice Slovenije (Uradni list RS, št. 56/05 z dne 10. 6. 2005),
-        Zakon o spremembah in dopolnitvah Zakona o graditvi objektov – ZGO-1C (Uradni list RS, št. 108/09 z dne 28. 12. 2009),
-        Splošni akt o postopkih vpisa in izbrisa iz imenika pooblaščenih inženirjev (Uradni list RS, št. 37/18 z dne 1. 6. 2018),
-        Splošni akt o postopkih vpisa in izbrisa iz imenika pooblaščenih arhitektov, pooblaščenih krajinskih arhitektov in pooblaščenih prostorskih načrtovalcev (Uradni list RS, št. 40/18 z dne 12. 6. 2018).

## PRAVILNIK


## o obliki in vsebini ter o načinu vodenja imenika Zbornice za arhitekturo in prostor Slovenije in Inženirske zbornice Slovenije
...
(3) Listine, ki jih je na podlagi predpisov iz prejšnjega odstavka in tega pravilnika treba predložiti pristojnemu organu ZAPS oziroma IZS (v nadaljnjem besedilu: pristojni evidenčni organ) v postopku vpisa v imenik, se vložijo v zbirko listin.
...
3.3. Posebne določbe o vpisu EU arhitektov, ki želijo v Republiki Sloveniji pridobiti status odgovornega projektanta arhitekture
...
3.5. Izbris iz imenika in možnost ponovnega vpisa v imenik
...
Priloga 1: Vloga za vpis v imenik Zbornice za arhitekturo in prostor Slovenije
Priloga 2: Vloga za vpis v imenik Inženirske zbornice Slovenije
Priloga 3: Potrdilo o vpisu v imenik Zbornice za arhitekturo in prostor Slovenije
Priloga 4: Potrdilo o vpisu v imenik Inženirske zbornice Slovenije
Pravilnik o obliki in vsebini ter o načinu vodenja imenika Zbornice za arhitekturo in prostor Slovenije in Inženirske zbornice Slovenije (Uradni list RS, št. 123/03 ) vsebuje naslednje prehodne in končne določbe:
...
### (vpisovanje EU arhitektov in inženirjev ter tujih arhitektov in inženirjev v prehodnem obdobju)
...
Pravilnik o spremembah in dopolnitvah Pravilnika o obliki in vsebini ter o načinu vodenja imenika Zbornice za arhitekturo in prostor Slovenije in Inženirske zbornice Slovenije (Uradni list RS, št. 56/05 ) vsebuje naslednjo prehodno in končno določbo:
»3. člen
...
Zakon o spremembah in dopolnitvah Zakona o graditvi objektov – ZGO-1C (Uradni list RS, št. 108/09 ) vsebuje naslednjo končno določbo:
»25. člen
Ta zakon začne veljati petnajsti dan po objavi v Uradnem listu Republike Slovenije.«.
Splošni akt o postopkih vpisa in izbrisa iz imenika pooblaščenih inženirjev (Uradni list RS, št. 37/18 ) v zvezi z delnim prenehanjem uporabe tega pravilnika določa:
»13. člen
...
Splošni akt o postopkih vpisa in izbrisa iz imenika pooblaščenih arhitektov, pooblaščenih krajinskih arhitektov in pooblaščenih prostorskih načrtovalcev (Uradni list RS, št. 40/18 ) v zvezi z delnim prenehanjem uporabe tega pravilnika določb:
»11. člen
