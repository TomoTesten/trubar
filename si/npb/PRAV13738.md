...
npb: "Osnovni"
veljaOd: 2020-03-13
vir: "https://pisrs.si/pregledNpb?id=PRAV13738"
---
...
(1) Tlak vetra q h se izračuna po naslednji enačbi:
kjer je:
q h –   tlak vetra v višini h [N/m 2 ],
...
(2) Tlak vetra q h se upošteva na višini za višinsko cono 50 m nad tlemi, vendar ne manj od 500 N/m 2 .
...
(1) Obtežba vetra na SKS QW c se računa v višini obesišča na podpori po naslednji enačbi:
kjer je:
q h –   tlak vetra na višini SKS nad tlemi [N/m2],
G c –  faktor razpetine za razpetine do 200 m je 1,00,
C c –   faktor zračnega upora za SKS je 1,00,
d –     premer SKS v [m],
L –     dolžina polovice sosednjih razpetin v [m].
(2) Obtežba vetra na podpore QW pol deluje v smeri vetra in se izračuna po naslednji enačbi:
kjer je:
C x –   koeficient delovanja vetra na podporo, in sicer:
...
A pol – projekcija vetru izpostavljene površine podpore v [m 2 ],
q h – tlak vetra, koeficient 1,1 upošteva reakcijo podpore.
