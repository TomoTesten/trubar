...
npb: "NPB 3"
veljaOd: 2011-12-16
vir: "https://pisrs.si/pregledNpb?id=PRAV10471"
---

# Pravilnik o reševalcih iz vode

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o reševalcih iz vode obsega:
-        Pravilnik o reševalcih iz vode (Uradni list RS, št. 103/11 z dne 16. 12. 2011),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o reševalcih iz vode (Uradni list RS, št. 96/20 z dne 8. 7. 2020),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o reševalcih iz vode (Uradni list RS, št. 31/21 z dne 5. 3. 2021),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o reševalcih iz vode (Uradni list RS, št. 58/23 z dne 26. 5. 2023).
...
(1) Naziv reševalca iz vode pridobi kandidat, ki se je udeležil usposabljanja in uspešno opravil preizkus usposobljenosti po enem od programov usposabljanja A, B in C iz prejšnjega člena, opravil predpisan zdravniški pregled za reševalca iz vode in predpisan preizkus usposobljenosti za nudenje prve pomoči po Pravilniku o opremi in sredstvih za dajanje prve pomoči, usposabljanju in preizkusih iz prve pomoči ter zdravniških pregledih reševalcev iz vode (v nadaljnjem besedilu: predpisan preizkus usposobljenosti za nudenje prve pomoči).
...
(3) Določba tega člena se smiselno uporablja tudi za prijavo za preizkus usposobljenosti po programu usposabljanja D.
...
Priloga 1: Izkaznica reševalca iz vode
Priloga 2: Potrdilo o usposobljenosti za reševanje iz vode
Pravilnik o reševalcih iz vode (Uradni list RS, št. 103/11 ) vsebuje naslednje prehodne in končne določbe:
...
Pravilnik o spremembah in dopolnitvah Pravilnika o reševalcih iz vode (Uradni list RS, št. 96/20 ) vsebuje naslednje prehodne in končno določbo:
...
Pravilnik o spremembah in dopolnitvah Pravilnika o reševalcih iz vode (Uradni list RS, št. 31/21 ) vsebuje naslednji prehodni in končno določbo:
...
Ta pravilnik začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
Pravilnik o spremembah in dopolnitvah Pravilnika o reševalcih iz vode (Uradni list RS, št. 58/23 ) vsebuje naslednjo končno določbo:
»KONČNA DOLOČBA
6. člen
