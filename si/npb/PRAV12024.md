...
npb: "NPB 1"
veljaOd: 2014-09-19
vir: "https://pisrs.si/pregledNpb?id=PRAV12024"
---

# Pravilnik o zaščiti podatkov policije

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o zaščiti podatkov policije obsega:
-        Pravilnik o zaščiti podatkov policije (Uradni list RS, št. 67/14 z dne 19. 9. 2014),
-        Pravilnik o spremembah in dopolnitvah Pravilnika o zaščiti podatkov policije (Uradni list RS, št. 35/22 z dne 11. 3. 2022).
...
6.      upravljanje z dnevnikom obdelave (v nadaljnjem besedilu: upravljavec dnevnika obdelave);
...
15.   druge naloge v zvezi z zaščito podatkov policije.
...
Zaradi varovanja podatkov uslužbenci policije in ministrstva, ki uporabljajo ITSP, izvajajo predvsem naslednje splošne varnostne ukrepe:
...
Vse pogodbe in postopki v zvezi z vzdrževanjem in servisiranjem opreme, prostorov, sredstev in objektov policije ter objektov ministrstva, kjer se uporablja ITSP, morajo vsebovati varnostne zahteve in pogoje, ki jih mora izpolnjevati vzdrževalno osebje oziroma oprema izvajalca vzdrževanja in servisiranja.
...
(1) Kadar je v obdelavo podatkov ali v izgradnjo oziroma vzdrževanje infrastrukture ITSP vključen zunanji izvajalec, mora biti dolžnost varovanja varovanih podatkov policije vključena v pogodbo, s katero se uredijo razmerja in odnosi med policijo oziroma ministrstvom in izvajalcem pogodbenih del.
...
(4) Dostop zunanjih izvajalcev v ITSP lahko poteka samo nadzorovano pod pogoji, ki omogočajo ustrezno zaščito in rekonstrukcijo dostopa. Nadzor se izvaja z beleženjem aktivnosti in z drugimi standardnimi varnostnimi mehanizmi v ITSP. Če ustreznega nadzora ni mogoče zagotoviti, dostop zunanjih izvajalcev ni dovoljen.
...
Gibanje in delo v objektih policije in ministrstva, kjer se uporablja ITSP, poteka v skladu s hišnim redom, za prostore, v katerih je nameščena oprema ITSP, pa veljajo še naslednja pravila:
1.      zadrževanje uslužbencev policije in ministrstva v teh prostorih, razen tistih, ki so v njih zaposleni ali je njihova prisotnost nujno potrebna za nemoteno opravljanje delovnih nalog, ni dovoljeno;
...
Poleg požarnovarnostnih ukrepov, ki jih za objekte policije in ministrstva predpisuje požarni red, velja za prostore, v katerih je nameščena oprema ITSP, še naslednje:
...
Opremo ITSP je dovoljeno uporabljati le za izvajanje nalog policije in nalog ministrstva, pri katerih se uporablja ITSP. Uporaba v druge namene je dopustna le izjemoma, s predhodnim dovoljenjem vodje enote.
...
(4) Organizacijska enota ministrstva, pristojna za kadrovske zadeve, mora o sklenitvi ali prenehanju delovnega razmerja ter premestitvi posameznega uporabnika ITSP takoj obvestiti notranjo organizacijsko enoto policije, pristojno za vodenje razvida uporabnikov ITSP.
...
(1) Dostop do informacijsko telekomunikacijskih sistemov drugih državnih organov ali pravnih oseb (v nadaljnjem besedilu: drugi informacijsko telekomunikacijski sistemi) imajo lahko le tisti uslužbenci policije in ministrstva, ki dostop potrebujejo zaradi izvajanja svojih delovnih nalog.
...
1.      upravljanje dostopov uslužbencev policije in ministrstva, ki uporabljajo ITSP, do drugih informacijskih sistemov ali svetovnega spleta;
...
(1) Kadar je na varnostni pregradi vključena oprema, ki omogoča spremljanje in evidentiranje aktivnosti posameznega uporabnika ITSP, mora biti vsak uslužbenec policije in ministrstva, ki uporablja ITSP, preden uporabi povezavo z drugim informacijskim sistemom ali svetovnim spletom, o tem na nedvoumen in jasen način opozorjen.
...
(1) Uslužbenec policije in ministrstva, ki uporablja ITSP, ob sklenitvi delovnega razmerja ali premestitvi na delovno mesto, na katerem bo obdeloval varovane podatke, s pisno izjavo potrdi, da je seznanjen s predpisi, ki v policiji urejajo varovanje podatkov.
...
(1) Nadzor nad izvajanjem tega pravilnika v policiji opravljata notranji organizacijski enoti, pristojni za nadzor in zaščito podatkov.
(2) Nadzor nad izvajanjem tega pravilnika v ministrstvu opravlja vodja organizacijske enote, kjer se uporablja ITSP.
(3) Za nadzor nad obdelavo podatkov je odgovoren vodja enote, iz katere je uporabnik ITSP.
