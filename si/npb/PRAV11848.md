...
npb: "NPB 1"
veljaOd: 2016-07-15
vir: "https://pisrs.si/pregledNpb?id=PRAV11848"
---

# Pravilnik o identifikaciji in registraciji goveda

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o identifikaciji in registraciji goveda obsega:
-        Pravilnik o identifikaciji in registraciji goveda (Uradni list RS, št. 50/16 z dne 15. 7. 2016),
-        Pravilnik o spremembah Pravilnika o identifikaciji in registraciji goveda (Uradni list RS, št. 68/19 z dne 15. 11. 2019).
...
Imetnik goveda mora najpozneje sedem dni po označitvi poskrbeti za registracijo goveda. V skladu z 28. in 29. členom tega pravilnika mora v CRG priglasiti naslednje podatke:
-        identifikacijsko številko živali;
-        spol goveda;
...
Priloga: (črtana)
Pravilnik o identifikaciji in registraciji goveda (Uradni list RS, št. 50/16 ) vsebuje naslednjo prehodno in končni določbi:
...
Pravilnik o spremembah Pravilnika o identifikaciji in registraciji goveda (Uradni list RS, št. 68/19 ) vsebuje naslednjo končno določbo:
»KONČNA DOLOČBA
3. člen
