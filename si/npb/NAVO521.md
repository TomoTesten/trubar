---
kratica: NAVO521
naziv: "Navodilo o fizikalno kemijskih analizah grozdnega mošta in vina"
sop: 2001-01-2439
npb: "Osnovni"
veljaOd: 2001-05-31
vir: "https://pisrs.si/pregledNpb?id=NAVO521"
---
...
Relativna gostota pri 20 °C je razmerje med gostoto določenega volumna vina ali mošta pri 20 °C in enakega volumna vode pri enaki temperaturi. Označena je s simbolom
...
izračunamo: ∆ T = T 1 – T 0 ;
masa praznega piknometra v času merjenja = P – m +∆ T ;
...
Masa tekočine v piknometru pri t °C = P 2 – ( P – m + ∆ T );
navidezna gostota pri t °C:
...
b) Postopek:
Izmerimo navidezno gostoto destilata (točka d.) 7. člena tega navodila) pri t °C, kot je opisano v točki c) 4. člena
tega navodila. To gostoto označimo z d t°C .
c) Podajanje rezultatov
-  Izračun:
z uporabo tabele I, ki je v prilogi 2, poiščemo volumski delež alkohola pri 20 °C. V vodoravni vrsti te tabele z ustrezno T (izraženo s celo številko), takoj pod t °C, poiščemo
najmanjšo gostoto, ki pa je večja od d t°C . Tabelarično razliko pod to gostoto uporabimo za izračun gostote d pri temperaturi T.
...
Relativno gostoto (20/20) dealkoholiziranega vina izračunamo s pomočjo formule:
= relativna gostota vina pri 20 °C (korigirana na hlapne kisline),
= relativna gostota alkoholnega destilata pri 20 °C mešanice voda-alkohol z enakim volumskim deležem alkohola kot vino,
lahko izračunamo tudi iz gostot pri 20 °C, gostote vina d v in gostote alkoholnega destilata d a mešanice voda-alkohol z enakim volumskim deležem alkohola kot vino.
...
Za izračun skupnega suhega ekstrakta v g/l se uporablja tabela I, ki je v prilogi 3, ki podaja skupni suhi ekstrakt kot funkcijo relativne gostote d r (20/20) dealkoholiziranega vina
ali relativne specifične mase mošta .
...
-  Klorovodikova kislina, HCl (ρ 20 = 1,18 do 1,19 g / ml), razredčena 1: 4 (vol: vol);
...
-  Klorovodikova kislina, HCl (ρ 20 ) = 1,18 do 1,19 g/l),
...
Opis vzorca Koncentracija sladkorja (g/l) Relativna gostota Razredčitev (%) mošti in mistele nad 125 nad 1,038 1 sladka vina 25 do 125 1,005 do 1,038 4 polsladka vina 5 do 25 0,997 do 1,005 20 suha vina pod 5 pod 0,997 brez razredčenja
1. REFERENČNA METODA
a) Reagenti:
...
koncentrirana žveplena kislina (H2SO4), ro = 1,84 g/ml: 25 g;
voda: do 100 ml.
...
vodo: ca 100 ml;
koncentrirana HCl, ρ 20 = od 1,16 do 1,19 g/ml: 5 ml.
...
Prosti žveplov dioksid je definiran kot žveplov dioksid, ki je prisoten v moštu ali vinu v naslednjih oblikah: H 2 SO 3 , HSO 3
...
-        Mikrobireta.
b) Reagenti:
-  Fosforna kislina, 85% (H 3 PO 4 , ρ 20 = 1,71 g/ml);
...
Izračun: Prosti žveplov dioksid v mg/l je produkt 6,4 n .
...
-  Žveplova(VI) kislina, H 2 SO 4 , (r 20 = 1,84 g/ml), 1: 10 (vol: vol);
...
-  Mobilna faza: diklorometan: 100% ocetna kislina (ledocet) (ρ 20 = 1,05 g/ml): etanol: metanol: voda, 50: 25: 9: 6: 10.
...
2,5 cm od spodnjega roba plošče nanesemo kot črtico 10 µl vzorca in 10 µl standarda.
...
-  Standardna raztopina: 1,2 g/l vodne raztopine saharoze. Filtriramo z 0,45 µm membranskim filtrom.
c) Postopek
1. Priprava vzorca:
...
b) Reagenti
-  Puferska raztopina pH 7,8 (0,51 M raztopina glicilglicina; pH 7,8; Zn 2 + (0,6 x 10 -3 M):
...
-        Raztopina reduciranega nikotinamid adenin dinukleotida (NADH) (približno 6 x 10 -3 M): 30 mg NADH in 60 mg NaHCO 3 raztopimo v 6 ml dvakrat destilirane vode.
...
referenčna celica (ml) vzorčna celica (ml) Raztopina 2.1 1,00 1,00 Raztopina 2.2 0,10 0,10 Vzorec za meritev - 0,20 Dvakrat destilirana voda 2,00 1,80 Raztopina 2.3 0,02 0,02
Mešamo in po približno petih minutah odčitamo absorpcijo raztopine v referenčni in vzorčni celici (A 1 ).
Dodamo:
...
Izračunamo razliko absorpcij (A 2 – A 1 ) za referenčno celico in celico z vzorcem, in dobimo ∆ AR in ∆ AS .
...
ε = absorpcijski koeficient NADH (pri 340 nm, e = 6,3 mmol -1 x 1 x cm -1 ,
zato je:
C = 479 x ∆ A
Če je bil vzorec med pripravo razredčen, rezultat pomnožimo s faktorjem razredčitve.
Opomba:
Pri 334 nm: C = 488 x ∆ A (= 6,2 m mol -1 x 1 x cm -1 )
pri 365 nm: C = 887 x ∆ A (= 3,4 m mol -1 x 1 x cm -1 )
2. Ponovljivost ( r )
...
- Referenčna metoda
Mirna vina (tlak CO 2 < / = 0,5 x 10 5 Pa) ( 1 )
...
1. Mirna vina (tlak CO 2 ≤= 0,5 x 10 5 Pa)
a) Aparature
-  Magnetno mešalo
-  pH meter
b) Reagenti
...
Izraziti ga je treba v obliki, ki je skladna z natančnostjo manometra (npr. pri manometrih razreda I s celotno skalo 1000 kPa kot 6,3 x 10 5 Pa ali 630 kPa in ne kot 6,33 x 10 5 Pa ali 633 kPa).
...
Priloga 1: Tabele I-VII; Temperaturne korekcije
Priloga 2: Tabele I-IV; Mednarodne tabele za volumenski delež alkohola pri 20°C
Priloga 3: Tabela I: Tabela za izračun koncentracije skupnega suhega ekstrakta; Interpolacijska tabela
Priloga 4: Tabela I: Zveza med volumnom raztopine natrijevega tiosulfata in maso reducirajočih sladkorjev
Priloga 5: Tabela I-III; Korekcije masnega deleža sahroze; Koncentracija sladkorja v moštu in zgoščenem grozdnem moštu; Koncentracija sladkorja v rektificiranem zgoščenem grozdnem moštu
Priloga 6: Tabela I: Razmerje nadtlaka v penečem in biser vinu med P(20) ter P(t)
