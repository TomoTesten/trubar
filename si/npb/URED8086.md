---
kratica: URED8086
naziv: "Uredba o varnostnem preverjanju in izdaji dovoljenj za dostop do tajnih podatkov"
sop: 2021-01-0096
npb: "NPB 1"
veljaOd: 2021-01-08
vir: "https://pisrs.si/pregledNpb?id=URED8086"
---

# Uredba o varnostnem preverjanju in izdaji dovoljenj za dostop do tajnih podatkov

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Uredbe o varnostnem preverjanju in izdaji dovoljenj za dostop do tajnih podatkov obsega:
-    Uredbo o varnostnem preverjanju in izdaji dovoljenj za dostop do tajnih podatkov (Uradni list RS, št. 4/21 z dne 8. 1. 2021),
-    Uredbo o spremembah in dopolnitvah Uredbe o varnostnem preverjanju in izdaji dovoljenj za dostop do tajnih podatkov (Uradni list RS, št. 68/25 z dne 5. 9. 2025).
...
(2) Ta uredba podrobneje določa način in postopek izdaje in preklica dovoljenja fizičnim osebam za dostop do tajnih podatkov tuje države (v nadaljnjem besedilu: tuji tajni podatki).
...
(1) Postopek varnostnega preverjanja za izdajo dovoljenja za dostop do tajnih podatkov (v nadaljnjem besedilu: dovoljenje) iz 22. člena Zakona o tajnih podatkih (Uradni list RS, št. 50/06 – uradno prečiščeno besedilo, 9/10, 60/11, 8/20 in 18/23 – ZDU-1O; v nadaljnjem besedilu: zakon) se začne na podlagi pisnega predloga predstojnika organa iz 22.f člena zakona (v nadaljnjem besedilu: predlagatelj).
...
(2) Predlagatelj iz prejšnjega odstavka osebo, za katero predlaga postopek za potrditev veljavnosti dovoljenja, pisno ali ustno na zapisnik seznani z uvedbo postopka in ji začasno onemogoči dostop do tajnih podatkov ter jo pozove, da v osmih delovnih dneh da soglasje za vmesno varnostno preverjanje na obrazcu VP-8 ter izpolni varnostni vprašalnik glede na najvišjo stopnjo tajnosti veljavnega dovoljenja, ki ga poseduje. Preverjano osebo opozori na posledice neizpolnitve soglasja ali ustreznega varnostnega vprašalnika iz četrtega odstavka 25.c člena zakona.
...
(2) Osnovno in dodatno usposabljanje lahko izvajata tudi Upravna akademija pri ministrstvu, pristojnem za javno upravo, in nacionalni varnostni organ.
...
Priloga 1: VP-1: Izjava preverjane osebe
Priloga 2: VP-2: Soglasje za varnostno preverjanje
Priloga 3: VP-3: Osnovni vprašalnik za varnostno preverjanje
Priloga 4: VP-4: Posebni vprašalnik za varnostno preverjanje
Priloga 5: VP-5: Dodatni vprašalnik za varnostno preverjanje
Priloga 6: VP-6: Soglasje za varnostno preverjanje z varnostnim poizvedovanjem
Priloga 7: VP-7: Soglasje za vmesno varnostno preverjanje zaradi suma obstoja varnostnega zadržka
Priloga 8: VP-8: Soglasje za vmesno varnostno preverjanje za potrditev veljavnosti dovoljenja
Priloga 9: VP-9: Obrazec
Priloga 10: I-EU: Izjava EU
Priloga 11: I-NATO: Izjava NATO
Priloga 12: Obrazec Z-EU: Zaprosilo za izdajo dovoljenja za dostop do tajnih podatkov Evropske unije
Priloga 13: Obrazec Z-NATO: Zaprosilo za izdajo dovoljenja za dostop do tajnih podatkov zveze NATO
Priloga 14: I-EU-INTERNO: Izjava EU za stopnjo tajnosti interno
Priloga 15: I-NATO-INTERNO: Izjava NATO za stopnjo tajnosti interno
Priloga 16: Obrazec POT-EU: Zaprosilo za izdajo potrdila o veljavnem dovoljenju za dostop do tajnih podatkov Evropske unije
Priloga 17: Obrazec POT-NATO: Zaprosilo za izdajo potrdila o veljavnem dovoljenju za dostop do tajnih podatkov zveze NATO
Priloga 18: NA-EU: Zaprosilo za najavo udeležbe na dogodku Evropske unije v tujin i
Priloga 19: NA-NATO: Zaprosilo za najavo udeležbe na dogodku zveze NATO v tujini
Priloga 20: PROGRAM
