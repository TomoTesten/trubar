---
kratica: URED5278
naziv: "Uredba o koncesiji za graditev sedežnice Čaplja v Planici"
sop: 2009-01-3644
npb: "NPB 1"
veljaOd: 2009-10-16
vir: "https://pisrs.si/pregledNpb?id=URED5278"
---

# Uredba o koncesiji za graditev sedežnice Čaplja v Planici

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Uredbe o koncesiji za graditev sedežnice Čaplja v Planici obsega:
-       Uredbo o koncesiji za graditev sedežnice Čaplja v Planici (Uradni list RS, št. 81/09 z dne 16. 10. 2009),
-       Uredbo o spremembi Uredbe o koncesiji za graditev sedežnice Čaplja v Planici (Uradni list RS, št. 12/10 z dne 19. 2. 2010).

## UREDBA


## o koncesiji za graditev sedežnice Čaplja v Planici

(neuradno prečiščeno besedilo št. 1)

### 1. člen

(1) Ta uredba je koncesijski akt, na podlagi katerega se podeli koncesija za graditev sedežnice Čaplja v Planici (v nadaljnjem besedilu: koncesija), predvidoma na zemljiških parcelah št. 1346/74, 1346/75, 1346/80, 1346/81, 1417/9, 1417/13, vse k.o. Rateče.
(2) Žičniška naprava iz prejšnjega odstavka je žičniška naprava, ki se navezuje na obstoječe športne objekte.
...
Koncesionar mora izpolnjevati pogoj, da je finančno sposoben.
...
(1) Na podlagi drugega odstavka 28. člena Zakona o žičniških napravah za prevoz oseb (Uradni list RS, št. 126/03; v nadaljnjem besedilu: zakon) se koncesija podeli brez javnega razpisa, in sicer Ministrstvu za šolstvo in šport.
(2) Koncesija iz prejšnjega odstavka se podeli na podlagi vloge Ministrstva za šolstvo in šport z upravno odločbo.
...
(4) Koncesionar mora predlog za podaljšanje iz prejšnjega odstavka vložiti najmanj šest mesecev pred iztekom roka, za katerega je bila pridobljena koncesija.
...
(2) Koncesija se odvzame, če v dveh letih po pridobitvi dovoljenja za obratovanje žičniška naprava ne začne obratovati.
...
Uredba o koncesiji za graditev sedežnice Čaplja v Planici (Uradni list RS, št. 81/09 ) vsebuje naslednjo končno določbo:

### »14. člen

Ta uredba začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
Uredba o spremembi Uredbe o koncesiji za graditev sedežnice Čaplja v Planici (Uradni list RS, št. 12/10 ) vsebuje naslednjo končno določbo:
»2. člen
Ta uredba začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
