---
kratica: URED668
naziv: "Uredba o nadomestilu plače in povračilih stroškov med opravljanjem nalog zaščite, reševanja in pomoči"
sop: 1999-01-2255
npb: "NPB 3"
veljaOd: 1999-06-18
vir: "https://pisrs.si/pregledNpb?id=URED668"
---
...
Neuradno prečiščeno besedilo Uredbe o nadomestilu plače in povračilih stroškov med opravljanjem nalog zaščite, reševanja in pomoči obsega:
-       Uredbo o nadomestilu plače in povračilih stroškov med opravljanjem nalog zaščite, reševanja in pomoči (Uradni list RS, št. 48/99 z dne 18. 6. 1999),
-       Uredbo o spremembah in dopolnitvah Uredbe o nadomestilu plače in povračilih stroškov med opravljanjem nalog zaščite, reševanja in pomoči (Uradni list RS, št. 113/07 z dne 11. 12. 2007),
-       Uredbo o spremembah in dopolnitvah Uredbe o nadomestilu plače in povračilih stroškov med opravljanjem nalog zaščite, reševanja in pomoči (Uradni list RS, št. 13/11 z dne 28. 2. 2011),
-       Uredbo o spremembi Uredbe o nadomestilu plače in povračilih stroškov med opravljanjem nalog zaščite, reševanja in pomoči (Uradni list RS, št. 20/13 z dne 8. 3. 2012).
...
(2) Za službena potovanja pripadnikov CZ v tujino se smiselno uporabljajo določbe predpisov o povračilu stroškov za službena potovanja v tujino, ki veljo za javne uslužbence.
...
(6) Potrdila in druge podatke o dejstvih iz uradnih evidenc, ki jih vodijo upravni in drugi državni organi, organi občine in nosilci javnih pooblastil, za obračun nadomestila iz prvega odstavka tega člena pridobi Uprava Republike Slovenije za zaščito in reševanje oziroma občinska služba, pristojna za varstvo pred naravnimi in drugimi nesrečami po uradni dolžnosti.
...
(2) Obračun potnih stroškov, predložen na predpisanem obrazcu potnega naloga se šteje za vloženo zahtevo. Obrazec potnega naloga je enak kot za javne uslužbence.
...
Obrazec R-1: Zahtevek za nadomestilo plače med opravljanjem nalog zaščite, reševanja in pomoči (izpolni delodajalec)
Obrazec R-2: Zahtevek za nadomestilo izgubljenega zaslužka med opravljanjem nalog zaščite, reševanja in pomoči (izpolni oseba, ki opravlja samostojno dejavnost)
Obrazec R-3: Zahtevek za nadomestilo izgubljenega zaslužka za obdobje izvrševanja nalog zaščite, reševanja in pomoči (izpolni oseba, ki prejema pokojnino oziroma štipendijo)
Obrazec R-4: Zahtevek za nadomestilo izgubljenega zaslužka za obdobje izvrševanja nalog zaščite, reševanja in pomoči (izpolni oseba, ki nima dohodkov)
Obrazec R-5: Zahtevek za nadomestilo izgubljenega zaslužka za obdobje izvrševanja nalog zaščite, reševanja in pomoči (izpolni oseba, ki prejema nadomestilo v času brezposelnosti)
Obrazec R-6: Zahtevek za nadomestilo plače med začasno nezmožnostjo za delo (izpolni delodajalec)
