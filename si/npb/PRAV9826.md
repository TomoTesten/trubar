...
npb: "NPB 1"
veljaOd: 2010-02-22
vir: "https://pisrs.si/pregledNpb?id=PRAV9826"
---

# Pravilnik o merilih za določanje nagrade članom poravnalnega odbora

> Opozorilo: Neuradno prečiščeno besedilo predpisa predstavlja zgolj informativni delovni pripomoček, glede katerega organ ne jamči odškodninsko ali kako drugače.
Neuradno prečiščeno besedilo Pravilnika o merilih za določanje nagrade članom poravnalnega odbora obsega:
-       Pravilnik o merilih za določanje nagrade članom poravnalnega odbora (Uradni list RS, št. 13/10 z dne 22. 2. 2010),
-       Pravilnik o spremembi Pravilnika o merilih za določanje nagrade članom poravnalnega odbora (Uradni list RS, št. 53/11 z dne 1. 7. 2011).
...
Višina osnovnega kapitala prevzete družbe v EUR Višina nagrade v EUR nad do ‑ 200.000 1.300 200.000 400.000 1.500 400.000 ‑ 1.700
(2) Nagrada po tem členu zajema študij zadeve, udeležbo na sejah in izdelavo mnenja.
(3) Predsedniku poravnalnega odbora za posamezen primer se višina nagrade, določene v prvem odstavku tega člena, poveča za 50 odstotkov.
(4) (črtan)
...
Pravilnik o merilih za določanje nagrade članom poravnalnega odbora (Uradni list RS, št. 13/10 ) vsebuje naslednji končni določbi:
...
Pravilnik o spremembi Pravilnika o merilih za določanje nagrade članom poravnalnega odbora (Uradni list RS, št. 53/11 ) vsebuje naslednjo končno določbo:
»2. člen
Ta pravilnik začne veljati naslednji dan po objavi v Uradnem listu Republike Slovenije.«.
