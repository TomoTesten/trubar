---
kratica: MP_ODLO15153
naziv: "Odlok o gospodarskih javnih službah na območju Občine Majšperk (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=1995-01-2888"
---

# Odlok o gospodarskih javnih službah na območju Občine Majšperk (ODLO)

Na podlagi 3. in 7. člena zakona o gospodarskih javnih službah (Uradni list RS, št. 32/93) 26. in 105. člena zakona o varstvu okolja (Uradni list RS, št. 32/93), 2. člena zakona o gasilstvu (Uradni list RS, št. 71/93) in 18. člena statuta Občine Majšperk (Uradni list RS, številka 27/95), je Občinski svet občine Majšperk na seji dne 12. 10. 1995 sprejel


## O D L O K
o gospodarskih javnih službah na območju Občine Majšperk
...
Ta odlok določa dejavnosti, ki so gospodarske javne službe (v nadaljevanju: javne službe) na območju Občine Majšperk (v nadaljevanju: občine) in ureja način njihovega opravljanja.
...
Pri predlaganju odločitev na področju javnih služb, ki jih sprejema občinski svet občine ter pri sprejemanju odločitev, ki so v njihovi pristojnosti, so dolžni organi zagotavljati, da javne službe opravljajo v okviru racionalno, funkcionalno in prostorsko zaokroženih oskrbovalnih sistemih.
...
Na območju Občine Majšperk se kot javne službe opravljajo naslednje dejavnosti:
...
17. javna razsvetljava v naseljih
18. javni potniški promet
19. upravljanje javnih stanovanj.
...
Dejavnosti iz 1., 2., 3., 4., 5., 6., 7., in 8. točke prvega odstavka tega člena so obvezne lokalne javne službe, dejavnosti iz 9. do 19. točke prvega odstavka tega člena pa so izbirne lokalne javne službe.


### 5. člen

Kot izbirne javne službe se lahko izvajajo tudi druge dejavnosti, ki jih kasneje določi občinski svet ali organ širše lokalne skupnosti.
...
Izvajanje gospodarskih javnih služb zagotavlja občina neposredno z javnim podjetjem, z dajanjem koncesij ali z vlaganjem javnega kapitala v dejavnost oseb zasebnega prava.
...
Na podlagi odločitve občinskega sveta, se lahko zagotovi izvajanje dejavnosti gospodarskih javnih služb tudi z vlaganjem finančnih in drugih sredstev v zasebnopavne subjekte (podjetja, obratovalnice, posamezniki idr.).
...
V javnem podjetju se zagotavlja dejavnost oskrba s pitno vodo.
Ostale dejavnosti iz 4. člena se zagotavljajo z dajanjem koncesij, ali z vlaganjem javnega kapitala v zasebno-pravne subjekte.
...
1. strokovnotehnične, organizacijske in razvojne naloge v zvezi z upravljanje, načrtovanjem, vzdrževanjem in izgradnjo objektov in naprav, potrebnih za izvajanje javnih služb, če z aktom o ustanovitvi režijskega obrata, javnega gospodarskega zavoda ali javnega podjetja oziroma koncesijsko pogodbo ali pogodbo o vlaganju te naloge niso prenesene na režijski obrat, javni gospodarski zavod, javno podjetje, koncesionarja ali osebo v dejavnosti, v katero občina vlaga kapital zaradi zagotavljanja javnih dobrin,
...
12. druge naloge določene z zakoni in predpisi občine
13. lahko opravlja tudi strokovne naloge za potrebe občinskega stanovanjskega sklada in sklada stavbnih zemljišč.
...
Za varstvo uporabnikov javnih dobrin se v roku 3 mesece po sprejemu odloka oblikuje svet za varstvo uporabnikov dobrin, ki ga imenuje občinski svet občine.
Občinski svet sprejme tudi pravilnik o sestavi, pristojnostih in funkcioniranju sveta za varstvo uporabnikov javnih dobrin.
...
Do sprejetja aktov iz 3. člena tega odloka, se za ureditev zadev, ki niso urejenje s tem odlokom, uporabljajo določbe predpisov, izdanih na podlagi 41. člena zakona o komunalnih dejavnosti (Uradni list SRS, št. 8/82) oziroma določbe drugih predpisov, če niso urejene s tem odlokom.
Akt iz 3. člena tega odloka pripravi občinski urad Občine Majšperk in jih predloži v sprejem občinskemu svetu.
...
Z dnem pričetka veljavnosti tega odloka preneha veljati odlok o komunalnih dejavnostih v občini Ptuj (Uradni vestnik občin Ormož in Ptuj, št. 9/83).
