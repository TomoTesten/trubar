---
kratica: AKT_1143
naziv: "Sistemska obratovalna navodila za distribucijski sistem zemeljskega plina za geografsko območje Občine Sevnica"
vrsta: "akt"
datum: 2020-01-30
sop: 2020-01-0163
...
(1) Ta akt ureja obratovanje in vodenje distribucijskega sistema zemeljskega plina (v nadaljnjem besedilu: distribucijski sistem) na geografskem območju Občine Sevnice, na katerem izvaja gospodarsko javno službo operaterja distribucijskega sistema zemeljskega plina družba Javno podjetje Plinovod d.o.o., Sevnica (v nadaljnjem besedilu: operater distribucijskega sistema).
...
Ta akt se uporablja za vsa pravna razmerja v zvezi z distribucijskim sistemom na geografskem območju Občine Sevnica, na katerem je bila operaterju distribucijskega sistema podeljena koncesija.
...
(8) Uporabnik mora omogočiti dostop do naprav, ki omogočajo izpolnjevanje pravic in obveznosti operaterja distribucijskega sistema, in sicer:
...
(pogodba o ureditvi medsebojnih razmerij, stroški posega v varovalni pas
...
11. projekt za izvedbo priključka, razen v primeru iz šestega odstavka tega člena in projekt notranje plinske napeljave
;
...
7. so projekti za izvedbo priključka in notranje plinske napeljave izdelani skladno s predpisi, sistemskimi obratovalnimi navodili in tehničnimi zahtevami operaterja distribucijskega sistema v primerih, ko bo investitor ali lastnik stavbe lastnik teh vodov;
...
9. je priložen načrt notranje plinske napeljave ali posnetek izvedenega stanja
,
...
(2) Če investitor ali lastnik stavbe nima pravice do priključitve zaradi neizpolnjevanja pogojev iz prvega odstavka 34. člena tega akta, operater distribucijskega sistema zavrne soglasje za priključitev.
...
(priključevanje skladišč plina,obratov za utekočinjen zemeljski plin in
proizvodnih virov plina)
...
(vračilo dela nesorazmernih stroškov zaradi priključitve novih uporabnikov
distribucijskega sistema)
...
(5) Operater distribucijskega sistema o primerih odklopa po predhodnem obvestilu odklopi odjemno mesto odjemalca tako, da zapre in začepi zaporno pipo pred plinomerom in demontira plinomer.
...
(ocena možnosti dostopa in zavrnitev dostopa do distribucijskega
sistema)
...
c) podatke o odjemnem mestu: številka merilnega mesta (enoumna številka odjemnega mesta) in naslov odjemnega mesta.
...
(2) Lastnik mora operaterju distribucijskega sistema o spremembah podatkov, pomembnih za izvajanje pravic in obveznosti iz pogodbe o dostopu (npr. ime ali firmo, naziv, prebivališče, statusno pravne spremembe, uvedbo postopkov zaradi insolventnosti, spremembe odjema, naslova za dostavo, nastop in prenehanje višje sile, spremembe soglasja za priključitev) pisno obvestiti najkasneje v 30 dneh po nastali spremembi oziroma dogodku in predložiti dokumente, ki izkazujejo spremembe, sicer se šteje, da se za operaterja distribucijskega sistema podatki niso spremenili, na njih temelječi dokumenti operaterja distribucijskega sistema pa se štejejo kot vsebinsko pravilni, pravilno dostavljeni in sprejeti.
...
VII. POSTOPKI ZA OBRATOVANJE DISTRIBUCIJSKEGA SISTEMA V KRIZNIH
STANJIH
...
3
na podlagi meritev iz prejšnjega odstavka se izvede skladno z določbami predpisov, ki urejajo način določanja odjema zemeljskega plina.
...
(3) Za končne odjemalce zemeljskega plina veljajo obdobja, določena v spodnji tabeli:
...
(4)
Gospodinjskim odjemalcem s predvidenim povprečnim mesečnim odjemom do vključno 50 kWh lahko operater distribucijskega sistema na podlagi njihove pisne zahteve izstavi račun za omrežnino za celotno poračunsko obdobje.
...
(1) Operater distribucijskega sistema v primeru predvidenega odklopa zaradi razlogov iz točk f), h) ali i) prvega odstavka 274. člena EZ-1 obvesti gospodinjskega odjemalca o datumu predvidenega odklopa, pravici do nujne oskrbe, o dokazilih, ki jih mora predložiti, ter rokih za predložitev dokazil za nujno oskrbo.
...
Z dnem uveljavitve tega akta se prenehajo uporabljati Sistemska obratovalna navodila za distribucijsko omrežje zemeljskega plina za geografsko območje Občine Sevnica (Uradni list RS, št. 85/07) in Splošni pogoji za dobavo in odjem zemeljskega plina iz distribucijskega omrežja za geografsko območje Občine Sevnica (Uradni list RS, št. 42/10).
