---
kratica: MP_ODLO14744
naziv: "Odlok o ustanovitvi javnega zavoda osnovne šole Primoža Trubarja Laško (ODLO)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=1995-01-1556"
---

# Odlok o ustanovitvi javnega zavoda osnovne šole Primoža Trubarja Laško (ODLO)
...
## O D L O K
o ustanovitvi javnega zavoda osnovne šole Primoža Trubarja Laško


### 1. člen

S tem odlokom Občinski svet občine Laško ustanavlja (dalje: ustanovitelj) na področju osnovnega šolstva javni zavod.
Ime javnega zavoda je Osnovna šola Primoža Trubarja Laško.
Sedež javnega zavoda (dalje: zavod) je v Laškem, Trubarjeva ul. 10, Laško.
V njegovi sestavi deluje organizacijska enota:
– osnovna šola s prilagojenim programom in
– naslednje podružnične šole:
· Podružnična šola Rečica,
· Podružnična šola Reka,
· Podružnična šola Šentrupert in
· Podružnična šola Vrh nad Laškim.
...
Zavod opravlja:
– osnovnošolsko splošno izobraževanje (M/80.102 – uredba o uvedbi in uporabi standardne klasifikacije dejavnosti) in
– osnovnošolsko prilagojeno izobraževanje (M/80.103) ki obsegata:
· pouk po predmetniku in učnem načrtu za osnovno šolo,
· pouk po predmetniku in učnem načrtu za osnovno šolo s programom, prilagojenim učencem z motnjami v telesnem in duševnem razvoju,
...
Svet zavoda šteje devet čanov in ga sestavljajo:
– 3 predstavniki ustanovitelja,
– 3 predstavniki delavcev,
– 3 predstavniki staršev.
Predstavnike ustanovitelja imenuje ustanovitelj. Delavci zavoda volijo svoje predstavnike neposredno. Starši volijo svoje predstavnike neposredno na svetu staršev. Člani so imenovani oziroma voljeni za štiri leta in so lahko ponovno imenovani oziroma voljeni.
...
V organizacijski enoti opravlja naloge pedagoškega vodje vodja organizacijske enote.
Vodjo organizacijske enote imenuje in razrešuje svet zavoda po predhodnem mnenju strokovnega organa zavoda.
Za vodjo organizacijske enote je lahko imenovan, kdor izpolnjuje pogoje za ravnatelja.


### 11. člen

Ravnatelj, pomočnik ravnatelja in vodja organizacijske enote so imenovani na podlagi javnega razpisa, po postopku, določenim z zakonom in statutom zavoda.
Vodjo podružnične šole imenuje svet zavoda na predlog ravnatelja.


### 12. člen

Naloge in odgovornosti ravnatelja, pomočnika ravnatelja, vodje organizacijske enote in vodje podružnične šole določa statut zavoda.


### 13. člen

Strokovni organ zavoda je učiteljski zbor.
Strokovni organ se oblikuje tudi v organizacijski enoti, na ravni zavoda pa se za koordinacijo dela učiteljskih zborov oblikuje kolegij ravnatelja, ki ga sestavljajo ravnatelj, pomočnik ravnatelja in vodja organizacijske enote.
Naloge in pristojnosti učiteljskega zbora se določijo s statutom. Zavod ima lahko tudi druge strokovne organe (strokovne aktive in podobno).
...
Svet staršev se oblikuje tudi v organizacijski enoti in na podružnični šoli. Število članov sveta staršev, način imenovanja oziroma njihovo izvolitev določa statut.
...
Zavod se vpiše v sodni register. V sodni register se vpiše tudi organizacijska enota, če ima pooblastila v pravnem prometu.
...
Imenovanje ravnatelja, pomočnika ravnatelja in vodje organizacijske enote se v skladu s tem odlokom in statutom zavoda, opravijo po zaključenem mandatu imenovanih.
...
Ta odlok začne veljati petnajsti dan po objavi v Uradnem listuRepub like Slovenije.
