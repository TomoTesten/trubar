...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2014-01-0240"
---

# Pravilnik o sprejemu predšolskih otrok v Vrtec Ribnica (PRAV)

Na podlagi 20. člena Zakona o vrtcih (Uradni list RS, št. 100/05 – ZVrt – UPB2, 25/08, 36/10) in Odloka o ustanovitvi javnega vrtca Vrtec Ribnica (Uradni list RS, št. 57/96, 26/97, 49/07, 105/08, 61/10) je Občinski svet Občine Ribnica na predlog Sveta vrtca na seji dne 30. 1. 2014 sprejel
...
+------+------------------------------------------------+------+
|  1.  |Prebivališče                                    |  7   |
|      |Otrok in eden izmed staršev/skrbnikov imata do  |      |
|      |zadnjega dneva razpisa stalno prebivališče na   |      |
|      |območju Občine Ribnica ali otrok tujcev, ki ima |      |
|      |skupaj vsaj z enim izmed staršev/skrbnikov do   |      |
|      |zadnjega dneva razpisa stalno ali začasno       |      |
|      |prebivališče na območju Občine Ribnica          |      |
+------+------------------------------------------------+------+
|  2.  |Čakalni seznam                                  |  2   |
|      |Otrok, ki ga je komisija v preteklem šolskem    |      |
|      |letu uvrstila na čakalni seznam, pa med šolskim |      |
|      |letom ni bil sprejet v vrtec, zaradi pomanjkanja|      |
|      |prostih mest v vrtcu, če starši/skrbniki niso   |      |
|      |odklonili ponujenega mesta                      |      |
|      |ALI                                             |      |
|      |Otrok, ki je bil že sprejet v Vrtec Ribnica, pa |      |
|      |so ga starši zaradi zdravstvenih težav morali   |      |
|      |izpisati iz vrtca (dokazilo je zdravniško       |      |
|      |potrdilo)                                       |      |
+------+------------------------------------------------+------+
|  3.  |Razvojne/zdravstvene težave                     |  1   |
|      |Priporočilo strokovnjaka za sprejem otroka v    |      |
|      |vrtec (upošteva se priporočilo, ki je na zadnji |      |
|      |dan razpisa staro največ 3 mesece)              |      |
+------+------------------------------------------------+------+
|  4.  |Otroci, ki jim je bil odložen vpis v osnovno    |  2   |
|      |šolo                                            |      |
+------+------------------------------------------------+------+
|  5.  |Zaposlitev staršev (dokazilo-priloga: potrdilo  |      |
|      |delodajalca; točke se upošteva, če je starš     |      |
|      |zaposlen oziroma študent v času, ki ga komisija |      |
|      |določi za dopolnitev vlog)                      |      |
|      +------------------------------------------------+------+
|      |Oba starša sta zaposlena ali imata status       |  4   |
|      |študenta                                        |      |
|      +------------------------------------------------+------+
|      |Zaposlen ali študent je eden izmed staršev      |  2   |
|      +------------------------------------------------+------+
|      |Zaposlen ali študent je starš enoroditeljske    |  4   |
|      |družine, ki živi z otrokom (dokazilo-priloga:   |      |
|      |kopija dokazila o preživnini ali prejemanju     |      |
|      |pokojnine)                                      |      |
+------+------------------------------------------------+------+
...
Z dnem uveljavitve tega pravilnika preneha veljati Pravilnik o sprejemu predšolskih otrok v Vrtec Ribnica (Uradni list RS, št. 47/11).
