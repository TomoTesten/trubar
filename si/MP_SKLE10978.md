---
kratica: MP_SKLE10978
naziv: "Sklep o razpisu referenduma za uvedbo krajevnega samoprispevka za območje Krajevne skupnosti Vrh nad Laškim (SKLE)"
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=1991-01-0983"
---

# Sklep o razpisu referenduma za uvedbo krajevnega samoprispevka za območje Krajevne skupnosti Vrh nad Laškim (SKLE)

Skupščina Krajevne skupnosti Vrh nad Laškim je na podlagi 3. člena zakona o samoprispevku (Uradni list SRS, št. 35/85 in 46/86) ter določil statuta Krajevne skupnosti Vrh nad Laškim na svoji seji dne 28. 9. 1991 sprejela


## SKLEP
o razpisu referenduma za uvedbo krajevnega samoprispevka za območje Krajevne skupnosti Vrh nad Laškim


### 1. člen

Za območje Krajevne skupnosti Vrh nad Laškim se razpiše referendum za uvedbo samoprispevka za sofinanciranje izvajanja programa krajevne skupnosti.
...
– gradnjo telefonskih kapacitet,
– asfaltiranje cest: Jurkovšek-Žigon, Vrh-Vel. Grahovše-Trobni dol, Leskovca-Rjavček, odcep glavna cesta-Laška vas, odcep-Gozdec, Loke-Leše.


### 3. člen

Za uresničitev programa je potrebno 27.000.000 SLT. S samoprispevkom bo zbrano predvidoma 4,328.000 SLT.
...
1. Delovni ljudje in občani, ki imajo stalno bivališče v Krajevni skupnosti Vrh nad Laškim:
– 1,5% od neto plač;
...
2. Lastniki nepremičnin v KS Vrh nad Laškim, v višini:
...
– 1.000 SLT v letu 1992 lastniki bivalnih objektov, namenjenih za trajno ali občasno bivanje, s stalnim bivališčem izven KS Vrh nad Laškim, če niso zavezanci za samoprispevek iz KD. Ta znesek se v naslednjih letih valorizira z indeksom porasta povprečnih plač v občini Laško v preteklem letu.
...
Sredstva samoprispevka se zbirajo na žiro računu Krajevne skupnosti Vrh nad Laškim.
Za zbiranje sredstev in izvajanje del referendumskega programa skrbi Svet Krajevne skupnosti Vrh nad Laškim. Ta bo enkrat letno zboru delovnih ljudi in občanov tudi poročal o uporabi sredstev.
...
skupnosti Vrh nad Laškim za sofinanciranje izvedbe programa KS Vrh nad Laškim
...
Vrh nad Laškim, dne 28. septembra 1991.
