...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2017-01-3099"
---
...
(1)
Ta pravilnik določa za obratovalni monitoring stanja podzemne vode obseg, merila za izbor parametrov, metodologijo vzorčenja, merjenja in analiziranja vzorcev, vrednotenje spremembe vsebnosti parametrov, vsebino programa in poročila ter način in obliko evidentiranja in sporočanja podatkov o obratovalnem monitoringu stanja podzemne vode.
...
(1)
Ta pravilnik se uporablja za obratovalni monitoring stanja podzemne vode zaradi ugotavljanja vpliva:
...
(1)
Merilna mesta se določijo tako, da omogočajo:
...
(1)
Zavezanec mora urediti stalno merilno mesto, ki je:
...
(1)
Obratovalni monitoring stanja podzemne vode zaradi ugotavljanja vpliva odvajanja odpadnih voda na stanje podzemne vode vključuje monitoring parametrov onesnaženosti, s katerimi se izraža emisija snovi in toplote in so za napravo, ki je predmet obravnave, vključeni v obratovalni monitoring odpadne vode na podlagi predpisa, ki ureja prve meritve in obratovalni monitoring odpadnih voda ter pogoje za njegovo izvajanje.
...
(1)
Gladine podzemne vode se merijo neprekinjeno z uporabo avtomatskih merilnikov, če gre za izvajanje obratovalnega monitoringa stanja podzemne vode zaradi ugotavljanja vpliva odlaganja odpadkov na odlagališču v:
...
– vodonosnikih, katerih prepustnost je večja od 10
-5
m/s,
...
(1)
Sprememba vsebnosti posameznega parametra obratovalnega monitoringa stanja podzemne vode (v nadaljnjem besedilu: sprememba vsebnosti parametra) se izračuna za letno povprečje vseh meritev parametra, ki je vključen v obratovalni monitoring stanja podzemne vode.
...
(1)
Izvajalec obratovalnega monitoringa mora za vsako koledarsko leto izvajanja obratovalnega monitoringa stanja podzemne vode izdelati poročilo o obratovalnem monitoringu stanja podzemne vode (v nadaljnjem besedilu: poročilo).
...
(1)
Predlog programa obratovalnega monitoringa stanja podzemnih voda izdela izvajalec obratovalnega monitoringa in vključuje:
...
(1)
Oseba iz prejšnjega člena mora glede usposobljenosti za izvajanje obratovalnega monitoringa stanja podzemne vode izpolnjevati naslednje tehnične pogoje:
...
(1)
Vloga za pridobitev pooblastila mora vsebovati podatke o vlagatelju (osebno ime in naslov stalnega ali začasnega bivališča ali firmo in sedež osebe) ter navedbo postopkov in parametrov v sklopu izvajanja obratovalnega monitoringa stanja podzemne vode, na katere se nanaša vloga za pridobitev pooblastila.
...
Priloga: Osnove za določitev programa obratovalnega monitoringa stanja podzemnih voda
