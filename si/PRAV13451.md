---
kratica: PRAV13451
naziv: "Splošni akt o postopkih vpisa in izbrisa iz imenika pooblaščenih inženirjev"
vrsta: "pravilnik"
datum: 2018-06-01
sop: 2018-01-1852
...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2018-01-1852"
---
...
(1)
Vpis v imenik opravi IZS na zahtevo posameznika.
...
(1)
IZS do 1. 1. 2021 oziroma do pričetka uporabe prostorskega informacijskega sistema izda posamezniku ob vpisu v imenik žig pooblaščenega inženirja z identifikacijsko številko pooblaščenega inženirja.
...
(1)
Posameznik, ki je izbrisan iz imenika na lastno zahtevo ali na podlagi ugotovitve, da ne izpolnjuje pogojev za opravljanje storitev, se lahko na lastno zahtevo ponovno vpiše v imenik, če izpolnjuje pogoje za vpis.
...
(1)
V primeru mirovanja poklicnega naziva pooblaščeni inženir mora ta oseba najpozneje v osmih dneh po pravnomočnosti odločbe o mirovanju poklicnega naziva pristojni službi IZS vrniti žig pooblaščenega inženirja, če mu ga je IZS izdala.
...
(1)
Posamezniku, kateremu je poklicni naziv miroval na podlagi lastne vloge ali na podlagi ugotovitve, da ne izpolnjuje pogojev za opravljanje poklicnih nalog pooblaščenega inženirja, se na lastno zahtevo izbriše mirovanje iz imenika, če izpolnjuje vse pogoje za vpis v imenik pooblaščenih inženirjev.
