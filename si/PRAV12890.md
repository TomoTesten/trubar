...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2016-01-2573"
---
...
d
:
vsota ogrevane površine tistih poslovnih delov stavbe, za katere so na voljo odčitki z delilnikov (m
2
),
– ∑
N:
...
– ∑
A:
vsota ogrevanih površin vseh poslovnih delov stavb (m
2
).«.
...
-1
. Korekturni faktorji posameznih delov stavbe se izračunajo po enačbi:
...
L,ref
:
celotne toplotne izgube referenčnega dela stavbe, pri čemer je referenčni del stavbe tisti del stavbe, ki ima
najmanjše celotne toplotne izgube na enoto ogrevane površine (kWh),
–
A
ref
:
ogrevana površina referenčnega dela stavbe (m
2
),
–
Q
...
i
:
ogrevana površina i-tega posameznega dela stavbe (m
2
).
...
d
:
vsota ogrevane površine tistih delov stavbe, za katere so na voljo odčitki z delilnikov (m
2
),
– ∑
A
:
vsota ogrevanih površin vseh delov stavbe (m
2
).«.
