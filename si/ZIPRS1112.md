...
## U K A Z
o razglasitvi Zakona o izvrševanju proračunov Republike Slovenije za leti 2011 in 2012 (ZIPRS1112)

Razglašam Zakon o izvrševanju proračunov Republike Slovenije za leti 2011 in 2012 (ZIPRS1112), ki ga je sprejel Državni zbor Republike Slovenije na seji 17. novembra 2010.
...
## Z A K O N
O IZVRŠEVANJU PRORAČUNOV REPUBLIKE SLOVENIJE ZA LETI 2011 IN 2012 (ZIPRS1112)
...
5. postavkah na programu 1603 – Oblikovanje rezerve in intervencijski programi, ki presegajo pravice porabe, zagotovljene na teh postavkah v proračunu, se na podlagi odločitve vlade plačujejo tudi nad to višino.
...
11. prihodki po 162. členu Zakonu o vodah (Uradni list RS, št. 67/02, 110/02 – ZGO-1, 2/04 – ZZdrl-A, 41/04 – ZVO-1 in 57/08) se uporabijo za namene, določene v navedenem zakonu;
...
2. kupnine od prodaje kapitalskih naložb, ki se v proračun za leto 2011 in za leto 2012 vplačajo na podlagi ZUKLPP, in se uporabijo za namene, določene v navedenem zakonu.
...
(1) Vlada lahko odloča o prerazporeditvah pravic porabe ne glede na omejitve iz 14., 15. in 17. člena tega zakona med podprogrami, znotraj programa, posameznega ali različnih predlagateljev finančnih načrtov, pri čemer skupno povečanje ali zmanjšanje posameznega podprograma ne sme presegati 10 odstotkov podprograma v sprejetem proračunu.
(2) Vlada lahko odloča o prerazporeditvah pravic porabe ne glede na omejitve iz 14., 15., 16. in 17. člena tega zakona in prejšnji odstavek:
1. s in na plačne konte integralnih postavk v okviru istega podprograma;
2. na postavke slovenske udeležbe, med njimi in z njih;
3. na postavke namenskih sredstev EU in med temi postavkami;
...
6. na postavke v programu 1003 – Pokojninsko in invalidsko varstvo;
7. na postavke v programu 1601 – Servisiranje javnega dolga;
8. na postavke v podprogramu 160201 – Plačila sredstev v proračun EU;
9. na postavke v podprogramu 160302 – Posebna proračunska rezerva in programi pomoči v primerih nesreč, med njimi in z njih;
...
(4) Če gre za prerazporeditev na postavke za kohezijsko politiko in s teh postavk po 2. in 3. točki drugega odstavka tega člena, pripravi predlog za prerazporeditev organ upravljanja v skladu s predpisi, ki urejajo postopke za izvajanje kohezijske politike in v sodelovanju s predlagateljem finančnega načrta ter ga predloži ministrstvu, pristojnemu za finance, ta pa vladi.
...
(2) Neposredni uporabnik lahko v letu 2011 prevzame obveznosti za namene, za katere so zagotovljena sredstva v letu 2012 in ki zapadejo v plačilo v letu 2012, v višini 80 odstotkov obsega pravic porabe na podskupinah kontov znotraj podprograma, načrtovanih v proračunu za leto 2012, v letu 2011 pa lahko sklene pogodbe za obveznosti, ki zapadejo v plačilo v letu 2013, do višine 60 odstotkov obsega pravic porabe, za namene, ki so načrtovani v proračunu za leto 2012 po podskupinah kontov znotraj podprograma. Neposredni uporabnik lahko v letu 2012 prevzame obveznosti za namene, za katere so načrtovane pravice porabe v letu 2012 in ki zapadejo v plačilo v letu 2013, v višini 60 odstotkov obsega pravic porabe na podskupinah kontov znotraj podprograma, načrtovanih v proračunu za leto 2012, v letu 2012 pa lahko prevzame obveznosti, ki zapadejo v plačilo v letu 2014, do višine 40 odstotkov obsega pravic porabe, za namene, ki so načrtovani v proračunu za leto 2012 po podskupinah kontov znotraj podprograma.
...
(4) Vlada odloča o uvrstitvi projektov oziroma ukrepov v veljavni NRP in o spremembi vrednosti projekta oziroma ukrepa nad 20 odstotkov izhodiščne vrednosti, če sprememba vpliva na obseg sredstev, ki je določen v proračunu.
(5) Ne glede na prejšnji odstavek vlada ne odloča o:
– spremembi vrednosti projektov oziroma ukrepov nad 20 odstotkov, kadar veljavna vrednost in vrednost po predvideni spremembi posameznega projekta oziroma ukrepa ne presega 100.000 eurov;
...
(7) Velikega projekta med letom ni mogoče uvrstititi v NRP. Izjemoma lahko vlada, na predlog organa upravljanja, odloči o uvrstitvi velikega projekta v NRP, če je projekt podprt z odločbo EU ali drugim ustreznim dokumentom EU o financiranju oziroma izvajanju projekta.
...
2. za namenska sredstva EU in sredstva slovenske udeležbe do višine 20 odstotkov vrednosti predvidenih izplačil teh sredstev in pod pogojem, da je prejemnik oseba zasebnega ali javnega prava in je ustanovljena in deluje kot društvo, zasebni ali javni zavod, zbornica, ki izvaja javna pooblastila po zakonu, ki ureja socialno varstvo ali ustanova;
3. za plačilo:
...
(2) Pri predplačilih iz 1. in 2. točke prejšnjega odstavka mora neposredni uporabnik v pogodbi s prejemnikom sredstev dogovoriti, da se prejemnik sredstev zavezuje prejeta sredstva, skupaj z zamudnimi obrestmi, vrniti v proračun, če se naknadno ugotovi, da je bilo izplačilo iz proračuna neupravičeno izvršeno. Šteje se, da je bilo izplačilo iz proračuna neupravičeno izvršeno, če se v postopkih pred posredovanjem zahtevka za plačilo EK ugotovi, da bi EK zahtevek za plačilo zavrnila, če EK zahtevek za plačilo sredstev zavrne ali če EK izstavi zahtevek za vračilo.
...
(2) Na zahtevo pristojnega organa, določenega s predpisi EU, neposredni proračunski uporabnik državnega ali občinskega proračuna, ki je prejel namenska sredstva iz EU, izvede vračilo na podračun v okviru enotnega zakladniškega računa države.
(3) Na zahtevo pristojnega organa EU izvede vračilo iz podračuna enotnega zakladniškega računa države v podračun EU, pristojni organ, določen skladno s predpisi EU.
...
(1) Sredstva, zagotovljena v finančnem načrtu ministrstva, pristojnega za finance, za nakup kapitalskih naložb, se v letu 2011, do višine 250.000.000 eurov, prerazporedijo v finančni načrt Agencije za upravljanje s kapitalskimi naložbami Republike Slovenije, po imenovanju sveta agencije in po sprejemu Strategije upravljanja kapitalskih naložb države.
(2) Za upravljanje s kapitalskimi naložbami, pridobljenimi v skladu z zakonom, ki ureja davčni postopek, zakonom, ki ureja dedovanje, zakonom, ki ureja izvrševanje kazenskih sankcij ter za upravljanje s kapitalskimi naložbami v mednarodnih finančnih institucijah je, ne glede na določbe prve alineje 42. člena Zakona o upravljanju kapitalskih naložb Republike Slovenije (Uradni list RS, št. 38/10), do višine 25.000 eurov, pristojno ministrstvo, pristojno za finance.
...
### (obseg zadolževanja in poroštev pravnih oseb javnega sektorja v letih 2011 in 2012)
...
Z dnem uveljavitve tega zakona preneha veljati Zakon o izvrševanju proračunov Republike Slovenije za leti 2010 in 2011 (Uradni list RS, št. 99/09, 29/10 in 56/10), v delu, ki se nanaša na leto 2011.
