...
vir: "https://www.uradni-list.si/1/objava.jsp?sop=2017-01-1605"
---
...
»
3
Podatki o naslovu poročevalske FI se vpišejo v prosti (
AddressFree)
in/ali
strukturirani (
AddressFix
) obliki. Obvezno je poročanje naslova poročevalske FI v vsaj enem od obeh formatov, zato sta označena kot opcijsko/obvezna.«.

Dosedanje tretja, četrta, peta in šesta opomba postanejo četrta, peta, šesta in sedma opomba.

V Preglednici 4 se v deseti vrstici tretjega stolpca besedilo »Za zaprti račun se vpiše vrednost nič (0) in hkrati se vpiše »true« v zaprti račun
(Clossed Account)
v sklopu številka računa
(Account number)
.« nadomesti z besedilom »Za zaprti račun se vpiše vrednost nič (0.00) in hkrati se vpiše »true« v zaprti račun
(Clossed Account)
v sklopu številka računa
(Account number)
.«.
